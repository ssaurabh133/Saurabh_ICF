...
<!--Purpose  : Business partner Search->
<!--Documentation : -->
...
<body
	...
	<html:form action="/bpMasterBehind" styleId="bpSearch"
		method="post">
...
<button type="button" class="topformbutton2" name="add"  id="add"  onclick="return addBpMaster();" title="Alt+A" accesskey="A" ><bean:message key="button.add" /></button>
	</td>
			...
			<logic:present name="list">
				<display:table id="list" name="list" style="width: 100%"
					...
					<display:setProperty name="locale.provider"
						value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
					<display:column property="bpId" titleKey="lbl.bpName"
						sortable="true" />
					<display:column property="activityCode"
						titleKey="lbl.activity" sortable="true" />
					<display:column property="bpAdd"
						titleKey="lbl.bpAdd" sortable="true" />
						...
						<td class="gridtd">
							<table width="100%" border="0" cellpadding="4" cellspacing="1">
								<tr>
									...
									<td width="220" class="white2" style="width: 250px;">
										<b><bean:message key="lbl.bpAdd" /> <br> </b>
									</td>
