...
<body
	onload="enableAnchor();document.getElementById('activityMasterSearch').searchActivityCode.focus();init_fields();">
	<html:form action="/activityMasterBehind" styleId="activityMasterSearch"
		method="post">
				...
				<tr>
					...
					<td width="13%">
						<html:text property="searchActivityCode" styleClass="text"
							styleId="searchActivityCode" maxlength="10"
							onblur="fnChangeCase('actionCodeMaster','searchActivityCode')" />
					</td>
					<td width="13%">
						<bean:message key="lbl.activityDesc" />
					</td>
					<td width="13%">
						<html:text property="searchActivityDesc" styleClass="text"
							styleId="searchActivityDesc" maxlength="50"
							onblur="fnChangeCase('actionCodeMaster','searchActivityDesc')" />
					</td>
				</tr>
...
<button type="button" class="topformbutton2" name="add"  id="add"  onclick="return addActivityMaster();" title="Alt+A" accesskey="A" ><bean:message key="button.add" /></button>
	</td>
		...
		<fieldset>
			...
			<logic:present name="list">
				<display:table id="list" name="list" style="width: 100%"
					...
					requestURI="/activityMasterBehind.do">
					...
					<display:setProperty name="locale.provider"
						value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
					<display:column property="activityCodeModify" titleKey="lbl.activityCode"
						sortable="true" />
					<display:column property="activityDesc"
						titleKey="lbl.activityDesc" sortable="true" />
					<display:column property="sourcedesc"
						titleKey="lbl.mappingSource" sortable="true" />
						<display:column property="mappingCode"
						titleKey="lbl.mappingCode" sortable="true" />
							...
							<table width="100%" border="0" cellpadding="4" cellspacing="1">
								<tr>
									<td width="220" class="white2" style="width: 220px;">
										<strong><bean:message key="lbl.activityCode" /> </strong>
									</td>
									
									<td width="220" class="white2" style="width: 250px;">
										<b><bean:message key="lbl.activityDesc" /> <br> </b>
									</td>
									<td width="220" class="white2" style="width: 250px;">
										<b><bean:message key="lbl.mappingSource" /> <br> </b>
									</td>
									<td width="220" class="white2" style="width: 250px;">
										<b><bean:message key="lbl.mappingCode" /> <br> </b>
									</td>
									<td width="220" class="white2" style="width: 250px;">
