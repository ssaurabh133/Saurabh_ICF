...
<body
	onload="enableAnchor();document.getElementById('schemeBpMapSearch').searchBpName.focus();init_fields();">
	<html:form action="/schemeBpMapBehind" styleId="schemeBpMapSearch"
		method="post">
				...
				<tr>
					...
					<td width="13%">
						<html:text property="searchSchemeName" styleClass="text"
							styleId="searchSchemeName" maxlength="10"	/>
					</td>
				</tr>
...
<button type="button" class="topformbutton2" name="add"  id="add"  onclick="return addSchemeBpMap();" title="Alt+A" accesskey="A" ><bean:message key="button.add" /></button>
	</td>
		...
		<fieldset>
			<legend>
				<bean:message key="lbl.schemBpMapMasterDtl" />
			</legend>
			...
			<logic:present name="list">
				<display:table id="list" name="list" style="width: 100%"
					...
					requestURI="/schemeBpMapBehind.do">
					...
					<display:setProperty name="locale.provider"
						value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
					<display:column property="bpName" titleKey="lbl.bpName"
						sortable="true" />
					<display:column property="schemeName" titleKey="lbl.schemeName"
						sortable="true" />
					<display:column property="schemeDesc" titleKey="lbl.payNarration"
						sortable="true" />
					<display:column property="activityCode"
						titleKey="lbl.payActivity" sortable="true" />
							...
							<table width="100%" border="0" cellpadding="4" cellspacing="1">
								<tr>
									...
									<td width="220" class="white2" style="width: 250px;">
										<b><bean:message key="lbl.schemeName" /> <br> </b>
									</td>
									<td width="220" class="white2" style="width: 250px;">
									...
									<td width="220" class="white2" style="width: 250px;">
										<b><bean:message key="lbl.payActivity" /> <br> </b>
									</td>
									<td width="220" class="white2" style="width: 250px;">
