...
public class PaymentReceiptBehindAction extends Action{
	private static final Logger logger = Logger.getLogger(PaymentReceiptBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		ArrayList<PaymentReceiptVO> list=new ArrayList<PaymentReceiptVO>();
		  ...
		  logger.info("current page link .......... "+request.getParameter("d-49520-p"));
			...
			list= payMaster.searchPaymentReceiptMaker(paymentReceiptVo);
