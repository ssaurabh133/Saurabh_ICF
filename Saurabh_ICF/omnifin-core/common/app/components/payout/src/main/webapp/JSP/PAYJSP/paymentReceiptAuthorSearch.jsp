...
<body
	onload="enableAnchor();document.getElementById('paymentReceiptAuthorSearch').searchBpName.focus();init_fields();">
	<html:form action="/paymentReceiptBehindAuthor" styleId="paymentReceiptAuthorSearch"
		method="post">
		...
		<fieldset>
			...
			<table width="100%">
				...
				<tr>
					<td>
 <button type="button" class="topformbutton2"   id="search"  onclick="return fnSearchCodeAuthor('<bean:message key="lbl.selectAtLeast" />');" title="Alt+S" accesskey="S" ><bean:message key="button.search" /></button>
		...
		<fieldset>
			<legend>
				<bean:message key="lbl.payPaymentReceiptWaiveAuthorDtl" />
			</legend>
			...
			<logic:present name="list">
				<display:table id="list" name="list" style="width: 100%"
					...
					requestURI="/paymentReceiptBehindAuthor.do">
					...
					<display:column property="paymentMode"
						...
						sortable="true" />
                       <display:column property="makerId"
						titleKey="lbl.payMaker" sortable="true" />
				</display:table>
			</logic:present>
						...
						<td class="gridtd">
							<table width="100%" border="0" cellpadding="4" cellspacing="1">
								<tr>
									...
									<td width="220" class="white2" style="width: 250px;">
										<b><bean:message key="lbl.payMaker" /> <br> </b>
									</td>
									<tr class="white2" >
