...
public class PoolIdAddEditDAOImpl implements PoolIdAddEditDAO{
	
	private static final Logger logger = Logger.getLogger(PoolIdAddEditDAOImpl.class.getName());
	     ...
	     ArrayList<PoolIdMakerVO> getPoolIdAddEditList=new ArrayList<PoolIdMakerVO>();
	 	 try
	 	 {
	 		 ...
	 		 bufInsSql.append(" select P.pool_id,P.pool_name,P.pool_creation_date,P.POOL_CUTOFF_DATE,A.AGENCY_CODE,A.AGENCY_NAME "+
	 		  ...
	 		  if(!poolId.trim().equalsIgnoreCase("0"))
	 		  {
