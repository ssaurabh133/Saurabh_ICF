...
%>
	...
	<html:form styleId="sourcingForm" action="/monthlyCollectionProcessAction" method="post" >   
	...
	<fieldset><legend><bean:message key="lbl.monthlyCollReport"/></legend>  
	    ...
	    <tr>
		    <td align="left">  
		    	<button type="button" name="button" class="topformbutton3" title="Alt+S" accesskey="O" onclick="checkValidforMonthly();">OK</button>
			<logic:present name="s1">
				<button type="button" name="button" class="topformbutton3" title="Alt+S" accesskey="O" onclick="generateReportForMonthlyCollection();">GenerateReport</button>
			</logic:present>	
			<logic:notPresent name="s1">
...
<logic:present name="ref">
	<script type="text/javascript">
		if(!confirm('${ref}')){
			window.location="<%=request.getContextPath()%>/MonthlyCollectionReportBehindAction.do";	
		}
	</script>
</logic:present>
