	...
	<legend><bean:message key="lbl.poolIdAuthorSearch"/></legend>  
	 ...
	 <logic:present name="authordetailList">	
		<logic:notEmpty name="authordetailList"> 
		    <display:table  id="sublist"  name="authordetailList" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1"  partialList="true" size="${authordetailList[0].totalRecordSize}" requestURI="/poolViewerBehindAction.do" >
