...
public class PoolCreationForCMVO {
	...
	private String deffralCase;
	private String repoStock;
	private String ltv1;
	private String ltv2;
	...
	private String lbxStateIds;
	

	private String lbxStateId;
	private String stateButtons;
	
	private String sectorType;
	private String assetCost1;
	private String assetCost2;
	...
	public String getLbxStateIds() {
		return lbxStateIds;
	}

	public void setLbxStateIds(String lbxStateIds) {
		this.lbxStateIds = lbxStateIds;
	}
	...
	public String getAssetCost2() {
		return assetCost2;
	}

	public void setAssetCost2(String assetCost2) {
		this.assetCost2 = assetCost2;
	}
	...
	public String getAssetCost1() {
		return assetCost1;
	}

	public void setAssetCost1(String assetCost1) {
		this.assetCost1 = assetCost1;
	}
	...
	public String getStateButtons() {
		return stateButtons;
	}

	public void setStateButtons(String stateButtons) {
	...
	/*Added By Rudra End*/	
	public String getInstalmentMode() {
		return instalmentMode;
	}

	public void setInstalmentMode(String instalmentMode) {
		this.instalmentMode = instalmentMode;
	}

	public String getMultipleBranches() {
		return multipleBranches;
	}

	public void setMultipleBranches(String multipleBranches) {
	...
	public String getDeffralCase() {
		return deffralCase;
	}

	public void setDeffralCase(String deffralCase) {
		this.deffralCase = deffralCase;
	}

	public String getRepoStock() {
		return repoStock;
	}

	public void setRepoStock(String repoStock) {
