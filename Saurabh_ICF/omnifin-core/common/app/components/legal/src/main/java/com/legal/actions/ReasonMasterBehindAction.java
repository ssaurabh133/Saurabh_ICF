...
public class ReasonMasterBehindAction extends Action  {
private static final Logger logger = Logger.getLogger(ReasonMasterBehindAction.class.getName());
public ActionForward execute(ActionMapping mapping, ActionForm form,
					HttpServletRequest request, HttpServletResponse response) throws Exception {
				HttpSession session=request.getSession();
				ServletContext context = getServlet().getServletContext();
				logger.info("In ReasonMasterBehindAction.........");
				...
				DynaValidatorForm legalCommonDynaValidatorForm= (DynaValidatorForm)form;
				org.apache.commons.beanutils.BeanUtils.copyProperties(vo, legalCommonDynaValidatorForm);
				...
				list= bp.searchReasonData(vo);

			    logger.info("In ReasonMasterBehindAction....list"+list.size());
