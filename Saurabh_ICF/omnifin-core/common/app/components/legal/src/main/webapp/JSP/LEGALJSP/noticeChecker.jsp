...
<!--Date of Creation : 02-April-2013-->
<!--Purpose  : Information of notice checker -->
<!--Documentation : -->
...
<html:form action="/noticeCheckerDispatchAction" styleId="noticeCheckerForm" method="post" > 	
<div  align="center" class="opacity" style="display: none;"  id="processingImage"></div>
<html:hidden property="path" styleId="path" value="<%=request.getContextPath()%>"/>
<input type="hidden" name="userId" id="userId" value="${userId}"/>
<input type="hidden" name="contextPath" value="<%=request.getContextPath() %>" id="contextPath"/>
<!-- - <td><input type="text" name="listSize" id="listSize" value="${requestScope.list[0].listSize}" /></td>--->
<html:errors/>

<fieldset>
<legend><bean:message key="lbl.legalNoticeInitiationChecker"/></legend>
	<table width="100%">
	...
	<tr>
		...
		<html:button property="loanNoButton" styleId="loanNoButton" onclick="closeLovCallonLov1();openLOVCommon(16090,'noticeCheckerForm','loanNo','userId','lbxLoanId','userId','','','customerName');" value=" " styleClass="lovbutton"> </html:button>
		...
		<html:button property="noticeButton" styleId="noticeButton" onclick="closeLovCallonLov1();openLOVCommon(1521,'noticeCheckerForm','noticeDesc','','','','','','lbxNoticeCode');" value=" " styleClass="lovbutton"> </html:button>
		</td> 
    </tr>
	...
	<table>	
	 ...
	 <tr>
	 <td>
	 	  <button type="button" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return fnSearchNoticeChecker('<bean:message key="lbl.selectAtleast" />');" ><bean:message key="button.search" /></button>
...
<fieldset>
		 <legend><bean:message key="lbl.legalNoticeInitiationCheckerDetail"/></legend> 

  <logic:present name="list">
  
   <logic:notEmpty name="list">
    <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/noticeCheckerBehind.do" >
	...
	<display:column property="noticeDesc" titleKey="lbl.notice"  sortable="true"  />
	...
	<display:column property="reasonDesc" titleKey="lbl.legalReason"  sortable="true"  />
					...
					<tr>
						<td class="gridtd">
							...
							<td width="220" class="white2" style="width: 250px;" align="center">
									...
									<td width="220" class="white2" style="width: 250px;" align="center">
										<b><bean:message key="lbl.legalReason" /> <br> </b>
									</td>
									
									<td width="220" class="white2" style="width: 250px;" align="center">
										<b><bean:message key="lbl.makerRemarks" /> <br> </b>
									</td>
