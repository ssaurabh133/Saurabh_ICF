...
<li><a href= "noticeCheckerAdd.jsp"target="body" id="a"><span style="color: rgb(255, 255, 255);">Notice Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/noticeCheckerDispatchAction.do?method=noticeCheckerScreen " target="body" id="b"><span style="color: rgb(255, 255, 255);">Notice Checker</span></a></li>
	</ul>
</div>
