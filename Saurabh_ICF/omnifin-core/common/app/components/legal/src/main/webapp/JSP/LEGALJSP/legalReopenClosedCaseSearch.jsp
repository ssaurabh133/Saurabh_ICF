...
<fieldset>
<legend><bean:message key="lbl.legalReopenClosedCaseSearch"/></legend>
	<table width="100%">
	...
	<table>
	 ...
	 <tr>
	 <td>
	 	  <button type="button" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return fnSearchLegalReOpen('<bean:message key="lbl.selectAtleast" />');" ><bean:message key="button.search" /></button>
...
<fieldset>
		 <legend><bean:message key="lbl.legalReopenClosedCaseDtl"/></legend> 
