...
<li><a href="legalCourtProcessingMakerDataForReopen.jsp" target="body" id="a"><span style="color: rgb(255, 255, 255);">Court Processing Detail</span></a></li>
<li><a href="<%=request.getContextPath()%>/legalReopenClosedCaseDispatchAction.do?method=authorScreenForReopenClosedCase" target="body" id="b"><span style="color: rgb(255, 255, 255);">Reopen Closed Case Author</span></a></li>
