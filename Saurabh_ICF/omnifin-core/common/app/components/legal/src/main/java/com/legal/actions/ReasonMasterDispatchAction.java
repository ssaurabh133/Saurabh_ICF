...
import com.legal.vo.BranchMasterVo;
...
public class ReasonMasterDispatchAction extends DispatchAction {
	private static final Logger logger = Logger.getLogger(ReasonMasterDispatchAction.class.getName());
		public ActionForward openAddReason(ActionMapping mapping, ActionForm form,
	        ...
	        String sms="";
	        String  status="";
	//  String checkQuery = ConnectionDAOforEJB.singleReturn("select REASON_ID from COM_LEGAL_REASON_M where REASON_id='"+vo.getReasonId()+"'");
		...
		logger.info("Inside Reason Master Action.....displaying status...."+status);
			...
			public ActionForward openEditReason(ActionMapping mapping, ActionForm form,
				...
				ServletContext context = getServlet().getServletContext();
					...
					//	 String checkQuery = ConnectionDAOforEJB.singleReturn("select REASON_SHORT_CODE from COM_LEGAL_REASON_M where REASON_SHORT_CODE='"+reasonMastervo.getReasonShortcode()+"' and Reason_ID= '"+reasonMastervo.getReasonId()+"'");
