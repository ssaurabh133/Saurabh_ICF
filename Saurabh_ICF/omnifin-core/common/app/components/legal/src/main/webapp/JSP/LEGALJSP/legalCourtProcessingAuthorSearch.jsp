...
<fieldset>
<legend><bean:message key="lbl.legalCourtProcessingAuthor"/></legend>
	<table width="100%">
	...
	<table>
	 ...
	 <tr>
	 <td>
	 	  <button type="button" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return fnSearchLegalCourtAuthor('<bean:message key="lbl.selectAtleast" />');" ><bean:message key="button.search" /></button>
