...
public class AssignRejectCaseBehindAction extends Action  {
		private static final Logger logger = Logger.getLogger(AssignRejectCaseBehindAction.class.getName());
		...
		public ActionForward execute(ActionMapping mapping, ActionForm form,
			...
			DynaValidatorForm legalCaseInitiationMakerDynaValidatorForm= (DynaValidatorForm)form;
			org.apache.commons.beanutils.BeanUtils.copyProperties(vo, legalCaseInitiationMakerDynaValidatorForm);
...
//			logger.info("current page link ................ "+request.getParameter("d-49520-p"));
		    ...
		    logger.info("In AssignRejectCaseBehindAction....list"+list.size());
