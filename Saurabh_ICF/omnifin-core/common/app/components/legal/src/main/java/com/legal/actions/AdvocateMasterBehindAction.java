...
public class AdvocateMasterBehindAction extends Action  {
		private static final Logger logger = Logger.getLogger(AdvocateMasterBehindAction.class.getName());
		
		public ActionForward execute(ActionMapping mapping, ActionForm form,
				HttpServletRequest request, HttpServletResponse response) throws Exception {
			HttpSession session=request.getSession(false);
			ServletContext context = getServlet().getServletContext();
			logger.info(" ## In AdvocateMasterBehindAction() : .........");
			...
			AdvocateMasterVo vo = new AdvocateMasterVo(); //change
			...
			//change from here
			list= bp.searchAdvocateMasterData(vo);

		    logger.info("In AdvocateMasterBehindAction....list"+list.size());
