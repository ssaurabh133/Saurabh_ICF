...
<li><a href=reassign_Case_view.jsp target="body" id="a"><span style="color: rgb(255, 255, 255);">Re-Assign Case Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/reassignCaseAction.do?method=OpenScreen"  target="body" id="b"><span style="color: rgb(255, 255, 255);">Re-Assign Case Author</span></a></li>
	</ul>
</div>
