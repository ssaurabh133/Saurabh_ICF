...
public class CourtTypeMasterBehindAction extends Action  {
		private static final Logger logger = Logger.getLogger(CourtTypeMasterBehindAction.class.getName());
		
		public ActionForward execute(ActionMapping mapping, ActionForm form,
				HttpServletRequest request, HttpServletResponse response) throws Exception {
			HttpSession session=request.getSession(false);
			ServletContext context = getServlet().getServletContext();
			logger.info(" ## In CourtTypeMasterBehindAction() : .........");
			...
			CourtTypeMasterVo vo = new CourtTypeMasterVo(); //change
			...
			//change from here
			list= bp.searchCourtTypeMasterData(vo);

		    logger.info("In CourtTypeMasterBehindAction....list"+list.size());
