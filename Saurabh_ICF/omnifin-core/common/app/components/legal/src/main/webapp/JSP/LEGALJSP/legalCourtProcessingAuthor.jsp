...
Purpose :-  screen for the Court Processing Author
-->
...
<! [endif] -->
	...
	<html:form action="/legalCourtProcessingAuthorDispatch" method="POST" styleId="legalCourtProcessingAuthorForm">
  ...
  <legend><bean:message key="lbl.author"></bean:message></legend>
	...
	<tr>
		...
		<tr>
		 ...
		 <td><span style="float: left;">
		   <html:select property="decision" styleId="decision" onchange="hideAsterik(document.getElementById('decision').value);">
		     <html:option value="CPA">Approved</html:option>
             <html:option value="CPM">Send Back</html:option>
		...
		<tr>
	        <td> 
	       <button type="button" id="save" class="topformbutton2" onclick="return saveAuthorData();" title="Alt+V" accesskey="V" ><bean:message key="button.save" /></button>
...
<logic:present name="sms">
	...
	if('<%=request.getAttribute("sms").toString()%>'=='SBA')
	{
		...
		parent.location="<%=request.getContextPath()%>/legalCourtProcessingAuthorDispatch.do?method=searchLegalCourtProcessingAuthor";
