...
<body onload="enableAnchor();document.getElementById('legalCaseFileAuthorForm').lbxLoanId.focus();init_fields();">
<html:form action="/legalCaseFileAuthorDispatch" styleId="legalCaseFileAuthorForm" method="post" > 	
<div  align="center" class="opacity" style="display: none;"  id="processingImage"></div>
<html:hidden property="path" styleId="path" value="<%=request.getContextPath()%>"/>
<html:errors/>

<fieldset>
<legend><bean:message key="lbl.legalCaseFileAuthor"/></legend>
	<table width="100%">
	...
	<table>
	 ...
	 <tr>
	 <td>
	 	  <button type="button" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return fnSearchCaseTypeAuthor('<bean:message key="lbl.selectAtleast" />');" ><bean:message key="button.search" /></button>
...
<fieldset>
		 <legend><bean:message key="lbl.legalCaseFileDetail"/></legend> 

  <logic:present name="list">
   <logic:notEmpty name="list">
  <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/legalCaseFileAuthorDispatch.do" >
