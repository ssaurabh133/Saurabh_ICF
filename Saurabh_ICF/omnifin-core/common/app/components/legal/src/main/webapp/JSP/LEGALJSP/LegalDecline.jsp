...
<li><a href="Legal_decline_view.jsp" target="body" id="a"><span style="color: rgb(255, 255, 255);">Legal Notice Detail</span></a></li>
<li><a href="<%=request.getContextPath()%>/legalDeclineDispatchNoticeAction.do?method=OpenScreen"  target="body" id="b"><span style="color: rgb(255, 255, 255);">Decline/Dispatch Author</span></a></li>
	</ul>
</div>
