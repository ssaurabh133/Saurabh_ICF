...
public class StageTypeMasterBehindAction extends Action  {
		private static final Logger logger = Logger.getLogger(StageTypeMasterBehindAction.class.getName());
		
		public ActionForward execute(ActionMapping mapping, ActionForm form,
				HttpServletRequest request, HttpServletResponse response) throws Exception {
			HttpSession session=request.getSession(false);
			ServletContext context = getServlet().getServletContext();
			logger.info(" ## In StageTypeMasterBehindAction() : .........");
			...
			StageTypeMasterVo vo = new StageTypeMasterVo(); //change
...
//			//change from here
			list= bp.searchStageTypeMasterData(vo);

		    logger.info("In StageTypeMasterBehindAction....list"+list.size());
