...
<!--<li onclick="callFunction('/JSP/CMJSP/paymentMaker.jsp','');"><a href="#" target="body" id="a" onclick="activeTab(id);"><span style="color: rgb(255, 255, 255);">Payment Maker</span></a></li>-->
<!--<li onclick="callFunction('/paymentAuthorProcessAction.do?method=authorScreen','b');"><a href="#" target="body" id="b" onclick="activeTab(id);"><span style="color: rgb(255, 255, 255);">Payment Author</span></a></li>-->
<!---->
...
<li><a href="legalCaseFileMaker.jsp" target="body" id="a"><span style="color: rgb(255, 255, 255);">Case File Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/legalCaseFileAuthorDispatch.do?method=authorScreen" target="body" id="b"><span style="color: rgb(255, 255, 255);">Case File Author</span></a></li>
