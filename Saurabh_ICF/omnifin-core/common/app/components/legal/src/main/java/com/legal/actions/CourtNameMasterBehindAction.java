...
public class CourtNameMasterBehindAction extends Action  {
		private static final Logger logger = Logger.getLogger(CourtNameMasterBehindAction.class.getName());
		
		public ActionForward execute(ActionMapping mapping, ActionForm form,
				HttpServletRequest request, HttpServletResponse response) throws Exception {
			HttpSession session=request.getSession(false);
			ServletContext context = getServlet().getServletContext();
			logger.info(" ## In CourtNameMasterBehindAction() : .........");
			...
			CourtNameMasterVo vo = new CourtNameMasterVo(); //change
			...
			//change from here
			list= bp.searchCourtNameMasterData(vo);

		    logger.info("In CourtNameMasterBehindAction....list"+list.size());
