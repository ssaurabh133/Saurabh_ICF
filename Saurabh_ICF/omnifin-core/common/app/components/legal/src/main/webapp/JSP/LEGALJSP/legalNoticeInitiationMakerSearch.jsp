...
<body onload="enableAnchor();document.getElementById('legalNoticeInitiationMakerForm').focus();">
<html:form action="/legalNoticeInitiationMaker" styleId="legalNoticeInitiationMakerForm" method="post" > 	
...
<legend><bean:message key="lbl.legalNoticeInitiationMaker"/></legend>
	...
	<td>
		...
		<html:button property="loanNoButton" styleId="loanNoButton" onclick="closeLovCallonLov1();openLOVCommon(1516,'legalNoticeInitiationMakerForm','loanNo','','lbxLoanId','','','','customerName');" value=" " styleClass="lovbutton"> </html:button>
	...
	<table>	
	 ...
	 <tr>
	 <td>
	 	  <button type="button" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return fnSearchLegalNoticeInitiationMaker('<bean:message key="lbl.selectAtleast" />');" ><bean:message key="button.search" /></button>
	 	  <button type="button"  name="add" id="add" class="topformbutton2" title="Alt+N" accesskey="N" onclick="return newAddLegalNoticeInitiationMaker()" ><bean:message key="button.new" /></button></td>
...
<fieldset>
		 <legend><bean:message key="lbl.legalNoticeInitiationMakerDetail"/></legend> 

  <logic:present name="list">
   <logic:notEmpty name="list">
  <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/legalNoticeInitiationMakerBehind.do" >
    <display:setProperty name="paging.banner.placement"  value="bottom"/>
    <display:setProperty name="locale.resolver" value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
    <display:setProperty name="locale.provider" value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
	<display:column property="noticeId" titleKey="lbl.noticeId"  sortable="true"  />
							...
							<table width="100%" border="0" cellpadding="4" cellspacing="1">
								<tr>
									<td width="220" class="white2" style="width: 220px;" align="center">
										<strong><bean:message key="lbl.noticeId" /> </strong>
									</td>
