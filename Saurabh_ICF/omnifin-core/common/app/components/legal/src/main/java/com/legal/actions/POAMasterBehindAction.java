...
public class POAMasterBehindAction extends Action  {
		private static final Logger logger = Logger.getLogger(POAMasterBehindAction.class.getName());
		
		public ActionForward execute(ActionMapping mapping, ActionForm form,
				HttpServletRequest request, HttpServletResponse response) throws Exception {
			HttpSession session=request.getSession(false);
			ServletContext context = getServlet().getServletContext();
			logger.info(" ## In POAMasterBehindAction() : .........");
			...
			POAMasterVo vo = new POAMasterVo(); //change
			...
			//change from here
			list= bp.searchPOAMasterData(vo);

		    logger.info("In POAMasterBehindAction....list"+list.size());
