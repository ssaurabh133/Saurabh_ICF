...
public class LawFirmMasterBehindAction extends Action  {
		private static final Logger logger = Logger.getLogger(LawFirmMasterBehindAction.class.getName());
		
		public ActionForward execute(ActionMapping mapping, ActionForm form,
				HttpServletRequest request, HttpServletResponse response) throws Exception {
			HttpSession session=request.getSession(false);
			ServletContext context = getServlet().getServletContext();
			logger.info(" ## In LawFirmMasterBehindAction() : .........");
			...
			LawFirmMasterVo vo = new LawFirmMasterVo(); //change
			...
			//change from here
			list= bp.searchLawFirmMasterData(vo);

		    logger.info("In LawFirmMasterBehindAction....list"+list.size());
