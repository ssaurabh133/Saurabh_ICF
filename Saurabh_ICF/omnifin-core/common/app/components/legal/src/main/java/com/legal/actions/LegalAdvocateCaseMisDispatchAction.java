...
import com.legal.vo.LegalReportVo;
import com.login.dao.UserSessionCheck;
import com.login.roleManager.UserObject;
import com.reportUtility.ReportGenerateUtility;
public class LegalAdvocateCaseMisDispatchAction extends DispatchAction {
	private static final Logger logger = Logger.getLogger(LegalAdvocateCaseMisDispatchAction.class.getName());
	
	public ActionForward openAdvocateCaseMisSearchPage(ActionMapping mapping, ActionForm form,
	...
	public ActionForward generateLegalAdvocateCaseReprot(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception{	
		...
		try
		{
				...
				LegalReportVo vo = new LegalReportVo(); //change
				...
				String reportName="advocateReport";
				String reporttype="P";
				...
				hashMap.put("p_advocate_id",vo.getLbxUserId()); 
				hashMap.put("p_case_type",vo.getLbxCaseTypeCode());
