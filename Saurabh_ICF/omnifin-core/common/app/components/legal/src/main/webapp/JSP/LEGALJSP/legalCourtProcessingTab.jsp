...
<li><a href="<%=request.getContextPath() %>/legalCourtProcessingAuthorDispatch.do?method=makerScreen" target="body" id="a"><span style="color: rgb(255, 255, 255);">Court Processing Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/legalCourtProcessingAuthorDispatch.do?method=authorScreen" target="body" id="b"><span style="color: rgb(255, 255, 255);">Court Processing Author</span></a></li>
