...
public class LegalNoticeInitiationMakerBehindAction extends Action  {
		private static final Logger logger = Logger.getLogger(LegalNoticeInitiationMakerBehindAction.class.getName());
		...
		public ActionForward execute(ActionMapping mapping, ActionForm form,
			...
			//change from here
			list= bp.searchLegalNoticeInitiationMakerData(vo);
