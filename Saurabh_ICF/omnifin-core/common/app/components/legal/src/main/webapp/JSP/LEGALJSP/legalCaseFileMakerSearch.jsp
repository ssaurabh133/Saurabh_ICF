...
<body onload="enableAnchor();document.getElementById('legalCaseFileMakerForm').lbxLoanId.focus();init_fields();">
<html:form action="/legalCaseFileMakerDispatch" styleId="legalCaseFileMakerForm" method="post" > 	
...
<legend><bean:message key="lbl.legalCaseFileMaker"/></legend>
	...
	<table>
	 ...
	 <tr>
	 <td>
	 	  <button type="button" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return fnSearchCaseType1('<bean:message key="lbl.selectAtleast" />');" ><bean:message key="button.search" /></button>
...
<fieldset>
		 <legend><bean:message key="lbl.legalCaseFileMakerDetail"/></legend> 

  <logic:present name="list">
   <logic:notEmpty name="list">
  <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/legalCaseFileMakerDispatch.do" >
