	 ...
	 if(docFile != '') {
	  	if((ext1.toUpperCase()=='XLS')&& abc1=="excel"){
	    	...
	    	return true;
			  ...
			  document.getElementById("ExcelSheetUpload").action = basePath+'/glExcelSheetUpload.do?actionName=saveCsv';
			document.getElementById("processingImage").style.display = '';
			document.getElementById("ExcelSheetUpload").submit();
			return true;
		 }else{
...
<div>
<div>
<html:form action="glExcelSheetUpload" method="post" styleId="ExcelSheetUpload" enctype="multipart/form-data">
...
<table width="100%"  border="0" cellspacing="7" cellpadding="0" >
	...
	<logic:notPresent name="show">
        ...
        <td><html:radio property="radioButton" styleClass="" styleId="abc1"  value="csv" tabindex="2" /><bean:message key="lbl.csv" />
       	</td>  
      </logic:notPresent>
 ...
 <logic:present name="errorMsg">
       <script type="text/javascript">	
			alert("<%=request.getAttribute("errorMsg")%>");
			 var basePath=document.getElementById("context").value;	
		     document.getElementById("ExcelSheetUpload").action = basePath+'/glExcelSheetUpload.do?actionName=openExcel';
		     document.getElementById("ExcelSheetUpload").submit(); 
       </script>
 </logic:present>
