...
<li><a href= "repoMarkingAuthorAdd.jsp"target="body" id="a"><span style="color: rgb(255, 255, 255);">Repo Marking Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/repoMarkingAuthorDispatch.do?method=repoMarkingAuthorCaseScreen " target="body" id="b"><span style="color: rgb(255, 255, 255);">Repo Marking Author</span></a></li>
	</ul>
</div>
