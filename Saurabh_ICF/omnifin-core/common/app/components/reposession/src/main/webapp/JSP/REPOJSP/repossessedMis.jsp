...
<html:form styleId="repossessedMisForm"  method="post"  action="/repossessedMISDispatchAction" >
<div  align="center" class="opacity" style="display: none;"  id="processingImage"></div>
<fieldset>
<legend><bean:message key="lbl.repossessedMis" /></legend>
  <table width="100%">
	...
	<td>
		...
		<html:button property="loanNoButton" styleId="loanNoButton" onclick="closeLovCallonLov1();openLOVCommon(1613,'repossessedMisForm','loanNo','','lbxLoanId','','','','customerName');" value=" " styleClass="lovbutton"> </html:button>
		...
		<html:button property="stockyardButton" styleId="stockyardButton" onclick="closeLovCallonLov1();openLOVCommon(1619,'repossessedMisForm','stockYardDesc','','','','','','lbxStockYard');" value=" " styleClass="lovbutton"> </html:button>
		</td>
    ...
    <tr>
		...
		<html:button property="approverNameButton" styleId="approverNameButton" onclick="closeLovCallonLov1();openLOVCommon(1621,'repossessedMisForm','approverName','','','','','','lbxUserId');" value=" " styleClass="lovbutton"> </html:button>
		</td>
		...
		<html:button property="agencyButton" styleId="agencyButton" onclick="closeLovCallonLov1();openLOVCommon(1623,'repossessedMisForm','agency','','','','','','lbxAgencyId');" value=" " styleClass="lovbutton"> </html:button>
		</td>
    ...
    <tr>
		...
		<button type="button" name="generateReport" id="generateReport" title="Alt+G" accesskey="G" onclick="return generateRepossessedReport();" class="topformbutton3" ><bean:message key="button.generatereport" /></button>
