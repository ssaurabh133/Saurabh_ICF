...
<legend><bean:message key="lbl.repoMarkingMakerSearch"/></legend>
	...
	<td>
		...
		<html:button property="loanNoButton" styleId="loanNoButton" onclick="closeLovCallonLov1();openLOVCommon(1615,'repoMarkingMakerForm','loanNo','','lbxLoanId','','','','customerName');" value=" " styleClass="lovbutton"> </html:button>
	...
	<td>
		...
		<html:button property="productButton" styleId="productButton" tabindex="1"  onclick="openLOVCommon(1617,'repoMarkingMakerForm','repoProduct','','', '','','','lbxProductSearchID')" value=" " styleClass="lovbutton"></html:button>  
	 ...
	 <tr>
	 <td>
	 	  <button type="button" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return fnSearchRepoMarkingMaker('<bean:message key="lbl.selectAtleast" />');" ><bean:message key="button.search" /></button>
 <button type="button"  name="add" id="add" class="topformbutton2" title="Alt+N" accesskey="N" onclick="return newAddRepoMarkingMaker()" ><bean:message key="button.new" /></button></td>
	</tr>
	 </table>
</fieldset>
...
<fieldset>
  ...
  <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/repoMarkingMakerDispatch.do?method=searchRepoMarkingMaker" >
