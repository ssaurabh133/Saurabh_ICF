...
<li><a href="repoConfirmationMaker.jsp" target="body" id="a"><span style="color: rgb(255, 255, 255);">Repo Confirmation Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/RepoConfirmationDispatch.do?method=repoAuthorScreen"  target="body" id="b"><span style="color: rgb(255, 255, 255);">Repo Confirmation Author</span></a></li>
	</ul>
</div>
