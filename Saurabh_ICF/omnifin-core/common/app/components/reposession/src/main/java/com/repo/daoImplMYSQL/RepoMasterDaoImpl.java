...
public class RepoMasterDaoImpl implements RepoMasterDAO{

	private static final Logger logger = Logger.getLogger(RepoMasterDaoImpl.class.getName());
	...
	public ArrayList searchStockyardMasterData(Object ob) {
		...
		try {
			...
			bufInsSqlTempCount.append(" WHERE 5=5 ");
			 ...
			 bufInsSql.append(" ORDER BY STOCKYARD_CODE ");
	...
	public ArrayList searchRepoAsset(Object ob) {
		...
		try {
			...
			if (!ProductSearchID.equals("")) {
				 ...
				 bufInsSql.append(" ORDER BY RAPDM.PRODUCT_ID");
