...
public class RepoRepossessedMisDispatchAction extends DispatchAction {
	private static final Logger logger = Logger.getLogger(RepoRepossessedMisDispatchAction.class.getName());
	
	public ActionForward openRepossessedMISSearchPage(ActionMapping mapping, ActionForm form,
	...
	public ActionForward generateRepossessedMis(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception{	
		...
		try
		{
				...
				String reportName="repossessedApprovedCaseMis";
				String reporttype="P";
