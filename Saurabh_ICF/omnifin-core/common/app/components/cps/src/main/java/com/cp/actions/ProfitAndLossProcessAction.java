 ...
 */
public class ProfitAndLossProcessAction extends DispatchAction {
	private static final Logger logger = Logger.getLogger(ProfitAndLossProcessAction.class.getName());
	DecimalFormat myFormatter = new DecimalFormat("###,###.####");
	ResourceBundle resource = ResourceBundle.getBundle("com.yourcompany.struts.ApplicationResources");
	public ActionForward saveProfitAndLossDetails(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		// TODO Auto-generated method stub
			 logger.info("In ProfitAndLossProcessAction.............................. ");
		  	boolean flag =false;
			...
			if(userobj!=null)
			{
				...
				logger.info("here in saveProfitAndLossDetails method of ProfitAndLossProcessAction action the session is out----------------");
			...
			DynaValidatorForm FinancialAnalysisPNBDynaValidatorForm = (DynaValidatorForm) form;
			FinancialAnalysisVo vo=new FinancialAnalysisVo();
			FinancialAnalysisParamVo fvo=new FinancialAnalysisParamVo();
			org.apache.commons.beanutils.BeanUtils.copyProperties(vo, FinancialAnalysisPNBDynaValidatorForm);
			org.apache.commons.beanutils.BeanUtils.copyProperties(fvo, FinancialAnalysisPNBDynaValidatorForm);
			Date date;
			...
			{
				status=uploadFile(request,response,(FormFile)FinancialAnalysisPNBDynaValidatorForm.get("docFile"),userId,businessDate,dealId,"P");
				logger.info("Uploaded and processing status  :  "+status);
				if(CommonFunction.checkNull(status).trim().equalsIgnoreCase(""))
				{
					ArrayList data=dao.getUploadedData(dealId,userId,"P");
			...
			String ids=dao.saveProfitandBalance(vo);
			if(vo.getNegativeActive().equalsIgnoreCase("Y") ){
				idss=dao.saveProfitandBalanceWithMinus(fvo);
			}
...
//								}
					...
					request.setAttribute("profitLossAllDetailsByDeal", paramCodeValues);
...
//						}
				...
				//session.setAttribute("profitLossParamCodeValues", paramCodeValues);
				session.setAttribute("profitLossAllMinusDetailsByDeal", minusParamCodeValues);
				//session.removeAttribute("profitLossAllDetailsByDeal");
