...
<ul>
	<li><a href="<%=request.getContextPath()%>/varifComplFieldVerificationSaveAction.do?method=openTabVerifCompletionModule" id="a" onclick="activeTab(id);"><span ><bean:message key="lbl.ver.initiation"/></span></a></li>
	<li><a href="<%=request.getContextPath()%>/varifComplFieldVerificationSaveAction.do?method=showTabVerificationCompletionModule" id="b" onclick="activeTab(id);"><span ><bean:message key="lbl.ver.initiatedto"/></span></a></li>
