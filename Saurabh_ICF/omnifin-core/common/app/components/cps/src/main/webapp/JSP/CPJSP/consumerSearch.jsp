...
<! [endif] -->
	...
	<html:form action="/cibilCustomer" method="post" styleId="CibilReportForm">
<html:hidden property="contextPath" styleId="contextPath" value="<%=request.getContextPath() %>" />
	...
	<tr>
		...
		<td width="35%" valign="top">
			...
			<html:button property="dealButton" styleId="dealButton" onclick="closeLovCallonLov1();openLOVCommon(336,'CibilReportForm','dealNo','userId','dealNo', 'userId','','','customername');closeLovCallonLov1();" value=" " styleClass="lovbutton"> </html:button>
	  ...
	  <td><bean:message key="lbl.customerName"/></td>
        ...
        <td > 
	        ...
	        <html:button property="productButton" styleId="productButton" onclick="openLOVCommon(87,'CibilReportForm','product','userId','scheme','lbxscheme|userId','','','productId');closeLovCallonLov1();" value=" " styleClass="lovbutton"> </html:button>
            ...
            <td width="20%">
               ...
               <html:text property="scheme" styleId="scheme" styleClass="text" readonly="true" tabindex="-1"/>
          		<html:hidden  property="lbxscheme" styleId="lbxscheme"  />
          		 ...
          		 <html:button property="productButton" styleId="productButton" onclick="openLOVCommon(22,'CibilReportForm','scheme','product','lbxscheme', 'lbxProductID','Please Select Product','','schemeId');closeLovCallonLov('product');" value=" " styleClass="lovbutton"> </html:button>
	         ...
	         <td>
		            <html:text property="selectiveBranch" styleClass="text" styleId="selectiveBranch" maxlength="100" readonly="true" value=""/>
		     		<html:hidden property="lbxBranchId" styleClass="text" styleId="lbxBranchId" value=""/>
		      		<html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="openLOVCommon(505,'CibilReportForm','lbxBranchId','','', '','','','selectiveBranch')" value=" " styleClass="lovbutton"  ></html:button>
				</td>
	         </tr>
<!--       		 <tr>-->
<!--			    <td width="13%">-->
...
<!--					  	<html:button property="userButton" styleId="userButton" onclick="openLOVCommon(266,'CibilReportForm','userName','userId','', 'userId','','','reportingToUserId')" value=" " styleClass="lovbutton"></html:button>-->
<!--   					  </td>-->
<!--			    </tr>	-->
		 ...
		 <tr>
		     ...
		     <td align="left">
		    <button type="button" name="cibilSearchButton" id="cibilSearchButton" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return searchCibilReportDeal('F');"><bean:message key="button.search" /></button>
		    </td>
...
<tr>
    ...
    <td><b><bean:message key="lbl.dealStatus"/> </b></td>
 ...
 <logic:notEmpty name="list">
  <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/cibilCustomer.do" >
