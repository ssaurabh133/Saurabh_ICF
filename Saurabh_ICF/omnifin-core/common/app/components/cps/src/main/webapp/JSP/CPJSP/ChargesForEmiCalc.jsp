...
<head>
	...
	<script type="text/javascript"
		src="<%=request.getContextPath() %>/js/cpScript/creditProcessingForEmiCalc.js"></script>
		<script type="text/javascript"
