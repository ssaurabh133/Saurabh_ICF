...
<style>
	...
	<body onload="enableAnchor();" onclick="parent_disable();" >
	...
	<legend><bean:message key="lbl.buyersCheck"/> </legend>
          ...
          <tr>
                 ...
                 <tr>
                   ...
                   <td><html:text property="viewAppraisalDate" styleClass="text" styleId="viewAppraisalDate" tabindex="-1" maxlength="10" value="${list[0].appraisalDate}" readonly="true" onchange="return checkDate('appraisalDate');"/></td>
