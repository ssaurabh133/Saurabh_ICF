...
<!--	<body onload="enableAnchor();generateReceiptReport();document.getElementById('receiptMakerSearch').loanAccountButton.focus();init_fields();" onunload="closeAllLovCallUnloadBody();">-->
	...
	<html:form action="/imdMakerProcessAction" method="post" styleId="imdMakerSearch">
	   ...
	   <fieldset>	  
	<legend><bean:message key="lbl.imdAuthorSearch"/></legend>         
	...
	<tr>
	 ...
	 <tr>	   
		  <td><bean:message key="lbl.dealNo"></bean:message> </td>
             ...
             <html:button property="dealNoButton" styleId="dealNoButton" onclick="openLOVCommon(1392,'imdMakerSearch','dealNo','','', '','','','customerName','lbxBPNID')" value=" " styleClass="lovbutton"></html:button>
		 ...
		 <html:option value="S">Adjustment</html:option>	            
           ...
           <input type="hidden"  name="lbxreceiptMode" id="lbxreceiptMode"/>
				 ...
				 <td>
				    ...
				    <html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="openLOVCommon(282,'imdMakerSearch','userName','userId','', 'userId','','','reportingToUserId')" value=" " styleClass="lovbutton"  ></html:button>
				 </td>
		    ...
		    <tr>		   
          <td>
	       <button type="button" class="topformbutton2"  id="search" onclick="return imdAuthorSearch('<bean:message key="msg.plsSelOneCriteria"/>');" title="Alt+S" accesskey="S"><bean:message key="button.search" /></button>
		</td>
		  </tr>
		</table>
	   ...
	   <fieldset>	  
	<legend><bean:message key="lbl.imdMakerSearch"/></legend>         
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
		  ...
		  <td><bean:message key="lbl.dealNo"></bean:message> </td>
		     <td>
		      <input type="hidden" name="contextPath" value="<%=request.getContextPath() %>" id="contextPath"/>
		     <html:text styleClass="text" property="dealNo" styleId="dealNo" maxlength="20"  value="" readonly="true" tabindex="-1"/>
             <html:button property="dealNoButton" styleId="dealNoButton" onclick="openLOVCommon(503,'imdMakerSearch','dealNo','','', '','','','customerName','lbxBPNID')" value=" " styleClass="lovbutton"></html:button>
             <html:hidden  property="lbxDealNo" styleId="lbxDealNo" value="" />
             <html:hidden  property="lbxBPNID" styleId="lbxBPNID" value=""/>
            <!--   <img onclick="openLOVCommon(123,'paymentMakerSearch','loanAccountNumber','','', '','','','customerName')" src="<%= request.getContextPath()%>/images/lov.gif"/>-->
	...
	<input type="hidden" name="contextPath" value="<%=request.getContextPath() %>" id="contextPath"/>
		   ...
		   <tr>
		    ...
		    <tr>
				 ...
				 <td>
				    ...
				    <html:hidden property="lbxUserId" styleId="lbxUserId" value=""/>
				    <input type="hidden" name="userId" id="userId" value="${userobject.userId}" />
				    <html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="openLOVCommon(266,'imdMakerSearch','userName','userId','', 'userId','','','reportingToUserId')" value=" " styleClass="lovbutton"  ></html:button>
				 </td>
	     ...
	     <button type="button" class="topformbutton2" id="search" onclick="return imdSearch('<bean:message key="msg.plsSelOneCriteria"/>');" title="Alt+S" accesskey="S"><bean:message key="button.search" /></button>
	 	 <button type="button" name="button2" class="topformbutton2" onclick="return newImdMaker();" title="Alt+N" accesskey="N"><bean:message key="button.new" /></button>
...
<bean:message key="lbl.noDataFound" />
    ...
    <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1"  partialList="true" size="${list[0].totalRecordSize}" requestURI="/imdMakerSearch.do" >
    <display:setProperty name="paging.banner.placement"  value="bottom"/>
    <display:setProperty name="locale.resolver" value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
    <display:setProperty name="locale.provider" value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
    <display:column property="modifyNo" titleKey="lbl.dealNo"  sortable="true"  />
...
<bean:message key="lbl.noDataFound" />
  ...
  <logic:present name="authordetailList">	
    ...
    <display:table  id="sublist"  name="authordetailList" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1"  partialList="true" size="${authordetailList[0].totalRecordSize}" requestURI="/imdAuthorProcessAction.do?method=imdAuthorSearchDetail" >
    <display:setProperty name="paging.banner.placement"  value="bottom"/>
    <display:setProperty name="locale.resolver" value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
    <display:setProperty name="locale.provider" value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
    <display:column property="modifyNo" titleKey="lbl.dealNo"  sortable="true"  />
