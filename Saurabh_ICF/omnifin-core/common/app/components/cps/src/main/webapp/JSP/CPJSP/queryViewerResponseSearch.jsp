<!--
 	...
 	Date of Creation :-07/09/2012
 	Purpose          :- To provide user interface for Query response search
 	Documentation    :- 
 -->
...
<! [endif] -->
	...
	<html:form action="/querResponseSearchBehindAction" method="post" styleId="queryResponseSearchForm">
	<input type="hidden" id="contextPath" name="contextPath" value="<%= request.getContextPath()%>"/>
	<input type="hidden" name="userId" id="userId" value="${userobject.userId}" />
	
	<fieldset>	  
	  <legend>
	  <bean:message key="lbl.querResponseSearch"/>
	...
	<tr>
		...
		<td width="35%">
			...
			<html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="closeLovCallonLov1();openLOVCommon(409,'queryResponseSearchForm','dealNo','','', '','','','customername')" value=" " styleClass="lovbutton"></html:button>
	  </td>
	  <td width="17%"><bean:message key="lbl.customerName"/></td>
        ...
        <td> 
	        ...
	        <html:button property="productButton" styleId="productButton" onclick="openLOVCommon(408,'queryResponseSearchForm','product','userId','scheme','lbxscheme|userId','','','productId');closeLovCallonLov1();" value=" " styleClass="lovbutton"> </html:button>
	       </td>
            ...
            <td width="20%">
              ...
              <html:text property="scheme" styleId="scheme" styleClass="text" readonly="true" tabindex="-1"/>
          		...
          		<input type="hidden" id="schemeId" name="schemeId"/>
          		 <html:button property="schemeButton" styleId="schemeButton" onclick="openLOVCommon(22,'queryResponseSearchForm','scheme','product','lbxscheme', 'lbxProductID','Please Select Product','','schemeId');closeLovCallonLov('product');" value=" " styleClass="lovbutton"> </html:button>
                </td>
		</tr> 
		...
		<%-- 	
		 ...
		 <tr>
		  <td align="left" class="form2" colspan="4">
		    <button type="button" name="searchButton" id="searchButton" class="topformbutton2" accesskey="S" title="Alt+S" onclick="searchQueryResponse();"><bean:message key="button.search" /></button>
		  </td>
		  </tr>
		</table>
...
<fieldset>	
		 <legend><bean:message key="lbl.querResponseSearch"/></legend>  
	...
	<tr>
	    ...
	    <td colspan="6"><bean:message key="lbl.noDataFound" /></td>
    	  		 ...
    	  		 <logic:present name="list">
						...
						<display:table id="list" name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/querResponseSearchBehindAction.do"> 
