...
<li onclick="callFunction('/balanceSheetBehindAction.do?method=balanceSheetBehindDetail','b');"><a href="#" target="body" id="b" onclick="activeTab(id);"><span><bean:message key="lbl.balanceSheet" /></span></a></li>
