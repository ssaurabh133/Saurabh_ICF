 	  ...
 	  <table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr class="white2">
          ...
          <tr class="white2">
	          ...
	          <td><b><bean:message key="lbl.currentStage"/></b></td>
	          <logic:equal name="functionId" value="8000312">
	          	<td>Pre-Deal Capturing</td>
	          </logic:equal>
	          <logic:notEqual name="functionId" value="8000312">
...
<logic:notPresent name="viewDeal">
    ...
    <input type="hidden" name="entityType" id="entityType" value="PRAPPL" />
...
<!--   </logic:present>-->
  ...
  <tr>
    <td class="gridtd">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr class="white2">
          <td   ><strong><bean:message key="lbl.applicantName" /></strong></td>
            ...
            <html:option value="N">NA</html:option><!-- Virender -->
	               ...
	               <logic:equal name="subdocuments" property="docStatus" value="D">
		            ...
		            <logic:equal name="subdocuments" property="docStatus" value="R">
		            	 ...
		            	 <html:text property="recievedDate" styleClass="text6"  readonly="true" styleId="recievedDate${i}" value="${subdocuments.recieveDate}" />
		            </logic:equal>
             ...
             <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','PRAPPL');"%>Upload/Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','PRAPPL');">Upload/Download</td>
               </logic:notEqual>
               
              <%-- <td align="center"  id="dwnl${i}"><a href="#" onclick="downloadDocuments('${subdocuments.realDocId}','${subdocuments.entityId}','PRAPPL');">Download</a></td> --%>
          </tr>
       </logic:iterate>
        ...
        <tr class="white2">
          ...
          <logic:present name="additionalDocuments">
            ...
            <html:option value="AW">As And When</html:option><!-- Virender -->
          		...
          		<td>         
         			<html:select property="additionalDocStatus" styleClass="" styleId="additionalDocStatus${i }" value="${subdocuments.addnDocStatus}" onchange="makeChoiceAdditional(${i+1});" style="width:10%;">
...
<logic:present name="documents">  
 ...
 <button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocument('A','Y');"><bean:message key="button.save" /></button>
 </logic:present>
 <logic:notPresent name="dataFound">
 <button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocument('A','N');"><bean:message key="button.save" /></button>
 </logic:notPresent>
 ...
 <logic:present name="loanInitDocs">
 <button type="button" name="button3" id="button3" class="topformbutton4" title="Alt+T" accesskey="T" onclick="viewDocument('applicantDealDocs');"><bean:message key="button.viewDocs" /></button>
 </logic:present>
</logic:present>
</td>
  </tr>
...
else if('<%=request.getAttribute("sms").toString()%>'=='COLLATERAL')
{
  ...
  <logic:present name="viewDeal">
	...
	<fieldset>
	<legend><bean:message key="lbl.applicantDocs" /></legend>  
    ...
    <td class="gridtd">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="4">
        <tr class="white2">
          ...
          <td ><b><bean:message key="lbl.DOC-TYPE" /></b></td>
          <td ><b><bean:message key="lbl.status" /></b></td>
          <td ><strong><bean:message key="lbl.statusDate" /></strong></td>
...
<!--           <html:option value="">--Select--</html:option>-->
   ...
   <html:hidden property="childId" styleId="childId${i }" value="${subdocuments.docChildId}" />   
         ...
         <logic:present name="FileManagement">
             	...
             	<logic:notPresent name="FileManagement">
             	 <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','PRAPPL');"%>Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','PRAPPL');">Download</td>
               </logic:notEqual>
               </logic:notPresent>
...
<!-- <html:button property="button" value="Save" styleClass="topformbutton2" onclick="return saveDocument('A');"/>-->
