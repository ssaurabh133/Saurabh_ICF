...
<body onload="enableAnchor();diffLead(<%=session.getAttribute("leadpageid")%>);document.getElementById('leadButton').focus();">
	...
	<html:form action="/leadCapturingSearchBehind" styleId="leadCapturing" method="post">
   ...
   <input type="hidden" name="userId" id="userId" value="${userobject.userId}" />
		...
		<fieldset>
			...
			<table width="100%">
				...
				<tr>
					<td width="13%">
						<bean:message key="lbl.leadSource" />
					</td>
					<td width="13%">
...
<br/>
							...
							<table width="100%" border="0" cellpadding="4" cellspacing="1">
								...
								<logic:notPresent name="list">
									<td width="220" class="white2" style="width: 220px;">
										<strong><bean:message key="lbl.leadno" /> </strong>
									</td>
									...
									<td width="220" class="white2" style="width: 220px;">
										<strong><bean:message key="lbl.source" /> </strong>
									</td>
									<td width="220" class="white2" style="width: 220px;">
										<strong><bean:message key="lbl.gendate" /> </strong>
									</td>
									<td width="220" class="white2" style="width: 220px;">
		...
		<logic:present name="list">
				...
				<display:table id="list" name="list" style="width: 100%" 
					...
					requestURI="/leadCapturingSearchBehind.do">
					...
					<display:setProperty name="locale.provider"
						value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
					<display:column property="leadno" titleKey="lbl.leadno"
						sortable="true" />
					<display:column property="applicationdate" titleKey="lbl.gendate"
						sortable="true" />
					...
					<display:column property="scheme" titleKey="lbl.scheme"
						sortable="true" />
					<display:column property="leadGenerator" titleKey="lbl.source"
						sortable="true" />
