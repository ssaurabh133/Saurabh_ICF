...
<logic:notPresent name="viewDeal">
    ...
    <input type="hidden" name="entityType" id="entityType" value="COAPPL" />
                   
	<fieldset>
	<legend><bean:message key="lbl.coApplicantDocs" /> </legend>  
<!--	<logic:present name="loanInitDocs">-->
...
<!--   </logic:present>-->
  ...
  <tr>
    <td class="gridtd">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
         <tr class="white2">
          <td   ><strong><bean:message key="lbl.coApplicantName" /></strong></td>
...
<!--           <html:option value="">--Select--</html:option>-->
   ...
   <html:hidden property="childId" styleId="childId${i }" value="${subdocuments.docChildId}" />   
             ...
             <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','COAPPL');"%>Upload/Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','COAPPL');">Upload/Download</td>
               </logic:notEqual>
               
              <%-- <td align="center"  id="dwnl${i}"><a href="#" onclick="downloadDocuments('${subdocuments.realDocId}','${subdocuments.entityId}','COAPPL');">Download</a></td> --%>
          </tr>
       </logic:iterate>
...
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocument('CA','Y');"><bean:message key="button.save" /></button>
</logic:present>   
<logic:notPresent name="dataFound">
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocument('CA','N');"><bean:message key="button.save" /></button>
</logic:notPresent>
 ...
 <logic:present name="loanInitDocs">
 <button type="button" name="button3" id="button3" class="topformbutton4" title="Alt+T" accesskey="T" onclick="return viewDocument('coApplicantDealDocs');"><bean:message key="button.viewDocs" /></button>
 </logic:present>
</logic:present>
...
<script type="text/javascript">
	...
	{
		alert('<bean:message key="lbl.CoappDocNotFound" />');
	}
	else
	{
...
<!--           <html:option value="">--Select--</html:option>-->
   ...
   <html:hidden property="childId" styleId="childId${i }" value="${subdocuments.docChildId}" />
             ...
             <td  id="rem${i }"><html:text property="remarks" styleClass="text1" styleId="remarks" value="${subdocuments.remark}" disabled="true"  maxlength="50" /></td>
             	...
             	<logic:notPresent name="FileManagement">
             	<logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','COAPPL');"%>Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','COAPPL');">Download</td>
               </logic:notEqual>
                </logic:notPresent>
...
<!-- Changes By Amit Starts -->  
  ...
  <tr>
	...
	<logic:present name="FileManagement">
			<tr>
		<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveReceiveDocument('CA');"><bean:message key="button.save" /></button>
		</tr>
	</logic:present>
<!-- Changes By Amit Ends -->
