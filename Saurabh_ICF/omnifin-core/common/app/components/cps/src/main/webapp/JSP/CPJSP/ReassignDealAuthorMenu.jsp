...
<li><a href="<%=request.getContextPath()%>/dealReassignmentAuthor.do?method=showEditDealDataAuthorTab" id="a"><span>Deal Re-Assignment Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/dealReassignmentAuthor.do?method=openReassignDealAuthor" id="b"><span>Deal Re-Assignment Author</span></a></li>
</ul>
</div>
