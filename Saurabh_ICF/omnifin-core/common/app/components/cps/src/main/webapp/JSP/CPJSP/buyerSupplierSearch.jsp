...
<! [endif] -->
	...
	<body  onload="enableAnchor();document.getElementById('buyerSupplierSearchForm').dealButton.focus();">
	...
	<html:form action="/buyerSuppMainAction" method="post" styleId="buyerSupplierSearchForm">
	
	<html:hidden property="contextPath" styleId="contextPath" value="<%=request.getContextPath() %>" />
	<input type="hidden" name="userId" id="userId" value="${userobject.userId}" />
	
    <logic:present name="buySuppMaker"> 
    
	<fieldset>	 	 
	  <legend><bean:message key="lbl.buySuppMaker"/></legend>         
	...
	<tr>
		...
		<td width="35%" valign="top">
			...
			<html:button property="dealButton" styleId="dealButton" onclick="openLOVCommon(237,'buyerSupplierSearchForm','dealNo','','', '','','','customerName')" value=" " styleClass="lovbutton"> </html:button>
	 ...
	 <tr>
       ...
       <td width="20%">
	        ...
	        <html:button property="productButton" styleId="productButton" onclick="openLOVCommon(259,'buyerSupplierSearchForm','product','','','','','','productId')" value=" " styleClass="lovbutton"> </html:button>
        ...
        <td width="8%"><bean:message key="lbl.scheme"/></td>
            <td width="20%">
               ...
               <html:text property="scheme" styleId="scheme" styleClass="text" readonly="true" tabindex="-1"/>
          	   ...
          	   <html:button property="productButton" styleId="productButton" onclick="openLOVCommon(22,'buyerSupplierSearchForm','scheme','product','lbxscheme', 'lbxProductID','Please Select Product','','schemeId')" value=" " styleClass="lovbutton"> </html:button>
        ...
        <td width="13%">
				      ...
				      <td width="13%">
						<html:hidden property="reportingToUserId" styleClass="text" styleId="reportingToUserId"  />
					  	...
					  	<html:button property="userButton" styleId="userButton" onclick="openLOVCommon(266,'buyerSupplierSearchForm','userName','userId','', 'userId','','','reportingToUserId')" value=" " styleClass="lovbutton"></html:button>
		 ...
		 <tr>
		  	<td align="left">
		 	    ...
		 	    <button type="button" name="search" id="searchButton" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return newSearchBuyerSupplier();"><bean:message key="button.search" /></button>
 ...
 <logic:present name="buySuppAuthor"> 
    
	<fieldset>	 	 
	  <legend><bean:message key="lbl.buySuppAuthor"/></legend>         
	...
	<tr>
		...
		<td width="35%" valign="top">
			...
			<html:button property="dealButton" styleId="dealButton" onclick="openLOVCommon(238,'buyerSupplierSearchForm','dealNo','','', '','','','customerName')" value=" " styleClass="lovbutton"> </html:button>
	        <%-- <img onclick="openLOVCommon(21,'commonForm','dealNo','','', '','','','customername')" src="<%= request.getContextPath()%>/images/lov.gif"  />--%> 	  
       </td>
        ...
        <td width="8%"><bean:message key="lbl.scheme"/></td>
            <td width="20%">
               ...
               <td width="13%">
				      ...
				      <td width="13%">
						<html:text property="reportingToUserId" styleClass="text" styleId="reportingToUserId"
						...
						<html:button property="userButton" styleId="userButton"
									onclick="openLOVCommon(266,'buyerSupplierSearchForm','reportingToUserId','','', 'userId','','','lbxUserId')"
		 ...
		 <tr>
		  	<td align="left">
		 	    ...
		 	    <button type="button" name="search" id="searchButton" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return newSearchBuyerSupplierAuthor();"><bean:message key="button.search" /></button>
...
<fieldset>	
 <legend><bean:message key="lbl.dealDetails"/></legend>  
 <logic:present name="dealdetails">
 <logic:notEmpty name="dealdetails">

   <display:table  id="dealdetails"  name="dealdetails" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" size="${dealdetails[0].totalRecordSize}" partialList="true" requestURI="/buyerSuppBehindAction.do" >
...
<!--		window.close();-->
<!--	}-->
<!--	 else if('<%=request.getAttribute("sms").toString()%>'=='Locked')-->
<!--	{-->
