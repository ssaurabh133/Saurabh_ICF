...
import com.connect.DaoImplInstanceFactory;
	...
	public class preDealSearchAction extends Action {
		
		private static final Logger logger = Logger.getLogger(preDealSearchAction.class.getName());
            public ActionForward execute(ActionMapping mapping, ActionForm form,
        		...
        		if(userobj!=null)
        		{
        			...
        			logger.info("here in execute method of preDealSearchAction action the session is out----------------");
			...
			ArrayList<Object> getCommonLeadData = lp.getCommonLeadDatafromjsp(ob,tracking);
