...
<table cellSpacing=0 cellPadding=0 width="100%" border=0>
  <tr>
	...
	<html:form styleId="notepadForm" action="/notepadInCPProcessAction" method="post">
...
<input type="hidden" name="contextPath" id="contextPath" value="<%=request.getContextPath() %>"/>
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
		    	...
		    	<table width="100%" border="0" cellspacing="1" cellpadding="1">
		        	<tr>
	 				...
	 				<tr>
						...
						<td ><textarea name="meetingRemarks" id="meetingRemarks" class="text" maxlength="1000" ></textarea></a></td>
		...
		<tr>
		   	<td align="left" >		   	
		    <button type="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveNotepadDataInCp('<bean:message key="msg.DateGrtrFd" />');" ><bean:message key="button.save" /></button></td>
		   	<td align="left" >&nbsp;</td>
		   	<td align="left" >&nbsp;</td>
		   	<td >&nbsp;</td>
		</tr>
