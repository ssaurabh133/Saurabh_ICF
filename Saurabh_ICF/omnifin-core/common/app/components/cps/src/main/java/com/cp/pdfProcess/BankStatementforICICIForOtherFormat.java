...
public class BankStatementforICICIForOtherFormat {
	private static final Logger logger = Logger.getLogger(BankStatementforICICIForOtherFormat.class.getName());
	...
	public static final String SAMPLE_PDF_FILE_ICICI = "D:\\SamplePDFs\\ICICI2.pdf";
	...
	{
		BankStatementforICICIForOtherFormat pdfReader = new BankStatementforICICIForOtherFormat();
		System.out.println("\n\n**************************\n\n");
	...
	public static ArrayList readUsingIText$ICICI(UnderwritingDocUploadVo vo ,String fileNameWithAbsolutePath, String firstHeadingLineColLabel) 
	{
		...
		try
		{
			...
			BankStatementSimpleTextExtractionStrategy9 textExtractionStrategyInstance = null;
			
		   /*float colStartPositions[] = {110.00f,570.00f,440.00f,10.00f,520.00f,50.00f,310.00f,640.00f};  Actual 
			 float colEndPositions[] = {310.00f,640.00f,520.00f,50.00f,600.00f,110.00f,440.00f,720.00f};*/
			/*float colStartPositions[] =   {193.00f,577.00f,450.00f,22.00f,501.00f,61.00f,362.00f,632.00f};	For Header 
			 float colEndPositions[] = {243.00f,620.00f,489.00f,48.00f,560.00f,112.00f,403.00f,701.00f};*/
			float colStartPositions[] =   {110.00f,440.00f,520.00f,600.00f,640.00f,10.00f,50.00f,310.00f};	//For Data 
			 float colEndPositions[] = {310.00f,520.00f,600.00f,640.00f,720.00f,50.00f,110.00f,440.00f};
			
			
			for (int i = 1; i <= reader.getNumberOfPages(); i++) 
			{
			    textExtractionStrategyInstance = new BankStatementSimpleTextExtractionStrategy9();
