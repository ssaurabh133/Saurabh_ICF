...
<tr>
    ...
    <tr  class="white1">
		...
		<td align="center">
			...
			<a href='#' onClick="downloadFilefordocumentupload('${uploadedDocSubList.fileName}','${count}');"><img style=\"cursor:pointer\" src="<%=request.getContextPath()%>/images/theme1/invoiceDownload1.png" width="18" height="18" ></a>	
		</td>
        </tr>
        </logic:iterate>
        </logic:notEmpty>
    ...
    <tr  class="white1">
        ...
        <td align="center">
			...
			<a href='#' onClick="downloadFilefordocumentupload('${uploadedDocSubListForCp.fileName}','${count}');"><img style=\"cursor:pointer\" src="<%=request.getContextPath()%>/images/theme1/invoiceDownload1.png" width="18" height="18" ></a>	
		</td>
        </tr>
        </logic:iterate>
        </logic:present>
