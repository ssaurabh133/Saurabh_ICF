...
import com.connect.DaoImplInstanceFactory;
	...
	public class preDealCommonAction extends Action {
		
		private static final Logger logger = Logger.getLogger(preDealCommonAction.class.getName());
            public ActionForward execute(ActionMapping mapping, ActionForm form,
        		...
        		if(userobj!=null)
        		{
        			...
        			logger.info("here in execute method of preDealCommonAction action the session is out----------------");
			...
			org.apache.commons.beanutils.BeanUtils.copyProperties(ob, LeadProcessingDynaValidatorForm);
			   ...
			   PreDealDao lp=(PreDealDao)DaoImplInstanceFactory.getDaoImplInstance(PreDealDao.IDENTITY);
			   	...
			   	request.setAttribute("capturing", "capturing");
