...
<li><a href="imdMaker.jsp" target="body" id="a"><span style="color: rgb(255, 255, 255);">IMD Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/imdAuthorProcessAction.do?method=imdAuthorScreen"  target="body" id="b"><span style="color: rgb(255, 255, 255);">IMD Author</span></a></li>
	</ul>
</div>
