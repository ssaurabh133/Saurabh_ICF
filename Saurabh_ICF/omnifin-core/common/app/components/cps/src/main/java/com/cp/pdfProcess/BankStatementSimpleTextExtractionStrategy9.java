...
public class BankStatementSimpleTextExtractionStrategy9 implements
		TextExtractionStrategy {

    private Vector lastStart;
    private Vector lastEnd;
    private float lastPagePositionStart =20.0f;
     ...
     */
    public BankStatementSimpleTextExtractionStrategy9() 
    {
