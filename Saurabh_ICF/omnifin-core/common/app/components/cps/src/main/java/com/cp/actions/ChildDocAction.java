 ...
 */
public class ChildDocAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		logger.info("In ChildDocAction(execute) loan/deal id: " + commonId
		...
		collectedDocsQ=collectedDocsQ+ "' AND STAGE_ID='" + stage;
		
		collectedDocsQ=collectedDocsQ+ "' AND TXNID='" + commonId+"' AND DOC_TYPE='"+entityType+"' AND ENTITY_ID='"+entityId+"'" ;
