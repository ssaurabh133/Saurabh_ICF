...
<logic:notPresent name="css">
	<link type="text/css" rel="stylesheet" href="<%=request.getContextPath() %>/css/theme1/displaytable.css"/>
		...
		<script type="text/javascript" src="<%=request.getContextPath() %>/js/cpScript/notePadInCP.js"></script>
...
<! [endif] -->
	...
	<html:form action="/searchNotePadBehindInCP" method="post" styleId="CreditFormInNotePad">
	...
	<td>
	         ...
	         <html:text property="dealNo" styleId="dealNo" styleClass="text" readonly="true" tabindex="-1"/>
          	 <html:hidden  property="lbxDealNoHID" styleId="lbxDealNoHID"  />

  			 <html:button property="loanButton" styleId="loanButton" onclick="closeLovCallonLov1();openLOVCommon(501,'CreditFormInNotePad','dealNo','','lbxDealNoHID', '','','','customerName');" value=" " styleClass="lovbutton"></html:button>
...
<%--        <html:button property="productButton" styleId="productButton" onclick="openLOVCommon(86,'CreditFormInNotePad','product','userId','scheme', 'lbxscheme|userId','','','hCommon');closeLovCallonLov1();" value=" " styleClass="lovbutton"></html:button> --%>
		...
		<tr>
	      ...
	      <td align="left" class="form2" colspan="4">
	          <button type="button" name="search" title="Alt+S" accesskey="S" id="searchButton" class="topformbutton2" onclick="return searchDealForNotePad();"><bean:message key="button.search" /></button>
		  </td>
...
<logic:notEmpty name="list"> 
  <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1"  partialList="true" size="${list[0].totalRecordSize}" requestURI="/searchNotePadBehindInCP.do" >
