...
<logic:notPresent name="viewDeal">
	...
	<fieldset>
	<legend><bean:message key="lbl.assetDocs" /></legend>  
<!--	<logic:present name="loanInitDocs">-->
...
<!--           <html:option value="">--Select--</html:option>-->
   ...
   <html:hidden property="childId" styleId="childId${i }" value="${subdocuments.docChildId}" />   
             ...
             <td  id="rem${i }"><html:text property="remarks" styleClass="text1" styleId="remarks${i }" value="${subdocuments.remark}"  maxlength="50" /></td>
                ...
                <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','ASSET');"%>Upload/Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','ASSET');">Upload/Download</a></td>
               </logic:notEqual>
...
<!--           <html:option value="">--Select--</html:option>-->
    ...
    <html:hidden property="childId" styleId="childId${i }" value="${subdocuments.docChildId}" /> 
			...
			<logic:notPresent name="FileManagement">
             	 <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','ASSET');"%>Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','ASSET');">Download</a></td>
               </logic:notEqual>
             </logic:notPresent>
               <%-- <td align="center"  id="dwnl${i}" style="display: none"><a href="#" onclick="downloadDocumentsPrj('${subdocuments.realDocId}');">Download</a></td>
