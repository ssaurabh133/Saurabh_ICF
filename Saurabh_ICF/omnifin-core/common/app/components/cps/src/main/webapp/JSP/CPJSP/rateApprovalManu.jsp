...
<li><a href="<%=request.getContextPath()%>/JSP/CPJSP/rateApprovalDetail.jsp" target="body" id="a"><span style="color: rgb(255, 255, 255);">Rate Approval Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/rateApprovalChecker.do?method=openRateChecker" target="body" id="b"><span style="color: rgb(255, 255, 255);">Rate Approval Checker</span></a></li>
</ul>
</div>
