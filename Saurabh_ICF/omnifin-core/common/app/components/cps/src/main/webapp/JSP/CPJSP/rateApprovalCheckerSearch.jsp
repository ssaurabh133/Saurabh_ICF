...
<html:form action="/rateApprovalChecker" styleId="rateApprovalChecker" method="post" > 	
<html:hidden property="contextPath" styleId="contextPath" value="<%=request.getContextPath()%>"/>
<fieldset><legend><bean:message key="lbl.rateApprovalCheckerSearch"/></legend>
	<table width="100%">
	<tr>	
		...
		<td>
			...
			<html:button property="lovDealButton" styleId="lovDealButton" onclick="openLOVCommon(2021,'rateApprovalChecker','dealNo','loginUserId','','loginUserId','','','customerName');" value=" " styleClass="lovbutton"></html:button>
        </td>  
	...
	<tr>
		<td><button type="button" name="search" title="Alt+S" accesskey="S" id="button" class="topformbutton2" onclick="return searchrateApprovalAuthor();"><bean:message key="button.search" /></button></td>
	</tr>
    </table>
</fieldset>
</html:form>
...
<display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/rateApprovalMaker.do?method=defaultRateChecker" >
