<!--
 	...
 	Date of Creation :- 
 	Purpose          :- To provide user interface for Deviation Approval search
 	Documentation    :- 
 -->
...
<! [endif] -->
	...
	<html:form action="/deviationApprovalSearchBehindAction" method="post" styleId="deviationApprovalSearchForm">
	<input type="hidden" id="contextPath" name="contextPath" value="<%= request.getContextPath()%>"/>
	<input type="hidden" name="userId" id="userId" value="${userobject.userId}" />
	
	<fieldset>	  
	  <legend>
	  <bean:message key="lbl.deviationApprovalSearch"/>
	...
	<tr>
		...
		<td width="35%">
			...
			<html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="closeLovCallonLov1();openLOVCommon(276,'deviationApprovalSearchForm','dealNo','','', '','','','customername')" value=" " styleClass="lovbutton"></html:button>
	  </td>
      ...
      <input type="hidden" name="userId" value="" id="userId" />
	        ...
	        <html:button property="productButton" styleId="productButton" onclick="openLOVCommon(87,'deviationApprovalSearchForm','product','userId','scheme','lbxscheme|userId','','','productId');closeLovCallonLov1();" value=" " styleClass="lovbutton"> </html:button>
	       </td>
            ...
            <td width="20%">
              ...
              <html:text property="scheme" styleId="scheme" styleClass="text" readonly="true" tabindex="-1"/>
          		...
          		<input type="hidden" id="schemeId" name="schemeId"/>
          		 <html:button property="productButton" styleId="productButton" onclick="openLOVCommon(22,'deviationApprovalSearchForm','scheme','product','lbxscheme', 'lbxProductID','Please Select Product','','schemeId');closeLovCallonLov('product');" value=" " styleClass="lovbutton"> </html:button>
                </td>
		</tr> 	
			    <tr>
			    <td width="13%">
				      ...
				      <td width="13%">
						<html:hidden property="reportingToUserId" styleClass="text" styleId="reportingToUserId"  />
					  	...
					  	<html:button property="userButton" styleId="userButton" onclick="openLOVCommon(266,'deviationApprovalSearchForm','userName','userId','', 'userId','','','reportingToUserId')" value=" " styleClass="lovbutton"></html:button>
   					  
   					  </td>
			    </tr>
		 <tr>
		  <td align="left" class="form2" colspan="4">
		   <button type="button" name="search" id="search" class="topformbutton2" accesskey="S" title="Alt+S" onclick="return searchDeviationApprovalDeals();"><bean:message key="button.search" /></button>
		  </td>
		  </tr>
		</table>
	...
	<tr>
	    ...
	    <td colspan="6"><bean:message key="lbl.noDataFound" /></td>
    	  		 ...
    	  		 <logic:present name="list">
						...
						<display:table id="list" name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/deviationApprovalSearchBehindAction.do"> 
