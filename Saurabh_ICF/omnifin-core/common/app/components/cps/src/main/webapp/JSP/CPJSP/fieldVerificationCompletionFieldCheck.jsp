...
<button type="button" name="search" id="searchButton" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveFiedlCheck();"><bean:message key="button.save" /></button>
 </td>
</tr>
 </table>
 ...
 <logic:present name="sms">
	...
	parent.location="<%=request.getContextPath()%>/fieldVarificationCompletionBehindAction.do";
