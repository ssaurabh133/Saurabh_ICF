...
Date of Creation:- 13/01/2014
Purpose:-  The purpose of this page is to enter details of insurance tab.
-->
...
<body oncontextmenu="return false" onload="insuranceServiceCalled();sumAssuredPercent();enableAnchor();checkChanges('cpInsuranceForm');document.getElementById('cpInsuranceForm').insuranceProvider.focus();">
...
<logic:notPresent name="reload">
	...
	<html:form styleId="cpInsuranceForm" action="/cpInsurance" method="post">
					...
					<html:optionsCollection name="insuranceProducts" label="insuranceProduct" value="insuranceProductId" />
	  				...
	  				<tr>
	  				 ...
	  				 <td width="20%"><bean:message key="lbl.sumAssuPer" /><span><font color="red">*</font></span></td>
	                     <td ><html:text property="sumAssuPer" styleClass="text" styleId="sumAssuPer"  onchange="sumAssuredAmount();clearData();" onkeypress="return isNumberKey(event);" value="${allInsuranceData[0].sumAssuPer}"  maxlength="6"/></td>
		                
	  				
	  				
	  				 <td width="20%"><bean:message key="lbl.sumAssured" /><span><font color="red">*</font></span></td>
	                     <td ><html:text property="sumAssured" styleClass="text" styleId="sumAssured" onchange="sumAssuredAmountPercentage();" readonly="false"   value="${allInsuranceData[0].sumAssured}" /></td>
		    	...
		    	<table width="100%" border="0" cellspacing="1" cellpadding="1">
					...
					<tr>
						...
						<input type="button" class="lovbutton" id="stateButton"
							onclick="openLOVCommon(256,'cpInsuranceForm','txtStateCode','','txtStateCode', '','','','snomineeState')"
							value="" name="stateButton" />
							<input type="hidden" name="txtStateCode" id="txtStateCode"
								value="${allInsuranceData[0].txtStateCode}" />
					</td>
	                    <%-- <td><html:text property="snomineeState" styleClass="text"  styleId="snomineeState" value="${allInsuranceData[0].snomineeState}"></html:text></td> --%>
			...
			<td>
		    	<table width="100%" border="0" cellspacing="1" cellpadding="1">
					...
					<tr>
						...
						<input type="button" class="lovbutton" id="stateButton"
							onclick="openLOVCommon(192025,'cpInsuranceForm','txtStateCode1','','txtStateCode1', '','','','sNomineeState1')"
							value="" name="stateButton" />
			...
			<td>
		    	<table width="100%" border="0" cellspacing="1" cellpadding="1">
					...
					<tr>
						...
						<input type="button" class="lovbutton" id="stateButton"
							onclick="openLOVCommon(192026,'cpInsuranceForm','txtStateCode2','','txtStateCode2', '','','','sNomineeState2')"
							value="" name="stateButton" />
			...
			<td>
		    	<table width="100%" border="0" cellspacing="1" cellpadding="1">
					...
					<tr>
						...
						<input type="button" class="lovbutton" id="stateButton"
							onclick="openLOVCommon(192027,'cpInsuranceForm','txtStateCode3','','txtStateCode3', '','','','sNomineeState3')"
							value="" name="stateButton" />
			...
			<td>
		    	<table width="100%" border="0" cellspacing="1" cellpadding="1">
					...
					<tr>
						...
						<input type="button" class="lovbutton" id="stateButton"
							onclick="openLOVCommon(192028,'cpInsuranceForm','txtStateCode4','','txtStateCode4', '','','','sNomineeState4')"
							value="" name="stateButton" />
...
<table id="gridTable" width="100%"  border="0" cellspacing="4" cellpadding="0">
<tr>
    <td class="gridtd">
		...
		<td>${objcustomerDetailList.customerConstitution }</td>
			...
			<tbody>
					<tr>
					 	...
					 	<td>  <button type="button" name="calc" id="calc" class="topformbutton2" title="Alt+l" accesskey="l" onclick="calculateInsurance('cpInsuranceForm');" ><bean:message key="button.calcInsurance"  /></button>
      					 <button type="button"  name="save" id="save" class="topformbutton2" title="Alt+V" accesskey="V" onclick="saveCpInsurance();clear();" ><bean:message key="button.save" /></button> 
 						 </td>
					</tr>
			</tbody>
			</table>
...
<tr>
	...
	<logic:present name="saveInsuranceData">
		...
		<td ><a href="#" id="anchor0" onclick="relodInsuranceData(${objSaveInsuranceData.insuranceId});">${objSaveInsuranceData.insuranceProvider}</a></td>
		<td >${objSaveInsuranceData.insuranceProduct }</td>
		<td>${objSaveInsuranceData.customerId }</td>
		<td>${objSaveInsuranceData.insurancePremium }</td>
		 ...
		 <%-- <logic:empty name="saveInsuranceData">
...
<logic:present name="saveInsuranceDataDelete">
   <tr><td >
  	  <button type="button"  name="delete" id="delete" class="topformbutton2" title="Alt+D" accesskey="D" onclick="deleteCpInsurance();" ><bean:message key="button.delete" /></button>
	      </td></tr>
	 </logic:present>
</table>
		    	...
		    	<table width="100%" border="0" cellspacing="1" cellpadding="1">
					...
					<html:optionsCollection name="insuranceProducts" label="insuranceProduct" value="insuranceProductId" />
	  				...
	  				<tr>
	  				 ...
	  				 <td width="20%"><bean:message key="lbl.sumAssuPer" /><span><font color="red">*</font></span></td>
	                     <td ><html:text property="sumAssuPer" styleClass="text" styleId="sumAssuPer"  onchange="sumAssuredAmount();clearData();" value="${reload[0].sumAssuPer}"  maxlength="6"/></td>
		                
	  				
	  				
	  				 <td width="20%"><bean:message key="lbl.sumAssured" /><span><font color="red">*</font></span></td>
	                     <td ><html:text property="sumAssured" styleClass="text" styleId="sumAssured" readonly="true"  onchange="sumAssuredAmountPercentage();" value="${reload[0].sumAssured}" /></td>
					...
					<html:optionsCollection name="policyTypes" label="policyType" value="policyTypeId" />
	 				...
	 				<tr>
	 					...
	 					<td><bean:message key="lbl.insurancePremium" /><span><font color="red">*</font></span></td>
						<td> <html:text property="insurancePremium" styleId="insurancePremium" styleClass="text" readonly="true" onkeypress="return isNumberKey(event);" value="${reload[0].insurancePremium}" maxlength="6" /> </td>
		                ...
		                <html:hidden  property="lbxOtherChargeId" styleId="lbxOtherChargeId" value="${reload[0].lbxOtherChargeId}" />
...
<logic:present name="viewmode">
	...
	<html:form styleId="cpInsuranceForm" action="/cpInsurance" method="post">
    		...
    		<input type="hidden" name="saddressType1" id="saddressType1"  value="${viewList[0].saddressType1}"/>
			...
			<td>
		    	<table width="100%" border="0" cellspacing="1" cellpadding="1">
					...
					<html:optionsCollection name="InsuranceProviders" label="insuranceProvider" value="chargeId" />
		                ...
		                <td width="35%"> 
		                <div id="insuranceProductDiv">
		                <html:text property="insuranceProduct" styleClass="text" styleId="insuranceProduct" readonly="true"   value="${viewList[0].insuranceProduct}" />
...
<%-- 						</html:select> --%>
	  				...
	  				<tr>
	  				 ...
	  				 <td width="20%"><bean:message key="lbl.sumAssuPer" /><span><font color="red">*</font></span></td>
	                     <td ><html:text property="sumAssuPer" styleClass="text" styleId="sumAssuPer" onchange="sumAssuredAmount();clearData();" disabled="true"  value="${viewList[0].sumAssuPer}"  maxlength="6"/></td>
		                
	  				
	  				
	  				 <td width="20%"><bean:message key="lbl.sumAssured" /><span><font color="red">*</font></span></td>
	                     <td ><html:text property="sumAssured" styleClass="text" styleId="sumAssured" readonly="true" onchange="sumAssuredAmountPercentage();"  value="${viewList[0].sumAssured}" /></td>
	                 ...
	                 <td><bean:message key="lbl.policyTenure" /><span><font color="red">*</font></span></td>
		                <td > 
	                    <html:text property="policyTenure" styleId="tenure" readonly="true" styleClass="text" onchange="clearData();"  value="${viewList[0].policyTenure}" maxlength="3" /> </td>
...
<!-- <table width="100%"  border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td>
		    	<table width="100%" border="0" cellspacing="1" cellpadding="1">
		        	<tr>
		            	<td width="20%"><bean:message key="lbl.sPrefix" /><span><font color="red">*</font></td>
		            	<td width="35%">
	  					<html:select styleId="sPrefix" property="sPrefix" disabled="true" styleClass="text" value="${viewList[0].sPrefix}"  >
							<html:option value="">---Select---</html:option>
							<html:option value="M">Mr</html:option>
		            	...
		            	<td width="20%"><bean:message key="lbl.SnomineeFName" /><span><font color="red">*</font></td>
	                     <td ><html:text property="nomineeName" styleClass="text" disabled="true" styleId="nomineeName"   value="${viewList[0].nomineeName}" /></td>
		              </tr>
					<tr>
						<td width="20%"><bean:message key="lbl.SnomineeMName" /><span><font color="red">*</font></td>
	                     <td ><html:text property="nomineeMName" styleClass="text" disabled="true" styleId="nomineeMName"   value="${viewList[0].nomineeMName}" /></td>
					...
					<td width="20%"><bean:message key="lbl.gender" /><span><font color="red">*</font></td>
		   			...
		   			<tr>
						<td width="20%"><bean:message key="lbl.SmaritalStatus" /><span><font color="red">*</font></td>
		                <td width="35%">
	  					<html:select styleId="smaritalStatus" property="smaritalStatus" disabled="true" styleClass="text" value="${viewList[0].smaritalStatus}"  >
							<html:option value="">---Select---</html:option>
							<html:option value="M">Married</html:option>
						...
						<td width="20%"><bean:message key="lbl.relationShp" /><span><font color="red">*</font></td>
						 <td width="35%">
	  					<html:select property="relationshp" styleId="relationshp" styleClass="text"  disabled="true" value="${viewList[0].relationshp}"  >
   					    <html:option value="">--Select--</html:option>
   					    <logic:present name="relationshps">
					...
					<tr>
						...
						<td width="20%"><bean:message key="lbl.sPercentage" /><span><font color="red">*</font></td>
	                     <td ><html:text property="percentage" styleClass="text" styleId="percentage" disabled="true" onkeypress="return isPercentKey(evt);" onblur="return checkRate('percentage');" value="${viewList[0].percentage}" /></td>
						<%-- <td width="20%"><bean:message key="lbl.addr" /></td>
	                    <td><html:textarea property="addr" styleClass="text" styleId="addr" value="${allInsuranceData[0].addr}"></html:textarea><td> --%>
		           		<td width="20%"><bean:message key="lbl.sNomineeStreet" /></td>
...
<script>
	parent.menu.document.test.getFormName.value = document.getElementById("cpInsuranceForm").id;
</script>
</body>
</html:html>
...
<script type="text/javascript">
	...
	else if('<%=request.getAttribute("sms").toString()%>'=='notCal')
	{
		alert('<bean:message key="msg.noCombination" />');
	...
	else if('<%=request.getAttribute("sms").toString()%>'=='combiExist')
	{
		...
		{
		alert('<bean:message key="msg.oneInsurance"/>');
		}
