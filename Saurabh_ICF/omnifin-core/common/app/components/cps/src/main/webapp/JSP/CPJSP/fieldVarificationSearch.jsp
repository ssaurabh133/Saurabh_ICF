...
<logic:present name="verifCMS">
	...
	<tr>
		...
		<td width="35%" valign="top">
	         ...
	         <html:text property="loanNo" styleId="loanNo" styleClass="text" readonly="true" tabindex="-1"/>
  			 ...
  			 <html:button property="loanButton" styleId="loanButton" onclick="openLOVCommon(1372,'CreditForm','loanNo','','lbxLoanNoHID', '','','','customerName');" value=" " styleClass="lovbutton"></html:button>	  
       </td>
	...
	--%>		
		 <tr>
		  	<td align="left">
		 	    <button type="button" name="search" id="searchButton" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return newLoanSearchInitaition();"><bean:message key="button.search" /></button>
		    </td>
...
<logic:notEmpty name="loandetails">
   <display:table  id="loandetails"  name="loandetails" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" size="${loandetails[0].totalRecordSize}" partialList="true" requestURI="/fieldVarificationBehindAction.do?method=verificationInitCreditManagement" >
    <display:setProperty name="paging.banner.placement"  value="bottom"/>
    <display:setProperty name="locale.resolver" value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
    <display:setProperty name="locale.provider" value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
...
<tr>
    ...
    <tr class="white2">
        <td ><b><bean:message key="lbl.loanNumber"/></b></td>
         <td><b><bean:message key="lbl.customerName"/></b></td>
        <td><b><bean:message key="lbl.product"/></b></td>
        <td><b><bean:message key="lbl.scheme"/> </b></td>
