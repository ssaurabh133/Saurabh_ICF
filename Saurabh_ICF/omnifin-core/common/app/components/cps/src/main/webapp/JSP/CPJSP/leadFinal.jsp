...
<body oncontextmenu="return false" onload="enableAnchor();checkChanges('leadNotepadForm');document.getElementById('leadNotepadForm').noteCode.focus();">
...
<div id="centercolumn">
	...
	<logic:notPresent name="viewDeal1">
	<html:form styleId="leadNotepadForm" action="/leadNotePadAction" method="post">
<fieldset>
...
<logic:equal name="status" value="np">
	<html:hidden property="txnType" value="LT"/>
</logic:equal>
...
<input type="hidden" name="contextPath" id="contextPath" value="<%=request.getContextPath() %>"/>
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
		    	...
		    	<table width="100%" border="0" cellspacing="1" cellpadding="1">
		        	<tr>
	  				...
	  				<tr>
	                    ...
	                    <td><bean:message key="lbl.meetingLocation" /><font color="red">*</font></td>
		                <td > 
		...
		<tr>
		   	<td align="left" >		   	
		    <button type="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveLeadNotepadData('<bean:message key="msg.MDateGrtrFd" />');" ><bean:message key="button.save" /></button></td>
		   	<td align="left" >&nbsp;</td>
		   	<td align="left" >&nbsp;</td>
		   	<td >&nbsp;</td>
		</tr>
			...
			<td class="gridtd">
				<table width="100%" border="0" cellspacing="1" cellpadding="1">
    				<tr class="white2">
						...
						<td><strong><bean:message key="lbl.notes"/></strong></td>
...
<script>
	setFramevalues("leadNotepadForm");
</script>
