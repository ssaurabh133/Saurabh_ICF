...
<logic:notPresent name="viewDeal">
    ...
    <input type="hidden" name="entityType" id="entityType" value="ASSET" />
                   
	<fieldset>
	<legend><bean:message key="lbl.PODDocs" /></legend>  
<!--	<logic:present name="loanInitDocs">-->
...
<!--   </logic:present>-->
  ...
  <tr>
    <td class="gridtd">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
         <tr class="white2">
          <td   ><strong><bean:message key="lbl.assetName" /></strong></td>
            <td   ><strong><bean:message key="lbl.assetDesc" /></strong></td>
   ...
   <html:hidden property="childId" styleId="childId${i }" value="${subdocuments.docChildId}" />   
	           <td  id="rec${i }">
	               <logic:equal name="subdocuments" property="docStatus" value="D">
		              <input type="text" name="recievedDate" id="recievedDate${i }"  class="text6" readonly="readonly"  value="${subdocuments.recieveDate}" />
		            </logic:equal>
             ...
             <td id="def${i }">
               ...
               <logic:equal name="subdocuments" property="docStatus" value="R">
                   <input type="text" name="deferedDate"  id="deferedDate${i }" readonly="readonly" class="text6" value="${subdocuments.deferDate}" />
               </logic:equal>
                 <logic:equal name="subdocuments" property="docStatus" value="O">
                   <input type="text" name="deferedDate" id="deferedDate${i }" readonly="readonly" class="text6" />
               </logic:equal>
               <logic:equal name="subdocuments" property="docStatus" value="D">
                ...
                <logic:equal name="subdocuments" property="docStatus" value="P">
		              <input type="text" name="deferedDate" id="deferedDate${i }"class="text6" readonly="readonly"  value="${subdocuments.deferDate}" />
		         </logic:equal>
		         <logic:equal name="subdocuments" property="docStatus" value="W">
		             <input type="text" name="deferedDate" id="deferedDate${i }"class="text6" readonly="readonly"  value="${subdocuments.deferDate}" />
		         </logic:equal>
             ...
             <td  id="rem${i }"><html:text property="remarks" styleClass="text1" styleId="remarks${i }" value="${subdocuments.remark}"  maxlength="50" /></td>
                ...
                <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','${subdocuments.docType}');"%>Upload/Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','${subdocuments.docType}');">Upload/Download</a></td>
               </logic:notEqual>
                  
              <%-- <td align="center"  id="dwnl${i}" style="display: none"><a href="#" onclick="downloadDocumentsPrj('${subdocuments.realDocId}');">Download</a></td> --%>
			  
			  <%-- <td align="center"  id="dwnld${i}" style=""><a href="#" onclick="downloadDocuments('${subdocuments.realDocId}','${subdocuments.entityId}','ASSET');">Download</a></td> --%>
            ...
            <html:option value="AW">As And When</html:option><!-- Virender -->
          		...
          		<td>         
         			<html:select property="additionalDocStatus" styleClass="" styleId="additionalDocStatus${i }" value="${subdocuments.addnDocStatus}" onchange="OTCPDDMarkingAdd(${i });makeChoiceAdditional(${i+1});" style="width:10%;">
            			<html:option value="P">Pending</html:option>
            			<html:option value="R">Received</html:option>
            			<%-- <html:option value="O">OTC</html:option> --%>
            			<html:option value="D">Deferred</html:option>
            			<html:option value="W">Waived</html:option>
            			<html:option value="N">NA</html:option><!-- Virender -->
          			</html:select>
...
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocument('AS','Y');"><bean:message key="button.save" /></button>
</logic:present>   
<logic:notPresent name="dataFound">
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocument('AS','N');"><bean:message key="button.save" /></button>
</logic:notPresent>
 ...
 <button type="button" name="button2" id="button2" class="topformbutton4" title="Alt+R" accesskey="R" onclick="removeRow();"><bean:message key="button.removeDocs" /></button>
  ...
  <logic:present name="loanInitDocs">
 <button type="button" name="button3" id="button3" class="topformbutton4" title="Alt+T" accesskey="T" onclick="viewDocument('assetDealDocs');"><bean:message key="button.viewDocs" /></button>
 </logic:present>
</logic:present>
...
<script type="text/javascript">
	...
	{
		alert('<bean:message key="lbl.assDocNotFound" />');
...
<!--           <html:option value="">--Select--</html:option>-->
    ...
    <html:hidden property="childId" styleId="childId${i }" value="${subdocuments.docChildId}" /> 
			...
			<logic:notPresent name="FileManagement">
             	 <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','${subdocuments.docType}');"%>Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','${subdocuments.docType}');">Download</a></td>
               </logic:notEqual>
             </logic:notPresent>
               <%-- <td align="center"  id="dwnl${i}" style="display: none"><a href="#" onclick="downloadDocumentsPrj('${subdocuments.realDocId}');">Download</a></td>
...
<logic:present name="FileManagement">
			<tr>
		<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveReceiveDocument('AS');"><bean:message key="button.save" /></button>
		</tr>
	</logic:present>
<!-- Changes By Amit Ends -->
