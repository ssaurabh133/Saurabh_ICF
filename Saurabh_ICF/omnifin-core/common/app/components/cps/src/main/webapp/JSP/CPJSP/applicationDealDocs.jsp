...
<td ><b><bean:message key="lbl.DOC-TYPE" /></b></td>          <td ><b><bean:message key="lbl.status" /></b></td>
     ...
     <!-- Virender code end -->          <td >
          ...
          <html:select property="status" disabled="true" styleClass="" styleId="status${i}" value="${subdocuments.docStatus}" onchange="makeChoice(${i});">
<!--           <html:option value="">--Select--</html:option>-->
    	...
    	<html:hidden property="childId" styleId="childId${i }" value="${subdocuments.docChildId}" /> 
             ...
             <td  id="def${i}">
               ...
               <logic:notEqual name="subdocuments" property="docStatus" value="R">${subdocuments.deferDate}
