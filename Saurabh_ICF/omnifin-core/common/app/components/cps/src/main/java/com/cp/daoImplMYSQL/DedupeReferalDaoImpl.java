...
import com.cp.dao.DedupeReferalDao;
import com.cp.vo.CreditProcessingLeadDetailDataVo;
import com.cp.vo.dedupeReferalVo;
import com.logger.LoggerMsg;

public class DedupeReferalDaoImpl implements DedupeReferalDao {
	...
	private static final Logger logger = Logger
			.getLogger(DedupeReferalDaoImpl.class.getName());
			...
			try{
				...
				if(!CommonFunction.checkNull(txnType).equalsIgnoreCase("") && !CommonFunction.checkNull(txnID).equalsIgnoreCase(""))
				{
					if(txnType.equalsIgnoreCase("LE"))
					{
						...
						query.append("if(a.CUSTOMER_DOB='0000-00-00',null,a.CUSTOMER_DOB)as CUSTOMER_DOB ,a.DRIVING_LICENSE,a.VOTER_ID,a.PASSPORT_NUMBER,a.FATHER_HUSBAND_NAME,a.FIRST_NAME,a.MIDDLE_NAME,a.LAST_NAME,if(a.DATE_OF_INCORPORATION='0000-00-00',null,a.DATE_OF_INCORPORATION)as DATE_OF_INCORPORATION, a.REGISTRATION_NUMBER,a.UID,a.VAT_REGISTRATION,a.TIN_NUMBER,a.REFERENCE_NO,a.SOURCE_SYSTEM,a.DISTRICT,a.ADDRESS_LINE1,a.ADDRESS_LINE2,a.ADDRESS_LINE3,a.ADDRESS_STRING,a.PARTNER,a.DEAL_NO,a.DEAL_STATUS,a.dedupe_remarks,a.pincode,a.STATE,a.ALTERNATE_PHONE  FROM cr_customer_search_dtl  A ");
						query.append("join cr_lead_customer_m b on a.customer_id=b.customer_id  and a.lead_id=b.lead_id ");
				   ...
				   if(txnType.equalsIgnoreCase("DC") ){
					   query.append("SELECT A.DEAL_ID,A.CUSTOMER_ID,A.CUSTOMER_NAME,A.PRIMARY_PHONE,A.CUSTOMER_EMAIL,A.CUSTOMER_TYPE,A.CUSTOMER_CONSTITUTION,A.CUSTMER_PAN, ");
						query.append(" case a.CUSTOMER_DOB when '0000-00-00' then '' else CUSTOMER_DOB  END AS CUSTOMER_DOB,A.DRIVING_LICENSE,A.VOTER_ID,A.PASSPORT_NUMBER,A.FATHER_HUSBAND_NAME,a.FIRST_NAME,a.MIDDLE_NAME,a.LAST_NAME,case a.DATE_OF_INCORPORATION  when '0000-00-00' then '' else DATE_OF_INCORPORATION END AS DATE_OF_INCORPORATION, a.REGISTRATION_NUMBER,a.UID,a.VAT_REGISTRATION,a.TIN_NUMBER,a.REFERENCE_NO,a.SOURCE_SYSTEM,a.DISTRICT,a.ADDRESS_LINE1,a.ADDRESS_LINE2,a.ADDRESS_LINE3,a.ADDRESS_STRING,a.PARTNER,a.DEAL_NO,a.DEAL_STATUS,a.dedupe_remarks,a.pincode,a.STATE,a.ALTERNATE_PHONE  FROM cr_customer_search_dtl  A ");
					query.append("WHERE  A.DEAL_ID ='"+StringEscapeUtils.escapeSql(CommonFunction.checkNull(txnID)).trim()+"' AND '"+txnType+"' = 'DC' ;");
				   }
				   ...
				   if(CommonFunction.checkNull(txnType).equalsIgnoreCase("LE")){
						String q1="delete from cr_dedupe_dtl where common_id='"+txnID+"' and TXN_TYPE='LE' ";
						ArrayList lis= new ArrayList();
						lis.add(q1);
							boolean st=ConnectionDAOforEJB.sqlInsUpdDelete(lis);
					}
				   /*if(txnType!="" && txnID!="")
					{
						if(txnType=="LE")
						{
							query2.append("SELECT b.LEAD_ID,a.customer_id,a.CUSTOMER_NAME,a.PRIMARY_PHONE,a.customer_email,a.CUSTOMER_TYPE,a.CUSTOMER_CONSTITUTION,a.CUSTMER_PAN, ");
							query2.append("a.CUSTOMER_DOB,a.DRIVING_LICENSE,a.VOTER_ID,a.PASSPORT_NUMBER,a.FATHER_HUSBAND_NAME,a.FIRST_NAME,a.MIDDLE_NAME,a.LAST_NAME,a.DATE_OF_INCORPORATION, a.REGISTRATION_NUMBER,a.UID,a.VAT_REGISTRATION,a.TIN_NUMBER,a.REFERENCE_NO,a.SOURCE_SYSTEM,a.DISTRICT,a.ADDRESS_LINE1,a.ADDRESS_LINE2,a.ADDRESS_LINE3,a.ADDRESS_STRING,a.PARTNER,a.DEAL_NO,a.DEAL_STATUS,a.dedupe_remarks,a.pincode,a.STATE,a.ALTERNATE_PHONE  FROM cr_customer_search_dtl  A ");
							query2.append("join cr_lead_dtl b on a.customer_id=b.customer_id ");
							query2.append(" WHERE  b.LEAD_ID =? AND '"+txnType+"' = 'LE';");
						}
					   if(txnType=="DC")
					   {
						   query2.append("SELECT B.DEAL_ID,A.CUSTOMER_ID,A.CUSTOMER_NAME,A.PRIMARY_PHONE,A.CUSTOMER_EMAIL,A.CUSTOMER_TYPE,A.CUSTOMER_CONSTITUTION,A.CUSTMER_PAN, ");
						   query2.append(" A.CUSTOMER_DOB,A.DRIVING_LICENSE,A.VOTER_ID,A.PASSPORT_NUMBER,A.FATHER_HUSBAND_NAME,a.FIRST_NAME,a.MIDDLE_NAME,a.LAST_NAME,a.DATE_OF_INCORPORATION, a.REGISTRATION_NUMBER,a.UID,a.VAT_REGISTRATION,a.TIN_NUMBER,a.REFERENCE_NO,a.SOURCE_SYSTEM,a.DISTRICT,a.ADDRESS_LINE1,a.ADDRESS_LINE2,a.ADDRESS_LINE3,a.ADDRESS_STRING,a.PARTNER,a.DEAL_NO,a.DEAL_STATUS,a.dedupe_remarks,a.pincode,a.STATE,a.ALTERNATE_PHONE  FROM cr_customer_search_dtl  A ");
						   query2.append(" INNER JOIN CR_DEAL_CUSTOMER_ROLE B ON A.CUSTOMER_ID=B.DEAL_CUSTOMER_ID ");
						query.append("WHERE b.DEAL_ID =? AND '"+txnType+"' = 'DC' ;");
					   }
							 
					   if(txnType=="LIM")
						{
						   query2.append(" SELECT B.LOAN_ID,A.CUSTOMER_ID ,A.CUSTOMER_NAME,A.PRIMARY_PHONE,A.CUSTOMER_EMAIL,A.CUSTOMER_TYPE,A.CUSTOMER_CONSTITUTION,A.CUSTMER_PAN,CUSTOMER_DOB, ");
						   query2.append(" A.DRIVING_LICENSE,A.VOTER_ID,A.PASSPORT_NUMBER,A.FATHER_HUSBAND_NAME,a.FIRST_NAME,a.MIDDLE_NAME,a.LAST_NAME,isnull(a.DATE_OF_INCORPORATION,0000-00-00), a.REGISTRATION_NUMBER,a.UID,a.VAT_REGISTRATION,a.TIN_NUMBER,a.REFERENCE_NO,a.SOURCE_SYSTEM,a.ADDRESS_LINE1,a.DISTRICT,a.ADDRESS_LINE2,a.ADDRESS_LINE3,a.ADDRESS_STRING,a.PARTNER,a.DEAL_NO,a.DEAL_STATUS,a.dedupe_remarks,a.pincode,a.STATE,a.ALTERNATE_PHONE  FROM cr_customer_search_dtl  A ");
						   query2.append(" INNER JOIN CR_LOAN_DTL B ON A.CUSTOMER_ID=B.LOAN_CUSTOMER_ID ");	
						   query2.append(" WHERE  b.LOAN_ID =? AND '"+txnType+"' = 'LIM' ;");
						}
					}
					   logger.info("txnID is ........"+txnID);
					   logger.info("In searchDedupeData......... query..........."+query.toString());
					   searchlist = ConnectionDAO.sqlSelectStringPrepStmt(query2.toString(), txnID);
	...
	/*			if(txnType!="" && txnID!="")
	    ...
	    public void saveDedupeCustomerDetail(String str,String txnId,CreditProcessingLeadDetailDataVo vo)
	 {
			...
			String AlternatePhone = CommonFunction.checkNull(vo.getPhoneOff())
					.trim();
			if(DateOfIncorporation.equalsIgnoreCase("0000-00-00") )
			{
				DateOfIncorporation="";
				vo.setDateOfIncorporation(DateOfIncorporation);
			}
			if(CustDOB.equalsIgnoreCase("0000-00-00") )
			{
				CustDOB="";
				vo.setCustDOB(CustDOB);
			}
			String record = "E";
		//	String firstletter1 = "";
			//String firstletter2 = "";
				...
				if (txnType != "" && txnId != "") {
					{
						...
						if (vo.getCustomerType().equalsIgnoreCase("I")) {
							...
							bufIns.append("  select distinct vw.RuleNo, vw.RuleWeightage, tbl.CUSTOMER_ID,CUSTOMER_NAME,PRIMARY_PHONE,CUSTOMER_EMAIL,CUSTOMER_TYPE,CUSTOMER_CONSTITUTION,CUSTMER_PAN,case CUSTOMER_DOB when '0000-00-00' then '' else CUSTOMER_DOB  END AS CUSTOMER_DOB,DRIVING_LICENSE,VOTER_ID,PASSPORT_NUMBER,FATHER_HUSBAND_NAME,FIRST_NAME,MIDDLE_NAME,");	
							bufIns.append(" LAST_NAME, case DATE_OF_INCORPORATION  when '0000-00-00' then '' else DATE_OF_INCORPORATION END AS DATE_OF_INCORPORATION, REGISTRATION_NUMBER,UID,VAT_REGISTRATION,TIN_NUMBER,REFERENCE_NO,SOURCE_SYSTEM,"); 
							bufIns.append("  DISTRICT,ADDRESS_LINE1,ADDRESS_LINE2,ADDRESS_LINE3,ADDRESS_STRING,PARTNER,tbl.DEAL_NO,d.rec_STATUS,tbl.dedupe_remarks,pincode,");	
							bufIns.append(" state,ALTERNATE_PHONE,tbl.DEAL_ID  from cr_customer_search_dtl tbl left join cr_deal_dtl d on d.deal_id=tbl.deal_id,  (( "); 
							...
							bufIns.append(" where customer_type='I' and customer_id <>'"+vo.getCustomerId()+"' and  ");	 
							...
							bufIns.append("	where customer_type='I' and customer_id <>'"+vo.getCustomerId()+"' ");
							...
							bufIns.append(" )vw  where tbl.CUSTOMER_ID=vw.CUSTOMER_ID  and  tbl.customer_type='I' limit 30 ;  "); 	
							...
							parameter.setString("CustomerId", CustomerId);
							...
							bufIns.append("select distinct vw.RuleNo, vw.RuleWeightage, tbl.CUSTOMER_ID,CUSTOMER_NAME,PRIMARY_PHONE,CUSTOMER_EMAIL,CUSTOMER_TYPE,CUSTOMER_CONSTITUTION,CUSTMER_PAN,case CUSTOMER_DOB when '0000-00-00' then '' else CUSTOMER_DOB  END AS CUSTOMER_DOB,DRIVING_LICENSE,VOTER_ID,PASSPORT_NUMBER,FATHER_HUSBAND_NAME,FIRST_NAME,MIDDLE_NAME "); 
							bufIns.append("	 LAST_NAME,case DATE_OF_INCORPORATION  when '0000-00-00' then '' else DATE_OF_INCORPORATION END AS DATE_OF_INCORPORATION, REGISTRATION_NUMBER,UID,VAT_REGISTRATION,TIN_NUMBER,REFERENCE_NO,SOURCE_SYSTEM ");
							bufIns.append("	DISTRICT,ADDRESS_LINE1,ADDRESS_LINE2,ADDRESS_LINE3,ADDRESS_STRING,PARTNER,tbl.DEAL_NO,d.rec_STATUS,tbl.dedupe_remarks,pincode ,state,ALTERNATE_PHONE,tbl.DEAL_ID  from cr_customer_search_dtl tbl left join cr_deal_dtl d on d.deal_id=tbl.deal_id, (  ( ");  
							bufIns.append("	select  '1' as RuleNo, '10' as RuleWeightage, CUSTOMER_ID,DEAL_NO FROM cr_customer_search_dtl   ");
							bufIns.append("	where customer_type='C' and ( ((CUSTMER_PAN='"+vo.getCustPan()+"' AND ifnull(CUSTMER_PAN,'')!='') OR  (REGISTRATION_NUMBER='"+vo.getRegistrationNo()+"' AND ifnull(REGISTRATION_NUMBER,'')!='00000')  OR" +
									...
									" union all ( ");  
							bufIns.append("	select  '2' as RuleNo, '7' as RuleWeightage, CUSTOMER_ID,DEAL_NO FROM cr_customer_search_dtl   ");
							bufIns.append("	where customer_type='C' and customer_id <>'"+vo.getCustomerId()+"' and (Customer_Name ='"+vo.getCustomerName()+"' AND (DATE_OF_INCORPORATION='"+vo.getDateOfIncorporation()+"' AND " +
									"ifnull(DATE_OF_INCORPORATION,'')!='')) limit 3  	) union all (  ");
							bufIns.append("		select  '3' as RuleNo, '5' as RuleWeightage, CUSTOMER_ID,DEAL_NO FROM cr_customer_search_dtl   ");
							bufIns.append("	where customer_type='C' and customer_id <>'"+vo.getCustomerId()+"' and (SOUNDEX(Customer_Name) LIKE SOUNDEX('"+vo.getCustomerName()+"') AND" +
							...
							bufIns.append("	select  '4' as RuleNo, '4' as RuleWeightage, CUSTOMER_ID,DEAL_NO FROM cr_customer_search_dtl   ");
							bufIns.append("	where customer_type='C' and customer_id <>'"+vo.getCustomerId()+"' and (Customer_Name LIKE '"+vo.getCustomerName()+"' AND " +
							...
							bufIns.append("	) union all (  select  '5' as RuleNo, '3' as RuleWeightage, CUSTOMER_ID,DEAL_NO FROM cr_customer_search_dtl " +
									"where customer_type='C' and customer_id <>'"+vo.getCustomerId()+"' AND ((PRIMARY_PHONE='"+vo.getMobile()+"' AND ifnull(PRIMARY_PHONE,'')!='') AND " +
									"(DATE_OF_INCORPORATION='"+vo.getDateOfIncorporation()+"' AND ifnull(DATE_OF_INCORPORATION,'')!='')  AND" +
									" (CUSTOMER_EMAIL ='"+vo.getEmail()+"' AND ifnull(CUSTOMER_EMAIL,'')!='') )limit 3 ) )vw where tbl.CUSTOMER_ID=vw.CUSTOMER_ID and " +
									"tbl.customer_type='C' limit 30; ");
						...
						if(CustomerType.equalsIgnoreCase("I"))
						 {
							...
							if ((CommonFunction.checkNull(vo1.getCustDOB())).trim()
									.equalsIgnoreCase("") || (CommonFunction.checkNull(vo1.getCustDOB())).trim().equalsIgnoreCase("0000-00-00") )
								insertPrepStmtObject1.addNull();
							else
							...
							if ((CommonFunction.checkNull(vo1
									...
									.equalsIgnoreCase("") || (CommonFunction.checkNull(vo1.getDateOfIncorporation())).trim().equalsIgnoreCase("0000-00-00") )
								insertPrepStmtObject1.addNull();
							else
								insertPrepStmtObject1.addString((vo1
										.getDateOfIncorporation()).trim());
							...
							if ((CommonFunction.checkNull(vo1.getDupDealId())).trim()
									.equalsIgnoreCase(""))
								insertPrepStmtObject1.addNull();
							else
								insertPrepStmtObject1
										.addString((vo1.getDupDealId()).trim());
						...
						}  else if(CustomerType.equalsIgnoreCase("C"))
	 {
	    ...
	    public LinkedHashMap<String,CreditProcessingLeadDetailDataVo> removeDuplicateValue(ArrayList searchlist)
	    {
	    	...
	    	vo1.setRuleWeightage((CommonFunction.checkNull(data1.get(1)).trim()));
	    	 ...
	    	 vo1.setDupDealId((CommonFunction.checkNull(data1.get(36)).trim()));
	    ...
	    if(!CommonFunction.checkNull(vo1.getRuleWeightage()).equalsIgnoreCase(""))
	    {
	    		...
	    		if(CommonFunction.checkNull(vo.getVoterId()).equalsIgnoreCase(vo1.getVoterId().trim())
	    			...
	    			if(CommonFunction.checkNull(vo.getFirstName()).equalsIgnoreCase("") || CommonFunction.checkNull(vo.getLastName()).equalsIgnoreCase("") || CommonFunction.checkNull(vo1.getFirstName()).equalsIgnoreCase("") || CommonFunction.checkNull(vo1.getLastName()).equalsIgnoreCase("")){	
		    			weightage=weightage;
		    			}else{
		    			if ((String.valueOf(CommonFunction.checkNull(vo.getFirstName()).charAt(0)).equalsIgnoreCase(String.valueOf(CommonFunction.checkNull(vo1.getFirstName()).charAt(0)))
		    				&& String.valueOf(CommonFunction.checkNull(vo.getLastName()).charAt(0)).equalsIgnoreCase(String
		    						.valueOf(CommonFunction.checkNull(vo1.getLastName()).charAt(0)))) 
	    ...
	    public ArrayList<Object> searchCustomerList(dedupeReferalVo vo) {
	    	...
	    	try
	    	{
	    		...
	    		if(((CommonFunction.checkNull(vo.getLbxDealNo()).equalsIgnoreCase("")) ||(CommonFunction.checkNull(vo.getCustomerName()).equalsIgnoreCase(""))||(CommonFunction.checkNull(vo.getLbxProductID()).equalsIgnoreCase(""))||(CommonFunction.checkNull(vo.getLbxscheme()).equalsIgnoreCase("")))){
	    			appendSQL=true;
	    		}
	    		...
	    		if((CommonFunction.checkNull(vo.getLbxDealNo()).trim().equalsIgnoreCase("") && CommonFunction.checkNull(vo.getCustomerName()).trim().equalsIgnoreCase("")) || (CommonFunction.checkNull(vo.getLbxDealNo()).trim().equalsIgnoreCase("") && CommonFunction.checkNull(vo.getCustomerName()).trim().equalsIgnoreCase("")) || (CommonFunction.checkNull(vo.getLbxProductID()).trim().equalsIgnoreCase("")  && CommonFunction.checkNull(vo.getLbxProductID()).trim().equalsIgnoreCase("")) || ( CommonFunction.checkNull(vo.getLbxscheme()).trim().equalsIgnoreCase("") && CommonFunction.checkNull(vo.getLbxscheme()).trim().equalsIgnoreCase("")) || vo.getCurrentPageLink()>1)
	    		{
	    ...
	    public ArrayList<Object> dedupeValues(dedupeReferalVo vo) {
	    	...
	    	try
	    	{
	    		...
	    		if ((!CommonFunction.checkNull(vo.getDealId()).trim().equalsIgnoreCase("") && !CommonFunction.checkNull(vo.getTxnType()).trim().equalsIgnoreCase("")) || !CommonFunction.checkNull(vo.getLbxDealNo()).trim().equalsIgnoreCase(""))
	    		{
	    			...
	    			bufInsSql.append(" left join cr_customer_search_dtl cr on(cr.customer_id=a.deal_customer_id and  a.deal_id=cr.deal_id ) ");			
	    			bufInsSqlTempCount.append("  left join cr_customer_search_dtl cr on(cr.customer_id=a.deal_customer_id and a.deal_id=cr.deal_id ) ");
	    		...
	    		else
	    		{
	    			...
	    			bufInsSql.append(" SELECT DISTINCT l.LEAD_ID,l.LEAD_ID,l.AMOUNT_REQUIRED,DATE_FORMAT(cm.customer_dob,'%d-%m-%Y')as customer_dob,cm.EMAIL_ID,CM.CUSTOMER_NAME,CASE cm.CUSTOMER_ROLE_TYPE WHEN 'PRAPPL' THEN 'APPLICANT' WHEN 'COAPPL' THEN 'CO-APPLICANT' WHEN 'GUARANTOR' THEN 'GUARANTOR' else cm.CUSTOMER_ROLE_TYPE END AS CUST_TYPE, ");
	    			bufInsSql.append(" cm.CUSTOMER_ID,case cm.CUSTOMER_TYPE when 'C' then 'CORPORATE' when 'I' then 'INDIVIDUAL' else cm.CUSTOMER_TYPE end as CUSTOMER_TYPE ,cm.VOTER_ID, ");
	    			bufInsSql.append(" cm.DRIVING_LICENSE,cm.PASSPORT_NUMBER,cm.PAN,cm.UID_NO,'' as tin ,(select DISTRICT_DESC from COM_DISTRICT_M where DISTRICT_ID=cm.DISTRICT)  ");
	    			bufInsSql.append(" as district,cm.ADDRESS_LINE1,cm.ADDRESS_LINE2,cm.ADDRESS_LINE3,cm.CUSTOMER_FNAME,'' as CUSTOMER_MNAME,cm.CUSTOMER_LNAME, ");
	    			bufInsSql.append(" '' as PARTNER,cm.REGISTRATION_NO,cm.FATHER_HUSBAND_NAME, DATE_FORMAT(cm.CUSTOMER_DOB,'%d-%m-%Y')as DATE_OF_INCORPORATION ");
	    			bufInsSql.append("  , case l.rec_status when 'L' then 'ALLOCATED' when 'X' then 'REJECTED' when 'A' then 'APPROVED' when 'P' THEN 'PENDING' end as rec_status, ");
	    			bufInsSql.append(" (select STATE_DESC from COM_STATE_M where STATE_ID=cm.state) as state      ");
	    			bufInsSql.append(" FROM CR_LEAD_DTL L  ");
	    			bufInsSql.append(" join cr_lead_customer_m cm on cm.lead_id=l.lead_id ");
	    			bufInsSql.append("  where l.lead_id=?  ");
	    			
	    			bufInsSqlTempCount.append("  select count(1)    ");
	    			bufInsSqlTempCount.append(" FROM CR_LEAD_DTL L  ");
	    			bufInsSqlTempCount.append(" join cr_lead_customer_m cm on cm.lead_id=l.lead_id ");
	    			if(!CommonFunction.checkNull(leadId).trim().equalsIgnoreCase(""))
	    			{
	    			bufInsSqlTempCount.append("  where l.LEAD_ID='"+StringEscapeUtils.escapeSql(leadId).trim()+"' ");
	    			}
	    			else
	    			{
	    				bufInsSqlTempCount.append("  where l.LEAD_ID='"+StringEscapeUtils.escapeSql(vo.getLeadId()).trim()+"' ");
	    			}
	       ...
	       boolean dealReject=false;
	    	...
	    	if (decision.equalsIgnoreCase("X"))
	    	{
	    		...
	    		else if(txn_type.equalsIgnoreCase("LE"))
	    		{
	    			...
	    			if(!CommonFunction.checkNull(vo.getDupCustomerID()).equalsIgnoreCase("")){
	    			String q1="update cr_lead_customer_m set dedupe_remarks='"+vo.getDedupeRemarks()+"',dedupe_decision='"+vo.getDecison()+"',dedupe_cust_id='"+vo.getDupCustomerID()+"',DEDUPE_STATUS='Y' where lead_id='"+dealId+"' and customer_id='"+vo.getDupCustomerID()+"'";
	    			ArrayList lis = new ArrayList();
	    			lis.add(q1);
	    			try {
						boolean flg=ConnectionDAO.sqlInsUpdDelete(lis);
					} catch (SQLException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
	    		}
	    			}
	    		if(!CommonFunction.checkNull(cusId1).equalsIgnoreCase("") && !CommonFunction.checkNull(vo.getDupCustomerID()).equalsIgnoreCase("")){
    				String q1="update cr_lead_customer_m set DEAL_CUSTOMER_ID='"+cusId1+"' where lead_id='"+dealId+"' and customer_id='"+vo.getDupCustomerID()+"'";
    			ArrayList lis = new ArrayList();
    			lis.add(q1);
    			try {
					boolean flg=ConnectionDAO.sqlInsUpdDelete(lis);
	    		...
	    		try {
	    		   ...
	    		   bufInsSql2.append(" where common_id=?  and deal_customer_id=? and customer_id in (?) ; " );
	    			...
	    			if((CommonFunction.checkNull(cusId1)).trim().equalsIgnoreCase(""))
	    				...
	    				insertPrepStmtObject1.addString((cusId1).trim());
	    			...
	    			bufInsSql2.append(" where customer_id=? and Deal_id=?; " );
	    		...
	    		//	logger.info("IN cr_customer_search_dtl() update query2 ### "+bufInsSql2);
	    						...
	    						qryList2.add(insertPrepStmtObject2);
	    								...
	    								dealReject = getDealRejection(vo,dealId);
	    								if(status  && status2)
	    								{
	    									result="Datareject";
	    								}
	    		...
	    		if(vo.getDecison().equalsIgnoreCase("A"))
	    		{
	    		   ...
	    		   bufInsSql2.append(" where common_id=?  and deal_customer_id=? and customer_id in ("+cusId1+") ; " );
	    			...
	    			status1 = ConnectionDAO.sqlInsUpdDeletePrepStmt(qryList1);
	    				...
	    				bufInsSql3.append("where customer_id=? and deal_id=? ; " );
	    ...
	    public String getSavedDecisionData(String dealId,String txnType,String cusId) {
	    	...
	    	try
	    	{
	    		...
	    		else if(!CommonFunction.checkNull(cusId).trim().equalsIgnoreCase("") && txnType.equalsIgnoreCase("LE")){
					str.append("select  dedupe_remarks from cr_lead_customer_m where lead_id =? AND CUSTOMER_ID='"+cusId+"' " );
					list =(ConnectionDAO.sqlSelectStringPrepStmt(str.toString(),dealId));
				}
		    	else if(!CommonFunction.checkNull(dealId).equalsIgnoreCase("") && !CommonFunction.checkNull(cusId).equalsIgnoreCase(""))
		    	{
		    		str.append("select  dedupe_remarks from cr_customer_search_dtl where   customer_id ='"+cusId+"'  and deal_id = '"+dealId+"' " );
		    		list =(ConnectionDAO.sqlSelect(str.toString()));
		    	}
		    	else 
		    	{
...
//			String cusId=vo.getDupCustomerID();
			...
			try
			{
				...
				if(CommonFunction.checkNull(cusId).trim().equalsIgnoreCase(""))
				{
					...
					str.append("select  dedupe_decision from cr_lead_customer_m where lead_id =? AND CUSTOMER_ID='"+cusId+"' " );
					list =(ConnectionDAO.sqlSelectStringPrepStmt(str.toString(),lbxDealNo));
				}
				else if(!CommonFunction.checkNull(lbxDealNo).equalsIgnoreCase("") && !CommonFunction.checkNull(cusId).equalsIgnoreCase(""))
		    	{
		    		str.append("select  dedupe_decision from cr_customer_search_dtl  where   customer_id ='"+cusId+"'  and deal_id = '"+lbxDealNo+"' " );
		    		list =(ConnectionDAO.sqlSelect(str.toString()));
		    	}
				else 
				{
		...
		{	  ArrayList list1=new ArrayList();
			...
			try
			{
				...
				{  
					 ...
					 bufInsSql.append(" left join cr_deal_dtl deal on(a.deal_id=deal.deal_id) ");
					 bufInsSql.append(" left join CR_DEAL_CUSTOMER_STAKEHOLDER_M m on( m.customer_id=a.customer_id) ");
				    bufInsSqlTempCount.append("select count(1) from cr_dedupe_dtl a ");
				   
				    if(vo.getTxnType().equalsIgnoreCase("DC"))
				   {
					   	bufInsSql.append("  where common_id=? and TXN_TYPE=?  and a.DEAL_ID != '"+StringEscapeUtils.escapeSql(vo.getLbxDealNo()).trim()+"' ");
					   	bufInsSqlTempCount.append("  where common_id='"+StringEscapeUtils.escapeSql(vo.getLbxDealNo()).trim()+"' and TXN_TYPE='"+vo.getTxnType()+"'  and a.DEAL_ID != '"+StringEscapeUtils.escapeSql(vo.getLbxDealNo()).trim()+"' ");
				   }
				   else if(vo.getTxnType().equalsIgnoreCase("LE"))
				   {
					   	bufInsSql.append("  where common_id=? and TXN_TYPE=? ");
					   	bufInsSqlTempCount.append("  where common_id='"+StringEscapeUtils.escapeSql(vo.getLbxLeadNo()).trim()+"' and TXN_TYPE='"+vo.getTxnType()+"' and a.deal_id not in (select deal_id from cr_deal_dtl where lead_id='"+StringEscapeUtils.escapeSql(vo.getLbxLeadNo()).trim()+"') ");
				   }
						bufInsSql.append("  and MATCH_RECORD in('A','X') and a.DEDUPE_FLAG=? order by WEIGHTAGE desc;");//rohit
						bufInsSqlTempCount.append(" and MATCH_RECORD in('A','X')  and a.DEDUPE_FLAG='"+flag+"' order by WEIGHTAGE desc ; ");//rohit
								...
								if(header1!=null && header1.size()>0)
								{
									...
									if(vo.getTxnType().equalsIgnoreCase("LE"))
									{
										if(CommonFunction.checkNull(header1.get(31)).trim().equalsIgnoreCase("Y"))
											fetchVo.setDedupeFlag("<input  type=radio name=chk1 id=chk1"+i+"  value="+CommonFunction.checkNull(header1.get(0))+" checked= checked disabled= disabled />");
											else
												fetchVo.setDedupeFlag("<input  type=radio name=chk1 id=chk1"+i+"  value="+CommonFunction.checkNull(header1.get(0))+" disabled= disabled />");
						
									}
									fetchVo.setDedupeFlag("<input  type=radio name=chk1 id=chk1"+i+"  value="+CommonFunction.checkNull(header1.get(0))+" />");
				...
				{	
					 ...
					 bufInsSql.append(" left join CR_DEAL_CUSTOMER_STAKEHOLDER_M m on( m.customer_id=a.customer_id) ");
				    bufInsSqlTempCount.append("select count(1) from cr_dedupe_dtl a ");
					bufInsSql.append("  where common_id=? and TXN_TYPE=? and a.DEAL_ID != ?  and a.DEAL_CUSTOMER_ID=? order by WEIGHTAGE desc;");			
					bufInsSqlTempCount.append("  where common_id='"+StringEscapeUtils.escapeSql(vo.getLbxDealNo()).trim()+"'and TXN_TYPE='"+vo.getTxnType()+"' and a.DEAL_ID != '"+StringEscapeUtils.escapeSql(vo.getLbxDealNo()).trim()+"' and a.DEAL_CUSTOMER_ID='"+StringEscapeUtils.escapeSql(vo.getDupCustomerID()).trim()+"' order by WEIGHTAGE desc ;");
				...
				{	
				 ...
				 bufInsSql.append(" left join CR_DEAL_CUSTOMER_STAKEHOLDER_M m on( m.customer_id=a.customer_id) ");
				    bufInsSqlTempCount.append("select count(1) from cr_dedupe_dtl a ");
					bufInsSql.append("  where common_id=? and TXN_TYPE=? and a.DEAL_CUSTOMER_ID=?  and a.deal_id not in (select deal_id from cr_deal_dtl where lead_id='"+StringEscapeUtils.escapeSql(vo.getLbxLeadNo()).trim()+"') order by WEIGHTAGE desc; ");			
				    bufInsSqlTempCount.append("  where common_id='"+StringEscapeUtils.escapeSql(vo.getLbxLeadNo()).trim()+"' and TXN_TYPE='"+vo.getTxnType()+"' and a.DEAL_CUSTOMER_ID='"+StringEscapeUtils.escapeSql(vo.getDupCustomerID()).trim()+"' and a.deal_id not in (select deal_id from cr_deal_dtl where lead_id='"+StringEscapeUtils.escapeSql(vo.getLbxLeadNo()).trim()+"') order by WEIGHTAGE desc; ");
				...
				if ( !CommonFunction.checkNull(vo.getDupCustomerID()).trim().equalsIgnoreCase("") && (!CommonFunction.checkNull(vo.getDealId()).trim().equalsIgnoreCase("") || !CommonFunction.checkNull(vo.getLeadId()).trim().equalsIgnoreCase("") ))
				{
					 ...
					 bufInsSql.append(" left join CR_DEAL_CUSTOMER_STAKEHOLDER_M m on( m.customer_id=a.customer_id) ");
				    bufInsSqlTempCount.append("select count(1) from cr_dedupe_dtl a ");
				    bufInsSql.append("  where common_id=? and TXN_TYPE=?   and a.DEAL_ID != '"+StringEscapeUtils.escapeSql(vo.getDealId()).trim()+"' and a.DEAL_CUSTOMER_ID=?  ");
				    bufInsSql.append("   order by WEIGHTAGE desc ; ");//rohit
				  //  bufInsSql.append("  and MATCH_RECORD in('A','X') and a.DEDUPE_FLAG=? and a.dedupe_cust_id=? order by WEIGHTAGE desc ; ");//rohit
				    if(vo.getTxnType().equalsIgnoreCase("DC"))
				    {
					bufInsSqlTempCount.append("  where common_id='"+StringEscapeUtils.escapeSql(vo.getDealId()).trim()+"' and  TXN_TYPE='"+vo.getTxnType()+"'  and a.DEAL_ID != '"+StringEscapeUtils.escapeSql(vo.getDealId()).trim()+"'  and a.DEAL_CUSTOMER_ID= '"+StringEscapeUtils.escapeSql(vo.getDupCustomerID()).trim()+"' ");
					bufInsSqlTempCount.append("  order by WEIGHTAGE desc; ");//rohit
				//	bufInsSqlTempCount.append(" and MATCH_RECORD in('A','X')  and a.DEDUPE_FLAG='"+flag+"'  and a.dedupe_cust_id='"+StringEscapeUtils.escapeSql(vo.getDupCustomerID()).trim()+"' order by WEIGHTAGE desc; ");//rohit
				    }
				    else
				    {
				    	bufInsSqlTempCount.append("  where common_id='"+StringEscapeUtils.escapeSql(vo.getLeadId()).trim()+"' and  TXN_TYPE='"+vo.getTxnType()+"' and a.DEAL_CUSTOMER_ID= '"+StringEscapeUtils.escapeSql(vo.getDupCustomerID()).trim()+"'  ");
				    	bufInsSqlTempCount.append("  order by WEIGHTAGE desc ;");//rohit
					//	bufInsSqlTempCount.append(" and MATCH_RECORD in('A','X')  and a.DEDUPE_FLAG='"+flag+"'  and a.dedupe_cust_id='"+StringEscapeUtils.escapeSql(vo.getDupCustomerID()).trim()+"' order by WEIGHTAGE desc ;");//rohit
				...
				try
				{
					...
					StringBuffer bufInsSql=new StringBuffer();
					 ...
					 bufInsSql.append(" ,REGISTRATION_NUMBER,MATCHING_RECORD,VAT_REGISTRATION,WEIGHTAGE,(select STATE_DESC from COM_STATE_M where STATE_ID=a.state) AS STATE from cr_dedupe_dtl a  ");		
					   ...
					   bufInsSql.append("  join cr_deal_address_m d on(d.bpid=a.customer_id and COMMUNICATION_ADDRESS='Y' and d.BPTYPE='CS') ");
					   bufInsSql.append(" left join CR_DEAL_CUSTOMER_STAKEHOLDER_M m on( m.customer_id=a.customer_id) ");
						if(vo.getTxnType().equalsIgnoreCase("DC"))
						{
...
public boolean getDealRejection(dedupeReferalVo vo,String dealId) {
			...
			boolean status1=false;
			 ...
			 try{
				 ...
				 logger.info("In getDealRejection......................status= "+status1);
...
public void proForDedupeDecisionForLead(String str, String txnID,
		String dupCustomerID) {
	  logger.info("str..................."+ str);
	  logger.info("txnID................."+txnID);
  	StringBuilder query=new StringBuilder();
  	StringBuilder query1=new StringBuilder();
		...
		try{
			...
			if(!CommonFunction.checkNull(txnType).equalsIgnoreCase("") && !CommonFunction.checkNull(txnID).equalsIgnoreCase(""))
			{
				if(txnType.equalsIgnoreCase("LE"))
				{
					...
					query.append("if(a.CUSTOMER_DOB='0000-00-00',null,a.CUSTOMER_DOB)as CUSTOMER_DOB ,a.DRIVING_LICENSE,a.VOTER_ID,a.PASSPORT_NUMBER,a.FATHER_HUSBAND_NAME,a.FIRST_NAME,a.MIDDLE_NAME,a.LAST_NAME,if(a.DATE_OF_INCORPORATION='0000-00-00',null,a.DATE_OF_INCORPORATION)as DATE_OF_INCORPORATION, a.REGISTRATION_NUMBER,a.UID,a.VAT_REGISTRATION,a.TIN_NUMBER,a.REFERENCE_NO,a.SOURCE_SYSTEM,a.DISTRICT,a.ADDRESS_LINE1,a.ADDRESS_LINE2,a.ADDRESS_LINE3,a.ADDRESS_STRING,a.PARTNER,a.DEAL_NO,a.DEAL_STATUS,a.dedupe_remarks,a.pincode,a.STATE,a.ALTERNATE_PHONE  FROM cr_customer_search_dtl  A ");
					query.append("join cr_lead_customer_m b on a.customer_id=b.customer_id  and a.lead_id=b.lead_id ");
					query.append(" WHERE  b.LEAD_ID ='"+StringEscapeUtils.escapeSql(CommonFunction.checkNull(txnID)).trim()+"' AND b.customer_id='"+dupCustomerID+"' AND '"+txnType+"' = 'LE';");
				}
			   if(txnType.equalsIgnoreCase("DC") ){
				   query.append("SELECT A.DEAL_ID,A.CUSTOMER_ID,A.CUSTOMER_NAME,A.PRIMARY_PHONE,A.CUSTOMER_EMAIL,A.CUSTOMER_TYPE,A.CUSTOMER_CONSTITUTION,A.CUSTMER_PAN, ");
					query.append(" case a.CUSTOMER_DOB when '0000-00-00' then '' else CUSTOMER_DOB  END AS CUSTOMER_DOB,A.DRIVING_LICENSE,A.VOTER_ID,A.PASSPORT_NUMBER,A.FATHER_HUSBAND_NAME,a.FIRST_NAME,a.MIDDLE_NAME,a.LAST_NAME,case a.DATE_OF_INCORPORATION  when '0000-00-00' then '' else DATE_OF_INCORPORATION END AS DATE_OF_INCORPORATION, a.REGISTRATION_NUMBER,a.UID,a.VAT_REGISTRATION,a.TIN_NUMBER,a.REFERENCE_NO,a.SOURCE_SYSTEM,a.DISTRICT,a.ADDRESS_LINE1,a.ADDRESS_LINE2,a.ADDRESS_LINE3,a.ADDRESS_STRING,a.PARTNER,a.DEAL_NO,a.DEAL_STATUS,a.dedupe_remarks,a.pincode,a.STATE,a.ALTERNATE_PHONE  FROM cr_customer_search_dtl  A ");
			   ...
			   if(CommonFunction.checkNull(txnType).equalsIgnoreCase("LE")){
					String q1="delete from cr_dedupe_dtl where common_id='"+txnID+"' and TXN_TYPE='LE' AND DEAL_CUSTOMER_ID='"+dupCustomerID+"' ";
					ArrayList lis= new ArrayList();
					lis.add(q1);
						boolean st=ConnectionDAOforEJB.sqlInsUpdDelete(lis);
}
