...
<form name="test" id="test">
	...
	<div class="tab-bg">
		<div class="ddcolortabs"><ul>
			<li><a href="<%=request.getContextPath()%>/authormakerinfo.do?method=getDocumentForOCR" id="a" onclick="activeTab(id);"><span >Document Upload Maker</span></a></li>
			<li><a href="<%=request.getContextPath()%>/authorForOcr.do?method=getDocumentForAuthor" id="b" onclick="activeTab(id);"><span >Author</span></a></li>
		</ul>																			
		</div>
		<div id="tabs"></div>
	</div>
