...
<!--           <html:option value="">--Select--</html:option>-->
   ...
   <html:hidden property="childId" styleId="childId${i }" value="${subdocuments.docChildId}" />   
             ...
             <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','GUARANTOR');"%>Upload/Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','GUARANTOR');">Upload/Download</td>
               </logic:notEqual>
               
              <%-- <td align="center"  id="dwnl${i}"><a href="#" onclick="downloadDocuments('${subdocuments.realDocId}','${subdocuments.entityId}','GUARANTOR');">Download</a></td> --%>
          </tr>
       </logic:iterate>
...
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocument('G','Y');"><bean:message key="button.save" /></button>
</logic:present>   
<logic:notPresent name="dataFound">
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocument('G','N');"><bean:message key="button.save" /></button>
</logic:notPresent>
 ...
 <logic:present name="loanInitDocs">
 <button type="button" name="button3" id="button3" class="topformbutton4" title="Alt+T" accesskey="T" onclick="viewDocument('guarantorDealDocs');"><bean:message key="button.viewDocs" /></button>
 </logic:present>
</logic:present>
...
<script type="text/javascript">
	...
	{
		alert('<bean:message key="lbl.GaurDocNotFound" />');
...
<!--           <html:option value="">--Select--</html:option>-->
   ...
   <html:hidden property="childId" styleId="childId${i }" value="${subdocuments.docChildId}" />
        	...
        	<logic:present name="FileManagement">
           	...
           	<logic:notPresent name="FileManagement">
             	 <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','GUARANTOR');"%>Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','GUARANTOR');">Download</td>
               </logic:notEqual>
            </logic:notPresent>
...
<!-- Changes By Amit Starts -->  
  ...
  <tr>
	...
	<logic:present name="FileManagement">
			<tr>
		<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveReceiveDocument('G');"><bean:message key="button.save" /></button>
		</tr>
	</logic:present>
<!-- Changes By Amit Ends -->
