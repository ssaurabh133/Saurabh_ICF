...
<! [endif] -->
	...
	<body onclick="parent_disable();" onload="enableAnchor();document.getElementById('tradeBuyerForm').refrenceNO.focus();init_fields();">
...
<html:form action="/tradeBuyerDetails" method="POST" styleId="tradeBuyerForm" acceptCharset="UTF-8"> 
<html:javascript formName="TradeCheckCapBuyerSupplierDynaValidatorForm"/>
<html:hidden property="tradeCheck1" styleId="tradeCheck1" styleClass="text" value="B" />
	...
	<legend><bean:message key="lbl.buyersCheck"/> </legend>
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
               ...
               <logic:notPresent name="list">    
                     <tr>
                       ...
                       <td ><html:text styleClass="text" property="refrenceNO" styleId="refrenceNO" value="" onblur="fnChangeCase('tradeBuyerForm','refrenceNO')" maxlength="20"/></td>
                       <td><bean:message key="lbl.tradeAppraiserName"/><font color="red">*</font></td>
                       <td ><html:text styleClass="text" property="appraiser" styleId="appraiser" value="" onblur="fnChangeCase('tradeBuyerForm','appraiser')" /></td>
                    </tr>
                 <tr>
           ...
           <tr>
                 	<td><bean:message key="lbl.verificationMode" /></td>
                    	 ...
                    	 <td><html:text styleClass="text" property="contactPerson" styleId="contactPerson" onblur="fnChangeCase('tradeBuyerForm','contactPerson')" value="" maxlength="50"/></td>
                    	</tr>                    
                     <tr> 
                    	 <td><bean:message key="lbl.relation"/><font color="red">*</font></td>
                    	 <td><html:text styleClass="text" property="relation" maxlength="50" styleId="relation" onblur="fnChangeCase('tradeBuyerForm','relation')" value="" /> </td>
                      ...
                      <tr>
                    	...
                    	<td><html:text styleClass="text" property="email" styleId="email" value="" maxlength="100"/></td>
                      	...
                      	<tr>
                      	<td ><bean:message key="lbl.averageMonthlyPurchase" /><font color="red">*</font></td>
                       ...
                       <td><html:text styleClass="text" property="productType" styleId="productType" value="" onblur="fnChangeCase('tradeBuyerForm','productType')" maxlength="50"/></td>      
                ...
                <td><html:text styleClass="text" property="address" value="" styleId="address" onblur="fnChangeCase('tradeBuyerForm','address')"  maxlength="500" /></td>
				<td ><bean:message key="lbl.Tradecity" /></td>
          	    <td><html:text property="city" styleId="city" styleClass="text" value="" onblur="fnChangeCase('tradeBuyerForm','city')" maxlength="50"/></td>	
					</tr>
          	 <tr>
			   <td><bean:message key="lbl.stateOrProvidence" /></td>
                <td><html:text property="txtStateCode" styleClass="text" styleId="txtStateCode" value="" onblur="fnChangeCase('tradeBuyerForm','txtStateCode')" maxlength="50"/></td>
                 <td ><bean:message key="lbl.country" /></td>
                 <td><html:text property="txtCountryCode" styleClass="text" styleId="txtCountryCode"  onblur="fnChangeCase('tradeBuyerForm','txtCountryCode')" value="" maxlength="50" /></td>
                      </tr> 
           <tr>
      		  ...
      		  <td><textarea name="textarea" class="text" maxlength="1000" id="textarea" cols="70" onblur="fnChangeCase('tradeBuyerForm','textarea')" rows="1"></textarea></td>
      	 	 </tr>
            <tr>
            <td><button type="button" name="buyerButton" id="save"   class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveTradeBuyerDetails('${dealNo}')"><bean:message key="button.save" /></button> </td>
            </tr>
         </logic:notPresent> 
         ...
         <html:hidden property="tradeCheckId" styleId="tradeCheckId" value="${list[0].tradeCheckId}"/>
          <tr>
                       ...
                       <td ><html:text styleClass="text" property="refrenceNO" styleId="refrenceNO" onblur="fnChangeCase('tradeBuyerForm','refrenceNO')" value="${list[0].refrenceNO}" maxlength="20"/></td>
                       <td><bean:message key="lbl.tradeAppraiserName"/><font color="red">*</font></td>
                       <td ><html:text styleClass="text" property="appraiser" styleId="appraiser" onblur="fnChangeCase('tradeBuyerForm','appraiser')" value="${list[0].appraiser}" maxlength="50"/></td>
                    </tr>
                 <tr>
                   <td><bean:message key="lbl.appraisalDate"/><bean:message key="lbl.dateFormat(dd-mm-yyyy)"/><font color="red">*</font></td>
                   <td><html:text property="appraisalDate" styleId="appraisalDate" value="${list[0].appraisalDate}" styleClass="text" readonly="true" onchange="validateLeadDateApp();checkDateApp();" /></td>
					<td><bean:message key="lbl.reportDate" /></td>
					<td><html:text property="reportDate" styleId="reportDate" maxlength="10" styleClass="text" value="${userobject.businessdate }" disabled="true" tabindex="-1"/>
        	  			 <html:hidden property="reportDate" styleClass="text" styleId="reportDate" value="${userobject.businessdate }" />
        	   </td>
           ...
           <tr>
                 	<td><bean:message key="lbl.verificationMode" /></td>
                    	 ...
                    	 <td><bean:message key="lbl.contactPerson"/><font color="red">*</font></td>
                    	 <td><html:text styleClass="text" property="contactPerson" styleId="contactPerson" onblur="fnChangeCase('tradeBuyerForm','contactPerson')" value="${list[0].contactPerson}" maxlength="50"/></td>
                    	</tr>                    
                     <tr> 
                    	 <td><bean:message key="lbl.relation"/><font color="red">*</font></td>
                    	 <td><html:text styleClass="text" property="relation" maxlength="50" styleId="relation" onblur="fnChangeCase('tradeBuyerForm','relation')" value="${list[0].relation}" /> </td>
		               	<td><bean:message key="lbl.mobile"/></td>
                      ...
                      <tr>
                       ...
                       <td><html:text styleClass="text" property="vintageOfRelationship" value="${list[0].vintageOfRelationship}" styleId="vintageOfRelationship" style="text-align: right" maxlength="3" onkeypress="return isNumberKey(event);"/></td>						    
                      	...
                      	<tr>
 				<td><bean:message key="lbl.address" /></td>
                <td><html:text styleClass="text" property="address" value="${list[0].address}" onblur="fnChangeCase('tradeBuyerForm','address')" styleId="address" maxlength="500" /></td>
				<td ><bean:message key="lbl.Tradecity" /></td>
          	    <td><html:text property="city" styleId="city" styleClass="text"  onblur="fnChangeCase('tradeBuyerForm','city')" value="${list[0].city} " maxlength="50"/></td>	
					</tr>
          	 <tr>
			   <td><bean:message key="lbl.stateOrProvidence" /></td>
                <td><html:text property="txtStateCode" styleClass="text" styleId="txtStateCode" onblur="fnChangeCase('tradeBuyerForm','txtStateCode')" value="${list[0].txtStateCode}" maxlength="50"/></td>
                 <td ><bean:message key="lbl.country" /></td>
                 <td><html:text property="txtCountryCode" styleClass="text" styleId="txtCountryCode" onblur="fnChangeCase('tradeBuyerForm','txtCountryCode')" value="${list[0].txtCountryCode}" maxlength="50" /></td>
                      </tr> 
           <tr>
                 <td ><bean:message key="lbl.pincode" /></td>           
          	  <td ><html:text styleClass="text" property="pincode" styleId="pincode" value="${list[0].pincode}"  style="text-align: right" maxlength="20" onkeypress="return isNumberKey(event);"/></td>        
         		<td><bean:message key="lbl.appRemark"/><font color="red">*</font></td>
      		  <td><textarea class="text" maxlength="1000" name="textarea" id="textarea" cols="70" onblur="fnChangeCase('tradeBuyerForm','textarea')" rows="1" >${list[0].textarea}</textarea></td>
      	 	 </tr>
            <tr>
                <td><button type="button" name="buyerButton" id="save" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return modifyTradeBuyerDetails()"><bean:message key="button.save" /></button> </td>
            </tr>
         </logic:present>
