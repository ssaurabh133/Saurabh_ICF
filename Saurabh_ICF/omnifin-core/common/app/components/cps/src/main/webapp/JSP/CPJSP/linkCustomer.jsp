...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <script type="text/javascript">
		...
		function searchCustomer()
		{
			...
			var fatherHusband=document.getElementById('fatherHusband').value;
			...
			if(customerId!=''||customerName!=''||panNo!=''||registrationNo!=''||appFormNo!=''||loanNO!='' || fatherHusband!=''||birthDate!=''||moblieNo!=''||telephoneNo!=''||drivingLicense!=''||vehicleNo!='' || aadhaar!='')
			{
			    //alert("searchCustomer");
				document.getElementById("LinkCustomerForm").action="<%=request.getContextPath() %>/linkCustomer.do?method=searchCustomer&panNo="+panNo+"&aadhaar="+aadhaar;
 	   ...
 	   {
 	           // alert("In saveCustomer....."+document.getElementById("hType").value);
 	           if(checkboxCheck(document.getElementsByName('dealstore')))
 	           {
	                 ...
	                 if(customerId!='')
	                  {	
			 	          document.getElementById("LinkCustomerForm").action="approveCustomerAction.do?method=getApproval&codeId="+customerId+"&applType="+applType+"&status="+status;
			 	          document.getElementById("LinkCustomerForm").submit();
	                  }	            
 		     	}
 		     	else
	...
	<tr>
		...
		<tr>
         ...
         <td>
			...
			<html:button property="custButton" style="custButton" onclick="closeLovCallonLov1();openLOVCommon(119,'LinkCustomerForm','customerId','','', '','','','customerName')" value=" " styleClass="lovbutton"></html:button>
	 ...
	 <tr>
	    ...
	    <tr>
   			<td><bean:message key="fatherHusband" /><font color="red">*</font></td>
   			 <td><html:text property="fatherHusband" styleId="fatherHusband" styleClass="text" value="" onchange="return upperMe('fatherHusband');" maxlength="50"/></td>
   			 
          <td><bean:message key="individual.birthdate" /><bean:message key="lbl.dateFormat(dd-mm-yyyy)"/><font color="red">*</font> </td>
       	 <td><html:text property="birthDate" styleId="birthDate" styleClass="text" value="" /></td>
                           
           </tr>
     <tr>	  
	       <td><bean:message key="lbl.primary" /></td>
          <td><html:text property="moblieNo" styleId="moblieNo" styleClass="text" value="" maxlength="10"/></td>
          
           <td><bean:message key="lbl.alter"/></td>
           <td><html:text property="telephoneNo" styleClass="text" value="" styleId="telephoneNo" style="text-align: right" maxlength="100" size="20" /></td>  
     </tr>
     <tr>
	  
	       <td><bean:message key="drivingLicense" /></td>
          <td><html:text property="drivingLicense" styleId="drivingLicense" styleClass="text" value="${individualInfo[0].drivingLicense}" maxlength="20"/></td>
          
          <td><bean:message key="lbl.vehicleNo"/></td>
           <td><html:text property="vehicleNo" styleClass="text" value="" styleId="vehicleNo" style="text-align: right" maxlength="25" size="10" /></td>  
     </tr>
     <tr>
    ...
    <tr class="white2">
	 ...
	 <logic:iterate name="searchedDetail" id="subsearchedDetail">
	   ...
	   <input type="hidden" name="cust_id" id="cust_id" value="${subsearchedDetail.customerId }" /></a>
	        ...
	        <td >${subsearchedDetail.dealNO}</td>
      ...
      <button type="button" name="button" id="button" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return saveCustomer();"><bean:message key="button.select" /></button>
