...
function calculateInsurance(formName)
{
		...
		//alert("propertyType::"+propertyType);
			for(var i=0; i<alchecking.length;i++)
			{
			 ...
			 if(count>1 && policyType=='S')
				...
				// alert('sumAssuredMapping::'+sumAssuredMapping+'::sumAssuPer::'+sumAssuPer);
	...
	{
		var address = sourcepath+"/cpInsurance.do?method=calculateCpInsurance";
		...
		//document.getElementById("cpInsuranceForm").action=sourcepath+"/cpInsurance.do?method=calculateCpInsurance&ids="+temp;
		 calculateInsuranceAjax(address, data);
...
function calculateInsuranceAjax(address, data) {
	//alert("in sendDisbursalloanId id");
	var request = getRequestObject();
	request.onreadystatechange = function () {
		resultCalculateInsurance(request);	
	};
...
function resultCalculateInsurance(request)
{
	...
	//	if(( value.indexOf('E01'))||( value.indexOf('ERROR')) >= 0){
...
function saveCpInsurance()
{
	...
	var sPrefix3 = document.getElementById('sPrefix3').value;
	...
	/*// Validation for Insurance Capturing
	if(insuranceProvider!="" && policyType=="S")
		{
		alert("You can't capture more than one insurance, Please delete existing insurance.");
		DisButClass.prototype.EnbButMethod();
	...
	if (dateOfbirth!='' || dateOfbirth1!='' ||dateOfbirth2!='' ||dateOfbirth3!='' ||dateOfbirth4!=''){
		...
		{
			alert("Thired Nominee Date of birth must be less than Business Date");
			DisButClass.prototype.EnbButMethod();
			document.getElementById("save").removeAttribute("disabled","true");
			return false;
	...
	var msg= '';
	//alert('v_nomineeParam::::'+v_nomineeParam);
	...
	if (trim(nomineeName4) != '' && percentage4 =='') {
	 ...
	 if((trim(dateOfbirth)!='' || (percentage)!='' || trim(relationshp)!='' || trim(gender)!='' ||trim(addr)!=''|| trim(sPrefix)!='' ||trim(nomineeMName)!='' ||trim(nomineeLName)!='' ||trim(smaritalStatus)!='' ||trim(saddressType)!='' ||trim(sinsuranceStreet)!='' ||trim(snomineeCity)!='' ||trim(snomineeState)!='' ||(snomineePin)!='') && trim(nomineeName)=='')
		...
		if((trim(dateOfbirth3)!='' ||(percentage3)!='' || trim(relationshp3)!='' || trim(gender3)!='' ||trim(addr3)!=''|| trim(sPrefix3)!='' ||trim(nomineeMName3)!='' ||trim(nomineeLName3)!='' ||trim(smaritalStatus3)!='' ||trim(saddressType3)!='' ||trim(sinsuranceStreet3)!='' ||trim(sNomineeCity3)!='' ||trim(sNomineeState3)!='' ||(sNomineePin3)!='') && trim(nomineeName3)=='')
		{
			alert("Nominee Name3 is required.");
			DisButClass.prototype.EnbButMethod();
			document.getElementById("save").removeAttribute("disabled","true");
		...
		/*if((trim(dateOfbirth3)!='' ||(percentage3)!='' || trim(relationshp3)!='' || trim(gender3)!='' ||trim(addr4)!=''|| (sPrefix3)!='' ||trim(nomineeMName3)!='' ||trim(nomineeLName3)!='' || (smaritalStatus3)!='' || (saddressType3)!='' ||trim(sinsuranceStreet3)!='' ||trim(sNomineeCity3)!='' ||trim(sNomineeState3)!='' ||(sNomineePin3)!='') && trim(nomineeName3)=='')
		{
...
if(trim(nomineeName2) != '' ||trim(dateOfbirth2) != ''||trim(gender2) != ''||trim(relationshp2) != '' || (percentage2)!='' ||trim(addr2)!=''|| trim(sPrefix2)!='' ||trim(nomineeLName2)!='' ||trim(smaritalStatus2)!='' ||trim(saddressType2)!='' ||trim(sinsuranceStreet2)!='' ||trim(sNomineeCity2)!='' ||trim(sNomineeState2)!='' ||(sNomineePin2)!=''){			
			...
			{
			alert("*Address Type of third Nominee is required. ");
			DisButClass.prototype.EnbButMethod();
			document.getElementById("save").removeAttribute("disabled","true");
			return false;
			}
...
if(trim(nomineeName3) != '' ||trim(dateOfbirth3) != ''||trim(gender3) != ''||trim(relationshp3) != '' || (percentage3)!='' ||trim(addr3)!=''|| (sPrefix3)!='' ||trim(nomineeLName3)!='' || (smaritalStatus3)!='' || (saddressType3)!='' ||trim(sinsuranceStreet3)!='' ||trim(sNomineeCity3)!='' ||trim(sNomineeState3)!='' ||(sNomineePin3)!=''){			
...
/*if(trim(nomineeName4) != '' ||trim(dateOfbirth4) != ''||trim(gender4) != ''||trim(relationshp4) != '' || (percentage4)!='' ||trim(addr4)!=''|| trim(sPrefix3)!='' ||trim(nomineeLName3)!='' ||trim(smaritalStatus3)!='' ||trim(saddressType3)!='' ||trim(sinsuranceStreet3)!='' ||trim(sNomineeCity3)!='' ||trim(sNomineeState3)!='' ||(sNomineePin3)!=''){			
			if(trim(dateOfbirth3) == ''){
				alert("*Date of birth of fourth Nominee is required. ");
				DisButClass.prototype.EnbButMethod();
				document.getElementById("save").removeAttribute("disabled","true");
			...
			if(trim(sNomineeState2)=='')
			{
			alert("*State of fourth Nominee is required. ");
			DisButClass.prototype.EnbButMethod();
			document.getElementById("save").removeAttribute("disabled","true");
			return false;
			}
...
if(trim(nomineeName4) != '' ||trim(dateOfbirth4) != ''||trim(gender4) != ''||trim(relationshp4) != '' || (percentage4)!='' ||trim(addr4)!='' || trim(sPrefix4)!='' ||trim(nomineeLName4)!='' ||trim(smaritalStatus4)!='' ||trim(saddressType4)!='' ||trim(sinsuranceStreet4)!='' ||trim(sNomineeCity4)!='' ||trim(sNomineeState4)!='' ||(sNomineePin4)!=''){			
	...
	//if(trim(insuranceProvider) == '' || trim(sumAssured) =='' ||trim(tenure) == ''||trim(age) == ''||trim(insurancePremium) == ''||trim(chargesOnInsurance) == '')
		...
		else if((v_nomineeParam=='N') && (trim(nomineeName) == '' ||trim(dateOfbirth) == ''||trim(gender) == ''||trim(relationshp) == ''))	
		 {
		//	alert('amandeep');
			
			if(trim(nomineeName) == ''){
				msg += '* Nominee Name is required.\n';
			}
			if(trim(dateOfbirth) == ''){
			...
			if(trim(relationshp) == ''){
				msg += '* Relationship with Policy Holder is required.\n';
			}
			
			if(msg.match("dateOfbirth")){
				document.getElementById("dateOfbirth").focus();
				
			}else if(msg.match("gender")){
				document.getElementById("gender").focus();
			}
			else if(msg.match("nomineeName")){
				document.getElementById("nomineeName").focus();
			}
			
			else if(msg.match("relationshp")){
				document.getElementById("relationshp").focus();
			}
	...
	else
	{
		...
		if((sms1=="") || (sms1=='notCal' && insurancePremium==""))
			...
			{
			document.getElementById("cpInsuranceForm").action=sourcepath+"/cpInsurance.do?method=saveCpInsurance&ids="+temp;
			document.getElementById("processingImage").style.display = '';
...
function deleteCpInsurance()
{
	...
	/*if(sms=='')
	{
	alert("Please Save a Data First");
	DisButClass.prototype.EnbButMethod();
	return false;
	}*/
	/*if(insurancePremium=='')
		...
		return false;
		 ...
		 if(flag>0)
			{
				document.getElementById("cpInsuranceForm").action=sourcepath+"/cpInsurance.do?method=deleteCpInsurance&ids="+temp;
				document.getElementById("processingImage").style.display = '';
...
function getInsuranceProduct()
{
	var insuranceProvider= document.getElementById("insuranceProvider").value;
	 //alert("insuranceProvider:::"+insuranceProvider);
		 ...
		 var address = contextPath+"/cpInsurance.do?method=getInsuranceProduct";
...
function editInsuranceDetails(id)
{
	...
	document.getElementById("cpInsuranceForm").action=contextPath+"/cpInsurance.do?method=editInsuranceDetails&insuranceId="+id;
 	document.getElementById("cpInsuranceForm").submit();
 	return true;
}

function relodInsuranceData(id)
{
	
	var sourcepath = document.getElementById('contextPath').value;
	//var insuranceId=document.getElementById('insuranceId').value;
	//document.getElementById("cpInsuranceForm").action=contextPath+"/cpInsurance.do?method=relodInsuranceData&insuranceId="+id;
 //	document.getElementById("cpInsuranceForm").submit();
...
var address = sourcepath+"/cpInsurance.do?method=relodInsuranceData";
var data = "insuranceId="+id;
//document.getElementById("cpInsuranceForm").action=sourcepath+"/cpInsurance.do?method=calculateCpInsurance&ids="+temp;
relodInsuranceDataAjax(address, data);
/*document.getElementById("processingImage").style.display = '';
document.getElementById("cpInsuranceForm").submit();*/
return true;
...
function relodInsuranceDataAjax(address, data) {
	//alert("in sendDisbursalloanId id");
	var request = getRequestObject();
	request.onreadystatechange = function () {
		resultRelodInsuranceDataInsurance(request);	
	};
	request.open("POST", address, true);
	request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	request.send(data);
...
function resultRelodInsuranceDataInsurance(request)
{
	...
	if ((request.readyState == 4) && (request.status == 200)) {
		...
		var temp=s2.length;
		document.getElementsByName("alchecking").checked=false;
		for(i = 1; i<= temp;i++)
		{
		...
		//document.getElementById('insuranceProduct').value=trim(s1[17]);
...
//	alert('sumAssuredMapping::'+sumAssuredMapping);
	if(service=='E')
	{
