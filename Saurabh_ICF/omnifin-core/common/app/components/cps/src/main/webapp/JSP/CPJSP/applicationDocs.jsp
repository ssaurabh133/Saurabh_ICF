...
<logic:notPresent name="viewDeal">
    ...
    <input type="hidden" name="entityType" id="entityType" value="APPL" />
                   
	<fieldset>
	<legend><bean:message key="lbl.applDocs" /></legend>  
<!--	<logic:present name="loanInitDocs">-->
    ...
    <td class="gridtd">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr class="white2">
          ...
          <td><b><bean:message key="lbl.osvnonosv" /></b></td>
	  <td ><b><bean:message key="lbl.DOC-TYPE" /></b></td>
          <td ><b><bean:message key="lbl.status" /></b></td>
          <td ><strong><bean:message key="lbl.statusDate" /><bean:message key="lbl.dateFormat(dd-mm-yyyy)"/></strong></td>
        ...
        <tr class="white1">
          ...
          <input type="hidden" name="mandOrNonMand" id="mandOrNonMand${i }" value="${subdocuments.mandatory}" />
			...
			<td><center>${subdocuments.osvnonosv}</center>
          	<input type="hidden" name="osvnonosv" id="osvnonosv${i }" value="${subdocuments.osvnonosv}" />
          	</td>
	<!-- Virender Code start -->
		 <td >
     ...
     <!-- Rohit code end -->
          ...
          <html:select property="status" styleClass=""  styleId="status${i}" value="${subdocuments.docStatus}" onchange="OTCPDDMarking(${i });makeChoice(${i});refreshChildId(${i }); fillExpiryDate(${i });">
<!--           <html:option value="">--Select--</html:option>-->
            ...
            <html:option value="N">NA</html:option><!-- Virender -->
	           ...
	           <td  id="rec${i}">
		            ...
		            <!-- Rohit Changes Starts for OTC -->
		             <logic:equal name="subdocuments" property="docStatus" value="O">
		            	 <html:text property="recievedDate" styleClass="text6" styleId="recievedDate${i}" readonly="true" value="${subdocuments.recieveDate}" />
		            </logic:equal>
		            <!-- Rohit end -->
		            <logic:equal name="subdocuments" property="docStatus" value="P">
		              <input type="text" name="recievedDate" class="text6" readonly="readonly"  value="${subdocuments.recieveDate}" />
		            </logic:equal>
		            ...
		            <logic:equal name="subdocuments" property="docStatus" value="B">
		              <input type="text" name="recievedDate" class="text6" readonly="readonly"  value="${subdocuments.recieveDate}" />
		            </logic:equal>
             ...
             <td  id="def${i}">
               <logic:equal name="subdocuments" property="docStatus" value="R">
                   <input type="text" name="deferedDate" readonly="readonly" class="text6" value="${subdocuments.deferDate}"/>
               </logic:equal>
               <!-- Rohit Changes Strats for OTC -->
               <logic:equal name="subdocuments" property="docStatus" value="O">
               ...
               <logic:equal name="subdocuments" property="docStatus" value="D">
                ...
                <logic:equal name="subdocuments" property="docStatus" value="P">
		              <input type="text" name="deferedDate" class="text6" readonly="readonly"  value="${subdocuments.deferDate}" />
		         </logic:equal>
		         <logic:equal name="subdocuments" property="docStatus" value="W">
		             <input type="text" name="deferedDate" class="text6" readonly="readonly"  value="${subdocuments.deferDate}" />
		         </logic:equal>
             ...
             <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','APPL');"%>Upload/Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','APPL');">Upload/Download</td>
               </logic:notEqual>
               
              <%-- <td align="center"  id="dwnl${i}"><a href="#" onclick="downloadDocuments('${subdocuments.realDocId}','${subdocuments.entityId}','APPL');">Download</a></td> --%>
          </tr>
            ...
            <html:option value="AW">As And When</html:option><!-- Virender -->
          		...
          		<td>         
	               ...
	               <logic:equal name="subdocuments" property="addnDocStatus" value="D">
		            ...
		            <logic:equal name="subdocuments" property="addnDocStatus" value="P">
		              <input type="text" name="additionalReceivedDate" class="text6" readonly="readonly"  value="${subdocuments.addnReceivedDate}" />
		            </logic:equal>
		            <logic:equal name="subdocuments" property="addnDocStatus" value="W">
		             ...
		             <logic:equal name="subdocuments" property="addnDocStatus" value="B">
		              <input type="text" name="additionalReceivedDate" class="text6" readonly="readonly"  value="${subdocuments.addnReceivedDate}" />
		            </logic:equal>
            	 ...
            	 <td id="addDef${i }">
		           ...
		           <logic:equal name="subdocuments" property="addnDocStatus" value="O">
                	...
                	<logic:equal name="subdocuments" property="addnDocStatus" value="P">
		              	<input type="text" name="additionalDeferredDate" class="text6" readonly="readonly"  value="${subdocuments.addnDeferredDate}" />
		         	</logic:equal>
		         	<logic:equal name="subdocuments" property="addnDocStatus" value="W">
		             	<input type="text" name="additionalDeferredDate" class="text6" readonly="readonly"  value="${subdocuments.addnDeferredDate}" />
		         	</logic:equal>
...
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocument('AD','Y');"><bean:message key="button.save" /></button>
</logic:present>   
<logic:notPresent name="dataFound">
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocument('AD','N');"><bean:message key="button.save" /></button>
</logic:notPresent>     
 ...
 <logic:present name="loanInitDocs">
<button type="button" name="button3" id="button3" class="topformbutton4" title="Alt+T" accesskey="T" onclick="return viewDocument('applicationDealDoc');"><bean:message key="button.viewDocs" /></button>
</logic:present>
</logic:present>
</td>
  </tr>
...
else if('<%=request.getAttribute("sms").toString()%>'=='success')
{
	alert('<bean:message key="lbl.documentForward" />');
	parent.location='<%=request.getContextPath()%>/documentVerificationUnit.do';	
}
else if('<%=request.getAttribute("sms").toString()%>'=='pending')
{
	alert('<bean:message key="lbl.documentErrorPending" />');
	parent.location='<%=request.getContextPath()%>/documentVerificationUnit.do';
}
else if('<%=request.getAttribute("sms").toString()%>'=='APPL')
{
	alert('<bean:message key="lbl.documentErrorAPPL" />');
}
else if('<%=request.getAttribute("sms").toString()%>'=='PRAPPL')
{
	alert('<bean:message key="lbl.documentErrorPRAPPL" />');
}
else if('<%=request.getAttribute("sms").toString()%>'=='COAPPL')
{
	alert('<bean:message key="lbl.documentErrorCOAPPL" />');
}
else if('<%=request.getAttribute("sms").toString()%>'=='GUARANTOR')
{
	alert('<bean:message key="lbl.documentErrorGUARANTOR" />');
}
else if('<%=request.getAttribute("sms").toString()%>'=='ASSET')
{
	alert('<bean:message key="lbl.documentErrorASSET" />');
}
else if('<%=request.getAttribute("sms").toString()%>'=='COLLATERAL')
{
	alert('<bean:message key="lbl.documentErrorCOLLATERAL" />');
}
</script>
</logic:present>  
  </html:form>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="4">
        ...
        <tr class="white1">
         ...
         <html:option value="NA">NA</html:option>
          ...
          <html:select property="status" disabled="true" styleClass="" styleId="status${i}" value="${subdocuments.docStatus}" onchange="OTCPDDMarking(${i });makeChoice(${i});">
<!--           <html:option value="">--Select--</html:option>-->
            <html:option value="R">Received</html:option>
            <html:option value="D">Deferred</html:option>
    	...
    	<html:hidden property="childId" styleId="childId${i }" value="${subdocuments.docChildId}" /> 
	           <td id="rec${i}">
	            <logic:equal name="subdocuments" property="docStatus" value="D">
	              <input type="text" name="recievedDate" class="text6" disabled="disabled"  value="" />
	            </logic:equal>
             ...
             <td  id="def${i}">
               <logic:equal name="subdocuments" property="docStatus" value="R">
                   <input type="text" name="deferedDate" disabled="disabled" class="text6" />
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docStatus" value="R">
                <logic:notEqual name="subdocuments" property="docStatus" value="O">
              ...
              <td  id="exp${i}">
                ...
                <logic:equal name="subdocuments" property="expirFlag" value="Y">
                  <html:text property="expiryDate" disabled="true"  styleClass="text6"  value="${subdocuments.expirDate}"  maxlength="10"  />
                </logic:equal>
               </td>
             <td  id="rem${i}"><html:text property="remarks" styleClass="text1" styleId="remarks" value="${subdocuments.remark}"  maxlength="50" disabled="true"/></td>
       			  <logic:present name="FileManagement">
             	<td>
             	...
             	<logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','APPL');"%>Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="#" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','APPL');">Download</td>
               </logic:notEqual>
               </logic:notPresent>
    ...
    <td class="gridtd">
      ...
      <table id="gridtable" width="100%" border="0" cellspacing="1" cellpadding="1">
        ...
        <script type="text/javascript" src="<%=request.getContextPath()%>/js/cpScript/CaldocumentRelated.js"></script>
        		...
        		<logic:present name="FileManagement">
			<tr>
		<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveReceiveDocument('AD');"><bean:message key="button.save" /></button>
		<button type="button" name="button" class="topformbutton2" title="Alt+F" accesskey="F" onclick="return forwardReceiveDocument();"><bean:message key="button.forward" /></button>
		</tr>
	</logic:present>
<!-- Changes By Amit Ends -->
