...
request.setAttribute("no",no); %>
	...
	<body  onload="enableAnchor();document.getElementById('tradeCheckComForm').dealButton.focus();init_fields();">
...
<html:form action="/tradeCheckComSearch" method="post" styleId="tradeCheckComForm">
	
	<html:hidden property="contextPath" styleId="contextPath" value="<%=request.getContextPath() %>" />
	<input type="hidden" name="userId" id="userId" value="${userobject.userId}" />
	<fieldset>	  
	  <legend><bean:message key="lbl.trdeChCap"/></legend>         
	...
	<tr>
		...
		<td width="35%" valign="top">
			...
			<html:button property="dealButton" styleId="dealButton" onclick="openLOVCommon(212,'tradeCheckComForm','dealNo','','', '','','','customername')" value=" " styleClass="lovbutton"> </html:button> 	  
       </td>
	    <td><bean:message key="lbl.tradCustName"/></td>
		<td width="13%" ><html:text property="customername" styleClass="text" styleId="customername" value="${searchParams[0].customername}" maxlength="50"/></td> 
		</tr>
	 ...
	 <tr>
		...
		<td width="20%"><bean:message key="lbl.product"/></td> 
      	 <td width="20%">
	        ...
	        <html:button property="productButton" styleId="productButton" onclick="openLOVCommon(215,'tradeCheckComForm','product','','scheme','lbxscheme','','','productId')" value=" " styleClass="lovbutton"> </html:button>	         
		...
		<tr> 
            ...
            <td width="20%">
               <html:text property="scheme" styleId="scheme" styleClass="text" readonly="true" tabindex="-1" value="${searchParams[0].scheme}"/>
          	   ...
          	   <html:button property="productButton" styleId="schemeButton" onclick="openLOVCommon(22,'tradeCheckComForm','scheme','product','lbxscheme', 'lbxProductID','Please Select Product','','schemeId')" value=" " styleClass="lovbutton"> </html:button>
		 ...
		 <tr>
		  	<td align="left">
		    <button type="button" name="search" id="searchComButton" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return newTradeCheckComSearch('F');"><bean:message key="button.search" /></button>
		    </td>		     
		 </tr>
		</table>
	     </td>
...
<fieldset>	
	 <legend><bean:message key="lbl.tradeComDetail"/></legend>  
   ...
   <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    ...
    <logic:notPresent name="list"> 
        <td ><b><bean:message key="lbl.tradDealNo"/></b></td>
        <td><b><bean:message key="lbl.tradCustName"/></b></td>
 ...
 <logic:notEmpty name="list">
  <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1"  partialList="true" size="${list[0].totalRecordSize}" requestURI="/tradeCheckCompletionBehindAction.do" >
