     ...
     <td class="gridtd">
 	  <table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr class="white2">
          ...
          <td colspan="3" >${dealHeader[0].dealCustomerName}
          <input type="hidden" id="dealCustomerId" value="${dealHeader[0].dealCustomerId}"/></td>
         </tr>
          <tr class="white2">
...
<center><font color="red"><html:errors /></font></center>
     ...
     <tr>
      <td>
       ...
       <td><bean:message key="lbl.assestCollateral"/></td>
         <td>
           <div id=forAll>
            <select name="assetCollateral" id="assetCollateral"  class="text" disabled="disabled" onchange="existingAssetCollateral('D');callOnLinkOrButtonWindowCollateral('assetCollateral');">
               <option  value="">---Select---</option>				    
 ...
 <td>
   ...
   <logic:present name="showCollateralDetails">
 <button type="button" name="Submit20" id="collateralDelet" class="topformbutton2" title="Alt+D" accesskey="D" onclick="return deleteCollateralDetails('D','N');"><bean:message key="button.delete" /></button>
 </logic:present>
  </td>
    ...
    <table cellspacing=0 cellpadding=0 width="100%" border=0>   
     <tr>
      ...
      <td><bean:message key="lbl.assestCollateral"/></td>
         <td>
           <div id=forAll>
            <select name="assetCollateral" id="assetCollateral" disabled="disabled" class="text" onchange="existingAssetCollateral('D');callOnLinkOrButtonWindowCollateral('assetCollateral');">
               <option  value="">---Select---</option>				    
               <option  value="N"><bean:message key="lbl.new"/></option>
              <option  value="E"><bean:message key="lbl.existing"/></option>
            </select>
            ...
            <div id="forAsset" style="display: none">
             <select name="assetCollateral" id="assetCollateral"  class="text" onchange="existingAssetCollateral('D');callOnLinkOrButtonWindowCollateral('assetCollateral');">
...
if('<%=request.getAttribute("sms")%>'=='S')
	...
	else if('<%=request.getAttribute("sms")%>'=='EX')
	{
