					...
					<html:form action="/updateGuaranteeAmount" styleId="guaranteeAmountForm">
						...
						<table width="100%"  border="0" cellspacing="0" cellpadding="1">
							...
							<td>&nbsp;</td>
												 ...
												 <tr>
												<td colspan="10" >
												<button type="button" name="Save" class="topformbutton2"  title="Alt+V" accesskey="V" id="Save" onclick="return saveGuaranteeAmount();" ><bean:message key="button.save" /></button>
												</td>
												<td></td>
													<td></td>
													<td></td>
