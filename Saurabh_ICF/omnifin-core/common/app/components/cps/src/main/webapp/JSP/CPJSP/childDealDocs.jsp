...
<html>
  ...
  <input type="hidden" name="rowNo" id="rowNo" value="${rowCount }"/>
    ...
    <tr class="white2">
     ...
     <td ><b><input type="checkbox" name="allchk" id="allchk" disabled="true" onclick="allChecked();"/><bean:message key="lbl.select" /></b></td> 
								...
								<logic:iterate name="collects" id="subcollects">
									...
									<logic:equal name="subChild" property="id" value="${subcollects}" >
										<%
											 k=1; 
										%>
									   <input type="checkbox" name="chk" id="chk"  disabled="true" checked="checked" value="${subChild.id }"/>
									</logic:equal>
								</logic:iterate>   
								    ...
								    <%
										...
										{ 
								     %>
											<input type="checkbox" name="chk" id="chk" disabled="true" value="${subChild.id }"/>
 ...
 %>
  ...
  <input type="hidden" name="rowNo" id="rowNo" value="${rowCount }"/>
    ...
    <tr class="white2">
     ...
     <td ><b><input type="checkbox" name="allchk" disabled="true" id="allchk" onclick="allChecked();"/><bean:message key="lbl.select" /></b></td> 
