 ...
 */
public class QuerResponseSearchBehindActionAction extends Action {
	/*
	 * Generated Methods
	 */
	private static final Logger logger = Logger.getLogger(QuerResponseSearchBehindActionAction.class.getName());
	/** 
	 * Method execute
	 * @param mapping
	 * @param form
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			...
			logger.info("In QuerResponseSearchBehindActionAction execute ");
			...
			if(userobj!=null)
			{
				...
				logger.info("here in execute method of QuerResponseSearchBehindActionAction action the session is out----------------");
			...
			ArrayList<CommonDealVo> queryResponseList = dao.queryResponseSearchDetail(vo);
			...
			return mapping.findForward("queryResponseSearch");	
