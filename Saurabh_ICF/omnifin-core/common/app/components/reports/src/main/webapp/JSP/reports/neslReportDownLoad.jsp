...
<html>
	...
	<html:form action="/neslReportGenerate" styleId="neslReportGenerate" >
		<fieldset>
				<legend><bean:message key="lbl.neslReportDownLoad"/></legend>  
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="1">
					<tr>
						...
						<html:option value="">---Select---</html:option>
							<html:option value="NeSL_DOWNLOAD_BIL_LAP">NeSL DOWNLOAD - BIL/LAP</html:option>
							<html:option value="NeSL_DOWNLOAD_LC">NeSL_DOWNLOAD - LC</html:option>
							...
							<td><bean:message key="lbl.neslFromDate"/><span><font color="red">*</font></span></td>
					...
					<tr>
						<td ><button type="button" name=" mybutton"  title="Alt+G" accesskey="G" class="topformbutton3" onclick="neslReport()"><bean:message key="button.generate" /></button></td>
					</tr>	
				</table>
		</fieldset>
	</html:form>
