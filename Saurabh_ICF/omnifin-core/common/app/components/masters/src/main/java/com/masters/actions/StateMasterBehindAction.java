...
import com.masters.vo.StateMasterVo;
		...
		public class StateMasterBehindAction extends Action  {
		private static final Logger logger = Logger.getLogger(StateMasterBehindAction.class.getName());

		public ActionForward execute(ActionMapping mapping, ActionForm form,
				HttpServletRequest request, HttpServletResponse response) throws Exception {
			HttpSession session=request.getSession();
			ServletContext context = getServlet().getServletContext();
			logger.info("In StateMasterBehindAction.........");
			...
			list= bp.searchStateData(vo);

		    logger.info("In StateMasterBehindAction....list"+list.size());
