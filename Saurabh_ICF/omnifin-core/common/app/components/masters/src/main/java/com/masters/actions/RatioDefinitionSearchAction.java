 ...
 */
public class RatioDefinitionSearchAction extends Action {
	private static final Logger logger = Logger.getLogger(RatioDefinitionSearchAction.class.getName());
...
ServletContext context = getServlet().getServletContext();
	    ...
	    logger.info("In RatioDefinitionSearchAction....list   :   "+list.size());
