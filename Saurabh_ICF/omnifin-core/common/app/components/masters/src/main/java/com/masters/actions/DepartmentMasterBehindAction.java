 ...
 */
public class DepartmentMasterBehindAction extends Action {
	private static final Logger logger = Logger.getLogger(DepartmentMasterBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		ArrayList list=new ArrayList();
			...
			list= bp.searchDepartmentData(vo);

		    logger.info("In DepartmentMasterBehindAction....list"+list.size());
