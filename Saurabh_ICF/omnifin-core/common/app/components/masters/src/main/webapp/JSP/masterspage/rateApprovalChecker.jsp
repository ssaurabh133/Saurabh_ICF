...
<!--Purpose  : Author of Rate Approval-->
<!--Documentation : -->
...
<html:form styleId="rateApprovalCheckerDynaValidatorForm"  method="post"  action="/rateMatrixCheckerDispatchAction" >
<div  align="center" class="opacity" style="display: none;"  id="processingImage"></div>
<fieldset>
  <legend><bean:message key="lbl.rateApprovalAuthor" /></legend>
	...
	<tr>
	 ...
	 <td>
		<html:select property="decision" styleId="decision" styleClass="text"  value="${rateApprovalList[0].decision}" >
		...
		<button type="button" name="save" id="save"  class="topformbutton2" onclick="return saveRateApprovalChecker();" accesskey="V" title="Alt+V"><bean:message key="button.save" /></button>
	      </td>
	</tr>
	</table>
...
<script type="text/javascript">
		...
		if('<%=request.getAttribute("sms").toString()%>'=='S')
	{
	    ...
	    parent.location="<%=request.getContextPath()%>/rateMatrixCheckerDispatchAction.do?method=rateApprovalCheckerSearch";
	}
