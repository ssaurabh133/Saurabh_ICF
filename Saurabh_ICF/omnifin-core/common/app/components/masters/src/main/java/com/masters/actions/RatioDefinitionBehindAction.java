 ...
 */
public class RatioDefinitionBehindAction extends Action {
	private static final Logger logger = Logger.getLogger(RatioDefinitionBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		list= bp.ratioDefinitionSearch(vo);

	    logger.info("In RatioDefinitionBehindAction....list"+list.size());
