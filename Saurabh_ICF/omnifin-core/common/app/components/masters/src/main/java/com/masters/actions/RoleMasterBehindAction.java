...
public class RoleMasterBehindAction extends Action{
	private static final Logger logger = Logger.getLogger(RoleMasterBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		org.apache.commons.beanutils.BeanUtils.copyProperties(roleMasterVo, CommonDynaValidatorForm);
		...
		ArrayList list=new ArrayList();
		 ...
		 logger.info("current page link .......... "+request.getParameter("d-49520-p"));
			...
			roleMasterVo.setCurrentPageLink(currentPageLink);
			list= mb.searchRoleData(roleMasterVo);
