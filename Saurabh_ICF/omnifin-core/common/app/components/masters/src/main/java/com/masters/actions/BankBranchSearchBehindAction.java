 ...
 */
public class BankBranchSearchBehindAction extends Action {
	private static final Logger logger = Logger.getLogger(BankBranchSearchBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		ServletContext context = getServlet().getServletContext();
		logger.info("In BankBranchMasterBehindAction.........");
		...
		BankBranchMasterVo vo = new BankBranchMasterVo();
		  ...
		  ArrayList list=new ArrayList();
		    ...
		    list= cpm.searchBankBranchDao(vo);

		    logger.info("In BankBranchMasterBehindAction....list"+list.size());
