...
public class CrSchemeSearchBehindAction extends Action {
	private static final Logger logger = Logger.getLogger(CrSchemeSearchBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		list= cpm.searchScemeCodeDao(vo);

	    logger.info("In CrSchemeSearchBehindAction....list"+list.size());
