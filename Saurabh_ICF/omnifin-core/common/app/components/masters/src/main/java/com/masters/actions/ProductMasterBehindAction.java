...
import com.masters.vo.ProductMasterVo;
		 ...
		 */
		public class ProductMasterBehindAction extends Action {
			private static final Logger logger = Logger.getLogger(ProductMasterBehindAction.class.getName());
			public ActionForward execute(ActionMapping mapping, ActionForm form,
					HttpServletRequest request, HttpServletResponse response) throws Exception {
				ServletContext context = getServlet().getServletContext();
				logger.info("In ProductMasterBehindAction.........");
				...
				CreditProcessingMasterBussinessSessionBeanRemote cpm = (CreditProcessingMasterBussinessSessionBeanRemote) LookUpInstanceFactory.getLookUpInstance(CreditProcessingMasterBussinessSessionBeanRemote.REMOTE_IDENTITY, request);
				  ...
				  logger.info("current page link .......... "+request.getParameter("d-49520-p"));
					...
					list= cpm.searchProductData(vo);

				    logger.info("In ProductMasterBehindAction....list"+list.size());
