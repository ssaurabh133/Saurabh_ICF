...
//Date of Creation : -->
//Purpose  : Behind Action For Branch Master-->
//Documentation : -->
...
public class BranchMasterBehindAction extends Action{
	private static final Logger logger = Logger.getLogger(BranchMasterBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		logger.info("In BranchMasterBehindAction.........");
		...
		org.apache.commons.beanutils.BeanUtils.copyProperties(branchMasterVo, CommonDynaValidatorForm);
		...
		branchMasterVo.setCurrentPageLink(currentPageLink);
		list= bp.searchBranchData(branchMasterVo);

	    logger.info("In BranchMasterBehindAction....list"+list.size());
