...
public class BusinessMonthBehindAction extends Action{
	private static final Logger logger = Logger.getLogger(BusinessMonthBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        ArrayList<BusinessClosureVo>  BusinessClosureList = new ArrayList<BusinessClosureVo> ();
        MasterDAO dao=(MasterDAO)DaoImplInstanceFactory.getDaoImplInstance(MasterDAO.IDENTITY);
        BusinessClosureList=dao.getBusinessMonthList(vo);
        if(BusinessClosureList.size()>0){
        request.setAttribute("BusinessClosureList", BusinessClosureList);
        logger.info("list..........................................."+vo.getRecStatus());
