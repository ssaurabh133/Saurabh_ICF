...
<!--Purpose  : Show productes for user -->
<!--Documentation : -->
...
<title><bean:message key="lbl.listOfProduct" /></title>
...
<fieldset>	
	<legend><bean:message key="lbl.listOfProduct"/></legend>    
		 		...
		 		<tr>
		    		<td class="gridtd">
    					...
    					<tr class="white2">
        		 			...
        		 			<td align="center"><b><bean:message key="lbl.products"/></b></td>
			 			</tr>
						<logic:present name="list">   
						<logic:iterate name="list" id="subdealdetails" >
	   					<tr class="white1">	        
          	 				<td>${subdealdetails.userId}</td>          	 
         	 				<td>${subdealdetails.productName}</td>
         	 			</tr>
						</logic:iterate>
						</logic:present>
						</table>
