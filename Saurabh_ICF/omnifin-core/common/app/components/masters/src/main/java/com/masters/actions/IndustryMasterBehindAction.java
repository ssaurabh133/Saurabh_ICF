...
//Date of Creation : -->
//Purpose  : Behind Action For Industry Master-->
//Documentation : -->
...
public class IndustryMasterBehindAction extends Action{
	private static final Logger logger = Logger.getLogger(IndustryMasterBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		logger.info("In IndustryMasterBehindAction.........");
		...
		org.apache.commons.beanutils.BeanUtils.copyProperties(industryMasterVo, CommonDynaValidatorForm);
		...
		industryMasterVo.setCurrentPageLink(currentPageLink);
		list= bp.searchIndustryData(industryMasterVo);
