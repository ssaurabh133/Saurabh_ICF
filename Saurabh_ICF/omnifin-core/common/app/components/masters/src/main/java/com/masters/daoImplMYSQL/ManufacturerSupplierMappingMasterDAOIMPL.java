...
public class ManufacturerSupplierMappingMasterDAOIMPL implements ManufacturerSupplierMappingMasterDAO {
	static final Logger logger = Logger.getLogger(ManufacturerSupplierMappingMasterDAOIMPL.class.getName());
	...
	public ArrayList<ManufacturerSupplierMappingVO> getManufacturerSupplierMappingRecords(ManufacturerSupplierMappingVO vo, int currentPageLink) 
	{
		...
		try
		{
			...
			bufInsSql.append("SELECT DISTINCT MANUFACTURE_ID,MANUFACTURE_ID,MANUFACTURE_DESC,IF(REC_STATUS='A','Active','Inactive')AS REC_STATUS FROM cr_manufacture_supplier_mapping	");								    	    
		    ...
		    bufInsSql.append(" ORDER BY MANUFACTURE_ID ");
	 ...
	 public ArrayList<ManufacturerSupplierMappingVO> searchManufacturerSupplierMappingList(ManufacturerSupplierMappingVO vo)
	{
		...
		try
		{
			...
			bufInsSql.append(" SELECT MANUFACTURE_ID,MANUFACTURE_ID,MANUFACTURE_DESC,IF(REC_STATUS='A','Active','Inactive')AS REC_STATUS ");					
