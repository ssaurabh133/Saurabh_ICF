...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/masterScript/reportFunctionAccess.js"></script>
...
<body onload="enableAnchor();document.getElementById('reportFunctioAccessForm').roleButton.focus();init_fields();">


<html:form styleId="reportFunctioAccessForm"  method="post"  action="/reportFunctionAccess" >
<html:errors/>

<fieldset>
<legend><bean:message key="lbl.reportFunctionAccess" /></legend>
  <table width="100%">
    <tr>
    <td width="13%"><bean:message key="lbl.roleId" /><span><font color="red">*</font></span></td>
       ...
       <html:button property="roleButton" styleId="roleButton" onclick="openLOVCommon(352,'reportFunctioAccessForm','roleId','','', '','','','moduleId','lbxModuleId')" value=" " styleClass="lovbutton"></html:button> 
    ...
    <td>
     <button type="button" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="fnReportSearch('<bean:message key="lbl.selectBoth" />','<bean:message key="lbl.selectRoleCode" />','<bean:message key="lbl.selectModuleCode" />');" ><bean:message key="button.search" /></button>
     <input type="hidden" name="path" id="path" value="<%=request.getContextPath()%>" />
     
    <logic:present name="list">
	    <logic:notEmpty name="list">
	       <button type="button" id="save" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveReportAccess('<bean:message key="lbl.selectBoth" />','<bean:message key="lbl.selectRoleCode" />','<bean:message key="lbl.selectModuleCode" />');"  ><bean:message key="button.save" /></button>
	    </logic:notEmpty>
