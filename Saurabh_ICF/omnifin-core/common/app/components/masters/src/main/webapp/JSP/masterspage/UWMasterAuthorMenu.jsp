...
<li><a href="<%=request.getContextPath()%>/UWApprovalLevelDefAuthorApprove.do?method=EditapprovalLevelDefAuthor" id="a"><span>U/W Approval Level Def Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/UWApprovalLevelDefAuthorApprove.do?method=openApprovalLevelAuthor" id="b"><span>U/W Approval Level Def Author</span></a></li>
</ul>
</div>
