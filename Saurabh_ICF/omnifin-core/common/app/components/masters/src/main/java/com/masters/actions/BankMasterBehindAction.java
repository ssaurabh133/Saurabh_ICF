 ...
 */
public class BankMasterBehindAction extends Action {
	private static final Logger logger = Logger.getLogger(BankMasterBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		ServletContext context = getServlet().getServletContext();
		logger.info("In BankMasterBehindAction.....###");
		...
		if(!strFlag.equalsIgnoreCase(""))
		{
			...
			list= cpm.searchBankData(vo);
			 
			 logger.info("In BankMasterBehindAction....list"+list.size());
