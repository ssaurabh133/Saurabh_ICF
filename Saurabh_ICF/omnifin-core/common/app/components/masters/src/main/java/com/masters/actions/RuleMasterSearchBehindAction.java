 ...
 */
public class RuleMasterSearchBehindAction extends Action {
	private static final Logger logger = Logger.getLogger(RuleMasterSearchBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		list= cpm.ruleMasterSearch(vo);

	    logger.info("In RuleMasterSearchBehindAction....list"+list.size());
