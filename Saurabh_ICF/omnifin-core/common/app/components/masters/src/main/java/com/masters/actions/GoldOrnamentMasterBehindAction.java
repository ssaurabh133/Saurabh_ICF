...
import com.masters.vo.ProductMasterVo;
		 ...
		 */
		public class GoldOrnamentMasterBehindAction extends Action {
			private static final Logger logger = Logger.getLogger(GoldOrnamentMasterBehindAction.class.getName());
			public ActionForward execute(ActionMapping mapping, ActionForm form,
					HttpServletRequest request, HttpServletResponse response) throws Exception {
				ServletContext context = getServlet().getServletContext();
				logger.info("In Gold Ornament MasterBehindAction.........");
				...
				CreditProcessingMasterBussinessSessionBeanRemote cpm = (CreditProcessingMasterBussinessSessionBeanRemote) LookUpInstanceFactory.getLookUpInstance(CreditProcessingMasterBussinessSessionBeanRemote.REMOTE_IDENTITY, request);
				  ...
				  logger.info("current page link .......... "+request.getParameter("d-49520-p"));
					...
					list= cpm.searchGoldOrnamentData(vo);
					

				    logger.info("In Gold Ornament MasterBehindAction....list"+list.size());
					
				   request.setAttribute("list", list);
				   request.setAttribute("ornamentId", vo.getOrnamentId());
					request.setAttribute("ornamentType", vo.getOrnamentTypeSearch());
					request.setAttribute("ornamentStandard", vo.getOrnamentStandardSearch());
