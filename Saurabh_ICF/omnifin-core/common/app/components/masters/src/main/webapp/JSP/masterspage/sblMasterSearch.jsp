...
<html:form action="/SBLGBLMasterSearch" styleId="sblMaster" method="post" > 	
...
<legend><bean:message key="lbl.sblMaster"/></legend>
	...
	<tr>
	 ...
	 <tr>
	 <td>
	  <button type="button" id="save" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return fnSearchSBL('<bean:message key="lbl.selectAtleast" />');" ><bean:message key="button.search" /></button>
	  <button type="button"  name="add" id="add" class="topformbutton2" title="Alt+A" accesskey="A" onclick="return newAddSBL();" ><bean:message key="button.add" /></button></td>
...
<br/>
<fieldset>
		 <legend><bean:message key="lbl.sblDetail"/></legend> 

  <logic:present name="list">
 	<logic:notEmpty name="list">
  <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/SBLGBLMasterBehind.do" >
