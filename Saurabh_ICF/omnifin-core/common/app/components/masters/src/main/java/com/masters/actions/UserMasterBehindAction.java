...
public class UserMasterBehindAction extends Action{
	private static final Logger logger = Logger.getLogger(UserMasterBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		logger.info("In UserMasterBehindAction.........");
		...
		org.apache.commons.beanutils.BeanUtils.copyProperties(userMasterVo, CommonDynaValidatorForm);
		...
		ArrayList list=new ArrayList();
		 ...
		 logger.info("current page link .......... "+request.getParameter("d-49520-p"));
			...
			userMasterVo.setCurrentPageLink(currentPageLink);
			list= mb.searchUserData(userMasterVo);

		    logger.info("In UserMasterBehindAction....list"+list.size());
