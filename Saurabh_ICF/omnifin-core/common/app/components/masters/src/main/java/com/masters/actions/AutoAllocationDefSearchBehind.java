...
public class AutoAllocationDefSearchBehind extends Action {
	private static final Logger logger = Logger.getLogger(AutoAllocationDefSearchBehind.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		ServletContext context = getServlet().getServletContext();
		logger.info("In AutoAllocationDefSearchBehind.........");
		...
		AutoAllocationDefinitionVo vo = new AutoAllocationDefinitionVo();
		  ...
		  CreditManagementBussinessSessionBeanRemote cm = (CreditManagementBussinessSessionBeanRemote) LookUpInstanceFactory.getLookUpInstance(CreditManagementBussinessSessionBeanRemote.REMOTE_IDENTITY, request);
			...
			ArrayList<AutoAllocationDefinitionVo> list = cm.searchAutoAllocationBean(vo);

		    logger.info("In AutoAllocationDefSearchBehind....list"+list.size());
