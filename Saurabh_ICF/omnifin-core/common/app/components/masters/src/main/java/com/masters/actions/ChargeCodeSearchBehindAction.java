...
public class ChargeCodeSearchBehindAction extends DispatchAction {
	private static final Logger logger = Logger.getLogger(ChargeCodeSearchBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		ServletContext context = getServlet().getServletContext();
		
		logger.info("In ChargeCodeSearchBehindAction.........");
		...
		if(!strFlag.equalsIgnoreCase(""))
		{
		  ...
		  org.apache.commons.beanutils.BeanUtils.copyProperties(chargeCodeMasterVo, CommonDynaValidatorForm);
		  ...
		  logger.info("current page link .......... "+request.getParameter("d-49520-p"));
			...
			chargeCodeMasterVo.setCurrentPageLink(currentPageLink);
			list= cpm.searchChargeCodeDao(chargeCodeMasterVo);

		    logger.info("In ChargeCodeSearchBehindAction....list"+list.size());
