...
<!--Date of Creation : 08 April 2013  -->
<!--Purpose  : U/W Approval Level Def Master Author Search-->
<!--Documentation : -->
...
<body onload="enableAnchor();" >   
	...
	<html:form styleId="approvalLevelDefSearchFormAuthor"  method="post"  action="/UWApprovalLevelDefAuthor" >
	<html:errors/>
	<fieldset>
	...
	<table>
 	 <tr>  
      	...
      	<td width="13%" >
			...
			<input type="button" class="lovbutton" id="productButton" onclick="openLOVCommon(89,'approvalLevelDefSearchFormAuthor','product','','','','','','lbxProductID')" value=" " tabindex="26" name="dealButton">
      ...
      <td width="20%">            
			...
			<html:button property="schemeButton" styleId="schemeButton" onclick="openLOVCommon(287,'approvalLevelDefSearchFormAuthor','scheme','product','lbxSchemeId', 'lbxProductID','Please firstly select Product then Scheme','','lbxSchemeId');" value=" " styleClass="lovbutton"> </html:button>           						    
      </td>      
    </tr>
    ...
    <tr>
      ...
      <td width="13%" >
			<html:select property="findApprovalSearch" styleClass="text" value="${requestScope.Vo.findApprovalSearch}" styleId="findApprovalLevel">
    ...
    <tr> 
    <td>
     <button type="button"  id="forward" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return SearchApprovalLevelAuthor('<bean:message key="lbl.selectAtleast" />');" ><bean:message key="button.search" /></button>
    </tr>
	</table>	
	 </fieldset> 
...
<legend><bean:message key="lbl.userDetail" /></legend>
  ...
  <logic:notEmpty name="list">
	  <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/UWApprovalLevelDefAuthor.do" >
