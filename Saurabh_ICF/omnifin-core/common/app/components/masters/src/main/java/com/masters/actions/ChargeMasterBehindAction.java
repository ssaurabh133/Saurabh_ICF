...
public class ChargeMasterBehindAction extends Action{
	private static final Logger logger = Logger.getLogger(ChargeMasterBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		logger.info("In ChargeMasterBehindAction.........");
		...
		org.apache.commons.beanutils.BeanUtils.copyProperties(chargeMasterVo, CommonDynaValidatorForm);
		...
		chargeMasterVo.setCurrentPageLink(currentPageLink);
		list= cpm.searchChargeData(chargeMasterVo);

	    logger.info("In ChargeMasterBehindAction....list"+list.size());
