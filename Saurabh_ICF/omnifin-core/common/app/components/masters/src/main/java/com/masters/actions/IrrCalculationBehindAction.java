...
public class IrrCalculationBehindAction extends Action  {
		private static final Logger logger = Logger.getLogger(IrrCalculationBehindAction.class.getName());
		
		public ActionForward execute(ActionMapping mapping, ActionForm form,
				HttpServletRequest request, HttpServletResponse response) throws Exception {
			HttpSession session=request.getSession(false);
			ServletContext context = getServlet().getServletContext();
			logger.info(" ## In IrrCalculationBehindAction() : .........");
			...
			if(!strFlag.equalsIgnoreCase(""))
			{
				...
				return mapping.findForward("logout");
					...
					IrrCalculationMasterVo vo = new IrrCalculationMasterVo(); //change
		...
		//	vo.setCurrentPageLink(currentPageLink);
			...
			//change from here
			list= bp.searchIrrCalculationData(vo);

		    logger.info("In IrrCalculationBehindAction....list"+list.size());
