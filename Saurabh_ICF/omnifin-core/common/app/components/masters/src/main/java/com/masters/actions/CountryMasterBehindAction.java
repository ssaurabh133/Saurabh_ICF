...
public class CountryMasterBehindAction extends Action  {
		private static final Logger logger = Logger.getLogger(CountryMasterBehindAction.class.getName());
		
		public ActionForward execute(ActionMapping mapping, ActionForm form,
				HttpServletRequest request, HttpServletResponse response) throws Exception {
			
			logger.info("In execute method of CountryMasterBehindAction.........");
			...
			list= bp.searchCountryData(vo);

		    logger.info("In CountryMasterBehindAction....list"+list.size());
