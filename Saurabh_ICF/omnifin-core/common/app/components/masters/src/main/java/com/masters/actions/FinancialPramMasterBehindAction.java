 ...
 */
public class FinancialPramMasterBehindAction extends Action {
	private static final Logger logger = Logger.getLogger(FinancialPramMasterBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		ServletContext context = getServlet().getServletContext();
		logger.info("In FinancialPramMasterBehindAction.....###");
		...
		if(!strFlag.equalsIgnoreCase(""))
		{
			...
			list= bp.searchFinancialPramData(vo);
			 
			 logger.info("In FinancialPramMasterBehindAction....list"+list.size());
