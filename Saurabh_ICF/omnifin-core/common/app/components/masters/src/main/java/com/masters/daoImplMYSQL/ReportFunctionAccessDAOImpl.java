...
public class ReportFunctionAccessDAOImpl implements ReportFunctionAccessDAO
 {
	
	private static final Logger logger = Logger.getLogger(ReportFunctionAccessDAOImpl.class.getName());
	...
	public ArrayList<ReportFunctionAccessVo> getReportName(Object ob) 
	{
		...
		try {
			...
			bufInsSql.append("Select DISTINCT reports.REPORT_NAME,reports.REPORT_DESC,IFNULL(CRM.REC_STATUS,'X') from reports ");
