...
import com.masters.vo.ConsortiumPartnerVo;
		...
		public class ConsortiumPartnerMasterBehindAction extends Action  {
		private static final Logger logger = Logger.getLogger(ConsortiumPartnerMasterBehindAction.class.getName());
		public ActionForward execute(ActionMapping mapping, ActionForm form,
				HttpServletRequest request, HttpServletResponse response) throws Exception {
			HttpSession session=request.getSession();
			
			logger.info("In ConsortiumPartnerMasterBehindAction.........");
			...
			logger.info("current page link .......... "+request.getParameter("d-49520-p"));
					...
					list= bp.searchConsortiumData(vo);

				    logger.info("In ConsortiumPartnerMasterBehindAction....list"+list.size());
