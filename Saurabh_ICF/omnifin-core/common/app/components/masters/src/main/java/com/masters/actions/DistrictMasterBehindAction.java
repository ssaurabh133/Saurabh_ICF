...
public class DistrictMasterBehindAction extends Action  {
private static final Logger logger = Logger.getLogger(DistrictMasterBehindAction.class.getName());
		public ActionForward execute(ActionMapping mapping, ActionForm form,
		    
			HttpServletRequest request, HttpServletResponse response) throws Exception {
			HttpSession session=request.getSession();
			ServletContext context = getServlet().getServletContext();
			logger.info("In DistrictMasterBehindAction.........");
			...
			list= bp.searchDistrictData(vo);

		    logger.info("In DistrictMasterBehindAction....list"+list.size());
