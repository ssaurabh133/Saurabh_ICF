...
<li><a href="<%=request.getContextPath()%>/JSP/masterspage/rateApprovalMaker.jsp" target="body" id="a"><span style="color: rgb(255, 255, 255);">Rate Approval Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/rateMatrixCheckerDispatchAction.do?method=openRateApprovalChecker" target="body" id="b"><span style="color: rgb(255, 255, 255);">Rate Approval Checker</span></a></li>
