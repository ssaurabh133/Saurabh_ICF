...
import com.masters.vo.RegionMasterVo;
		...
		public class RegionMasterBehindAction extends Action  {
		private static final Logger logger = Logger.getLogger(RegionMasterBehindAction.class.getName());
		public ActionForward execute(ActionMapping mapping, ActionForm form,
				HttpServletRequest request, HttpServletResponse response) throws Exception {
			HttpSession session=request.getSession();
			
			logger.info("In RegionMasterBehindAction.........");
			...
			logger.info("current page link .......... "+request.getParameter("d-49520-p"));
					...
					list= bp.searchRegionData(vo);

				    logger.info("In RegionMasterBehindAction....list"+list.size());
