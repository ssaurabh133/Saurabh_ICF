...
public class NPASatgeMasterBehindAction extends Action{
	private static final Logger logger = Logger.getLogger(NPASatgeMasterBehindAction.class.getName());
