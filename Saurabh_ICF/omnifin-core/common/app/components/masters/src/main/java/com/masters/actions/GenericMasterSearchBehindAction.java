...
public class GenericMasterSearchBehindAction extends Action {
	private static final Logger logger = Logger.getLogger(GenericMasterSearchBehindAction.class.getName());
		public ActionForward execute(ActionMapping mapping, ActionForm form,
				HttpServletRequest request, HttpServletResponse response) throws Exception {
			
			ServletContext context = getServlet().getServletContext();
			logger.info("in Generic Master Behind Action..");
			...
			GenericMasterVo vo=new GenericMasterVo();
			...
			list= bp.searchGenericMasterDao(vo);

		    logger.info("In GenericMasterSearchBehindAction....list"+list.size());
