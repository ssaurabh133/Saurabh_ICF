...
<body>
	<html:form action="/collButtonAction" styleId="PaymentDetailsFormId"
		method="post">
		...
		<fieldset>
			<legend>
				<bean:message key="lbl.payment.details" />
			</legend>
			<fieldset>
				<logic:present name="list">
					<display:table id="list" name="list" style="width: 100%"
						...
						requestURI="/collButtonAction.do?method=paymentDetails">
						...
						<display:setProperty name="locale.provider"
							value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
						<display:column property="paymentDate" titleKey="lbl.paymentDate"
							sortable="true" />
						<display:column property="paymentAmount"
							titleKey="lbl.paymentAmount" sortable="true" />
						<display:column property="paymentMode" titleKey="lbl.paymentMode"
							sortable="true" />
								...
								<table width="100%" cellspacing="1" cellpadding="1" border="0">
									<tbody>
										<tr align="center" class="white2">
											<td>
												<b><bean:message key="lbl.paymentDate" />
												</b>
											</td>
											<td>
												<b><bean:message key="lbl.paymentAmount" />
												</b>
											</td>
											<td>
												<b><bean:message key="lbl.paymentMode" />
												</b>
											</td>
										</tr>
									</tbody>
