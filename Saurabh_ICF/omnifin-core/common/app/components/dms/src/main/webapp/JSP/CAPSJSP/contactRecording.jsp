...
<html:form styleId="contectRecordingForm"  method="post"  action="/contactRecordingDispatchAction" >
...
<bean:message key="lbl.contactRecording" />
</logic:notPresent>
...
<tr><td class="gridtd">
  <table cellpadding="2"  cellspacing="1" width="100%" border="0">
   <tr class="white1">
  <td width="14%"><b>Address Type</b></td>
  <td width="18%">${contactInfoList[0].addressType} </td>
  <td width="14%"></td>
  <td width="18%"></td>
  <td width="14%"></td>
  <td width="18%"></td>
...
<td><b><bean:message key="lbl.Rm" /></b></td>
 	<td >${loanInfoList[0].rm}</td>
      ...
      <td>${loanInfoList[0].rmSup}</td>
 	  <td><b><bean:message key="lbl.LastReceiptDate" /> </b></td>
  <td>${loanInfoList[0].receiptDate}</td>
  <td><b><bean:message key="lbl.receiptAmount" /></b></td>
  <td>${loanInfoList[0].receiptAmount}</td>
  <td><b><bean:message key="lbl.overdueInstalment" /></b></td>
  <td>${loanInfoList[0].overdueEMI}</td>
 	 </tr>
...
<tr><td class="gridtd">
  ...
  <%-- <button type="button" value="Legal Initiation" class="topformbutton2" id="legal_initiation" title="Alt+L" accesskey="L" onclick="viewLegalInitiation('${customerInfoList[0].loanId}','${customerInfoList[0].loanNo}');"><bean:message key="button.legalInitiation" /></button> --%>
  </td>
