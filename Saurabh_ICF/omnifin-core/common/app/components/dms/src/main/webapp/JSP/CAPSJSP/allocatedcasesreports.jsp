...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/development-bundle/ui/jquery.ui.datepicker.js"></script>
		 ...
		 <!-- css and jquery for Datepicker -->
		<title>Reports</title>
		<script type="text/javascript" src="<%=request.getContextPath() %>/js/capsScript/casereport.js"></script>
<script type="text/javascript"
	...
	<input type="hidden" name="formatD" id="formatD" value="<bean:message key="lbl.dateFormat"/>" />
				<html:form action="/allocatecaseReports" styleId="allocatecasereportForm" >
					<fieldset>
						<legend><bean:message key="lbl.allocatedCase" /></legend>
							<input type="hidden" name="formatD" id="formatD" value="<bean:message key="lbl.dateFormat"/>" />
...
<input id="product" class="text" type="text" readonly="readonly" value="" tabindex="-1" name="product">
<input id="lbxProduct" class="lovbutton" type="button" name="dealButton" tabindex="3" value=" " onclick="openLOVCommon(17,'leadCapturing','product','','','','','','lbxProductID')">
<input id="lbxProductID" class="text" type="hidden" value="" name="lbxProductID">
      <!--<html:select  property="product" styleClass="text"  styleId="product"  >
...
<html:text property="pos2" styleClass="text" styleId="pos2" style="text-align: right"
										maxlength="18" onkeyup="checkNumber(this.value, event, 18,id);"
    ...
    <td >
     ...
     <tr>
								...
								<button type="button" class="topformbutton2" name="mybutton"  onclick="genrateAllocateCase();" 
