...
<html>
	...
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/capsScript/collectionMISReports.js"></script>
		<script type="text/javascript"
...
function fntab()
{
     ...
     {
    	 document.getElementById('collectionMISReportForm').loanSearchButton.focus();
     }
...
{
	document.getElementById('lastActionCode').value="COLL";
...
.white2 {
	...
	<body onload="enableAnchor();ClearCollMisField();fntab();">
		<div id="centercolumn">
			<div id="revisedcontainer">
				<html:form action="/collectionMIS" styleId="collectionMISReportForm">
					<fieldset>
						<legend>
							<bean:message key="lbl.collectionMis"/>
						</legend>
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="1">
							...
							<tr>
								...
								<td>
									...
									<html:hidden property="lastActionCode" styleId="lastActionCode" value="COLL" />
								</td>
								<td>
...
<button type="button" class="topformbutton2" name="mybutton" id="show" onclick="javaScript:save('<bean:message key="lbl.selectAtLeast"/>');" 
