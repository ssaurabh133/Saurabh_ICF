...
<!--Date of Creation :1 Nov 2011  -->
<!--Purpose  : Contact Recording Search Page-->
<!--Documentation : -->
<%@ page language="java"%>
<%@ page session="true"%>
...
<html:form styleId="supervisorReviewSearch"  method="post"  action="/supervisorReviwBehindAction" >
...
<html:errors/>
<fieldset>
<legend><bean:message key="lbl.supervisorReviewSearch" /></legend>
...
<tr> 
    ...
    <html:button property="loanSearchButton" styleId="loanSearchButton" onclick="openLOVCommon(195,'contactRecordingSearch','loanno','','', '','','','lbxLoanno');closeLovCallonLov1();" value=" " styleClass="lovbutton"> </html:button>
<html:hidden property="lbxLoanno" styleId="lbxLoanno"  />
    ...
    <tr>
     <td><bean:message key="lbl.DPD2" /></td>
      <td><html:text property="dpd2" styleClass="text"  styleId="dpd2" maxlength="5" style="text-align: right" />
  
     </td>
    <td><bean:message key="lbl.DPD1" /></td>
      <td><html:text property="dpd1" styleClass="text"  styleId="dpd1" maxlength="5"  style="text-align: right"   />
    ...
    <tr>
      ...
      <td><html:text property="pos2" styleClass="text"  styleId="pos2"   onkeypress="return numbersonly(event,id,18)" style="text-align: right" 
    ...
    <tr>
     ...
     <logic:notEmpty  name="customercatList">
       ...
       <td><html:text property="balanceprincipal" styleClass="text"  styleId="balanceprincipal"  style="text-align: right"
        onkeypress="return numbersonly(event,id,18)" 
		onblur="formatNumber(this.value,id);"
		onkeyup="checkNumber(this.value, event, 18,id);" 
		onfocus="keyUpNumber(this.value, event, 18,id);"   />
    ...
    <tr> 
    <td>
    <!--  <input type="button"  value="Search" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="this.disabled='true';searchSupervisorReview('<bean:message key="lbl.selectAtleast" />');" /> -->
    <button type="button" class="topformbutton2"   id="search"  onclick="this.disabled='true';searchSupervisorReview('<bean:message key="lbl.selectAtleast" />');"
...
<fieldset>
<legend><bean:message key="lbl.supervisorReviewSearchDtl" /></legend>

 <logic:present name="list">

  <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}"  cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/supervisorReviwBehindAction.do" >
	...
	<display:column property="tos1" titleKey="lbl.totalOutstanding"  sortable="true"  />
...
<script type="text/javascript">
	...
	if('<%=request.getAttribute("flagg").toString()%>'=='No')
	{
		...
		//	document.getElementById("supervisorReviewSearch").action="supervisorReviwBehindAction.do";
