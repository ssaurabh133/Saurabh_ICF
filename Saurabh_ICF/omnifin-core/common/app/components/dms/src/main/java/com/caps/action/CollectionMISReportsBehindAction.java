...
public class CollectionMISReportsBehindAction extends Action{
	private static final Logger logger = Logger.getLogger(CollectionMISReportsBehindAction.class.getName());
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)throws Exception {
				...
				String businessDate="";
				if(userobj==null){
					logger.info("here execute method of CollectionMISReportsBehindAction action the session is out----------------");
				...
				logger.info("In CollectionMISReportsBehindAction");
			    ...
			    return mapping.findForward("openCollMisSuccess");
