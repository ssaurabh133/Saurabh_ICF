...
<!--Purpose  : Contect Recording Page -->
<!--Documentation : -->
...
<html:form styleId="contactRecFollowUpForm"  method="post"  action="/contactRecordingDispatchAction" >
...
<legend><bean:message key="lbl.FollowUpRecord" /></legend>
 ...
 <td>
  ...
  <tr>
  <td><bean:message key="lbl.contactMode" /><font color="red">*</font>
  <logic:present name="superReview"></logic:present>
  <logic:notPresent name="superReview"><font color="red"></font></logic:notPresent></td>
 <%--  <td><html:text property="contactMode" styleClass="text" styleId="contactMode"/></td> --%>
 <td>
					<html:select styleId="contactMode" property="contactMode" styleClass="text">
						<html:option value="">---Select---</html:option>
						<logic:present name="contactList">
							<logic:notEmpty name="contactList">
								<html:optionsCollection name="contactList" label="contactCode" value="contactCodeType" /> 
							</logic:notEmpty>
						</logic:present> 
					</html:select>
		   </td>
   ...
   <tr>
  <td>Applicant Type<font color="red">*</font></td>
	<td>
		<html:select property="applicantType" styleId="applicantType" value="" styleClass="text" onchange="getPDCSubmitCustomerName();">
   ...
   <td>
   		<bean:message key="lbl.personContacted" /><font color="red">*</font>
   			<logic:present name="superReview"></logic:present>
   			<logic:notPresent name="superReview"><font color="red"></font>
   			</logic:notPresent>
   	</td>
	<td>
		    <div id="s4">
			     <html:text styleClass="text" property="personContacted"
				 styleId="personContacted" tabindex="-1" maxlength="100" value="" />
			</div>	
 ...
 title="Alt+V" accesskey="V" ><bean:message key="button.save" /></button>
   ...
   <logic:present name="sms">
	...
	if('<%=request.getAttribute("sms").toString()%>'=='S')
	{
		...
		if(actionCode=='EC'){
			window.opener.location.href="contactRecordingDispatchAction.do?method=openContactRecordingTrail&loanId="+loanId+"&exclationFlag="+exclationFlag+"&superReview="+superReview;
		//window.opener.location.href="contactRecordingBehindAction.do";
		}else{
		 window.opener.location.href="contactRecordingDispatchAction.do?method=openContactRecordingTrail&loanId="+loanId+"&exclationFlag="+exclationFlag+"&superReview="+superReview;
        }
        self.close();
