...
//						else if((assignFrom > businessdate)&&(assignto>businessdate)){
//						alert(" From/To Date is greater than business date ");
//					    return false;
//					  }
//					else if((assignto > businessdate)){
//						alert(" To Date is greater than business date ");
//					    return false;
//					  }
//					else if((assignFrom > businessdate)){
//						alert(" From Date is greater than business date ");
//					    return false;
//					  }
...
//							}
//							else{
//						  document.getElementById("delinquentcasereportForm").submit();	
...
//							}
//							else{
//						  document.getElementById("allocatecasereportForm").submit();	
//							Window.location.reload();
//					  }
//						
//					}
