...
public class MobileDownload extends Action{
	private static final Logger logger = Logger.getLogger(MobileDownload.class.getName());
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)throws Exception {
				...
				String businessDate="";
				if(userobj==null){
					logger.info("here execute method of MobileDownload action the session is out----------------");
				...
				logger.info("In MobileDownload");
			
			/*	try{
					String lead= (String) request.getAttribute("leadId");
					logger.info("leadId::::::::"+lead);
					if(CommonFunction.checkNull(lead).equalsIgnoreCase("NEW"))
					{
				...
				response.addHeader("Content-Disposition", "attachment; filename="+"OmniFinDMSAndroid"+".apk");
