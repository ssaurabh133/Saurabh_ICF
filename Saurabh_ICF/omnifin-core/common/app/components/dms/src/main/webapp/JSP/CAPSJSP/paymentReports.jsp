...
<html>
	...
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/capsScript/paymentReports.js"></script>
...
function fntab()
{
 if(document.getElementById('format').value =='F')		
     {
    	 document.getElementById('paymentReportsForm').loanSearchButton.focus();
     }
...
.white2 {
	...
	<body onload="enableAnchor();ClearPaymentField();fntab();">
		<div id="centercolumn">
	...
	<input type="hidden" name="formatD" id="formatD" value="<bean:message key="lbl.dateFormat"/>" />
				<html:form action="/paymentReports" styleId="paymentReportsForm">
					<fieldset>
						<legend>
							<bean:message key="lbl.promiseToPay"/>
						</legend>
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="1">
							...
							<tr>
								...
								<td>
									...
									<html:button property="loanSearchButton"
										...
										onclick="openLOVCommon(195,'reallocationCollForm','loanno','','', 'lastActionCode','','','lbxLoanno');closeLovCallonLov1();"
							...
							<tr>
								...
								<td>
									<html:text property="dpd2" styleClass="text" styleId="dpd2" style="text-align: right"
							...
							<tr>
								...
								<td>
									<html:text property="pos1" styleClass="text" styleId="pos1" style="text-align: right"
										maxlength="18" onkeyup="checkNumber(this.value, event, 3,id);"
										onblur="formatNumber(this.value,id);"
										onkeypress="return numbersonly(event,id,3)" />
								</td>
							...
							<tr>
								...
								<td>
									<html:text property="balanceprincipal" styleClass="text" style="text-align: right"
							...
							<td>PTP Due From (DD-MM-YYYY)</td>
								<td>
									<html:text styleClass="text" property="fromDueDate"
										styleId="fromDueDate" maxlength="10" value=""
										onchange="return checkDate('fromDueDate');" />
								</td>
								
								<td>PTP Due To (DD-MM-YYYY)</td>
								<td>
									<html:text styleClass="text" property="toDueDate"
										styleId="toDueDate" maxlength="10" value=""
										onchange="return checkDate('toDueDate');" />
								</td>
							</tr>
    ...
    <td >
							...
							<!--  	<tr>
								<td><button name="mybutton" value="pdfReport"  class="topformbutton2" onclick="checkValidation();">Show PDF </button></td>
								</tr>
								<tr>
								<td><button name="mybutton" value="excelReport"  class="topformbutton2" onclick="checkValidation();">Show Excel</button></td>
								</tr>
								<tr>
								<td><button name="mybutton" value="htmlReport"  class="topformbutton2" onclick="checkValidation();">Show HTML</button></td>
								</tr>-->
