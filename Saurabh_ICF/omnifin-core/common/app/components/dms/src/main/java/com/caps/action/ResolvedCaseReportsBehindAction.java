...
public class ResolvedCaseReportsBehindAction extends Action{
	private static final Logger logger = Logger.getLogger(ResolvedCaseReportsBehindAction.class.getName());
	
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)throws Exception {
				
				logger.info("In openResolveCaseJsp :::::::::::::::::::::::::::::::");
				...
				String businessDate="";
				if(userobj==null){
					logger.info("here execute method of ResolvedCaseReportsBehindAction action the session is out----------------");
			    ...
			    return mapping.findForward("ResolvedCaseSuccess");
