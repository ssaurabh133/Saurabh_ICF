...
public class MSSQLCollUoloadDataDAOImpl implements CollUoloadDataDAO {
	
	private static final Logger logger = Logger.getLogger(MSSQLCollUoloadDataDAOImpl.class.getName());
...
*/
      ...
      try 
      {
		...
		budInsSqlCust.append(dbo);
		budInsSqlCust.append("STR_TO_DATE(?,'"+dateFormatWithTime+"') + ' '+ substring((cast(CONVERT(time,getdate()) as nvarchar(30))),0,9))");
		/*Insert for asset:----*/
		...
		budInsSqlAsset.append(dbo); 
		budInsSqlAsset.append("STR_TO_DATE(?,'"+dateFormatWithTime+"') + ' '+ substring((cast(CONVERT(time,getdate()) as nvarchar(30))),0,9))");
	    ...
	    budInsSqlReference.append(dbo); 
	    budInsSqlReference.append("STR_TO_DATE(?,'"+dateFormatWithTime+"') + ' '+ substring((cast(CONVERT(time,getdate()) as nvarchar(30))),0,9))");
