...
<html:form styleId="contactRecordingSearch"  method="post"  action="/contactRecordingBehindAction" >
...
<html:errors/>
<fieldset>
<legend><bean:message key="lbl.contactRecordingSearch" /></legend>
...
<html:hidden property="lbxLoanno" styleId="lbxLoanno"  />
    ...
    <tr>
     ...
     <td width="13%"><bean:message key="lbl.branch" /></td>
     		<td width="20%">
     			<html:text property="branchId" styleClass="text" styleId="branchId" maxlength="10" readonly="true" tabindex="-1" value="${requestScope.defaultbranch}" />
   			<html:hidden  property="lbxBranchId" styleId="lbxBranchId"  value="${requestScope.defaultbranchId}"/>
    		...
    		<td ><bean:message key="lbl.dueDate" /><bean:message key="lbl.dateFormat(dd-mm-yyyy)"/></td>
       <td>
       <html:text property="dueDate" tabindex="8"  styleClass="text"  styleId="dueDate"    onchange="return checkDate('dueDate');"/>
 </td> 
     </tr>
...
<button type="button" class="topformbutton2"   id="search"  onclick="searchContactRecording('<bean:message key="lbl.selectAtleast" />');"
...
<fieldset>
<legend><bean:message key="lbl.contactRecordingSearchDtl" /></legend>

 <logic:present name="list">

  <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}"  cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/contactRecordingBehindAction.do" >
	...
	<display:column property="pos1" titleKey="lbl.overdueInstalment"  sortable="true"  />
	<display:column property="queue" titleKey="lbl.queue"  sortable="true"  />
	<display:column property="actionFlag" titleKey="lbl.actionFlag"  sortable="true"  />
...
<td><b><bean:message key="lbl.overdueInstalment" /></b></td>
