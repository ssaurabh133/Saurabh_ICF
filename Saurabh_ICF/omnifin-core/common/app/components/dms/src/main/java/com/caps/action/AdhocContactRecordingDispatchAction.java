...
public class AdhocContactRecordingDispatchAction extends DispatchAction{
	private static final Logger logger = Logger.getLogger(AdhocContactRecordingDispatchAction.class.getName());
	
	
	public ActionForward openAdhocContactRecordingTrail(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)	throws Exception {
		logger.info(" in openAdhocContactRecordingTrail():-----");
		HttpSession session = request.getSession();
		boolean flag=false;
		UserObject userobj=(UserObject)session.getAttribute("userobject");
		if(userobj==null){
			logger.info("here openAdhocContactRecordingTrail method of AdhocContactRecordingDispatchAction the session is out----------------");
		...
		return mapping.findForward("openAdhocContactRecording");
	}
	public ActionForward openFollowUpTrail(ActionMapping mapping, ActionForm form,
		...
		UserObject userobj=(UserObject)session.getAttribute("userobject");
		if(userobj==null){
			logger.info("here openFollowUpTrail method of AdhocContactRecordingDispatchAction the session is out----------------");
			return mapping.findForward("sessionOut");
		}
		...
		request.setAttribute("actionCodeList", collDAO.actionCodeList());
		 //Changes Start for relationShip by Rohit
		  CorporateDAO detail=(CorporateDAO)DaoImplInstanceFactory.getDaoImplInstance(CorporateDAO.IDENTITY);
			logger.info("Implementation class: "+detail.getClass());
			 ArrayList<Object> list=new ArrayList<Object>(); 
			  ...
			  //Changes end for relationShip by Rohit
	...
	public ActionForward saveFollowUpTrail(ActionMapping mapping, ActionForm form,
		...
		if(userobj!=null){
			...
			logger.info("here saveFollowUpTrail method of  AdhocContactRecordingDispatchAction the session is out----------------");
			return mapping.findForward("sessionOut");
		}
		String superReview=CommonFunction.checkNull(request.getParameter("superReview"));
		request.setAttribute("superReview",superReview);
