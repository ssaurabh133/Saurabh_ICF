...
public class ContactRecordingBehindAction extends Action{

	private static final Logger logger = Logger.getLogger(ContactRecordingBehindAction.class.getName());
	
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		
		logger.info("In ContactRecordingBehindAction.........");
		...
		if(userobj!=null)
		{
			...
			logger.info("here execute method of  ContactRecordingBehindAction action the session is out----------------");
			 ...
			 logger.info("current page link .......before... "+request.getParameter("d-49520-p"));
				...
				conteactRecVO.setCurrentPageLink(currentPageLink);
				 CollDAO collDAO=(CollDAO)DaoImplInstanceFactory.getDaoImplInstance(CollDAO.IDENTITY);
				  ...
				  conteactRecVO.setFlag("Y");
				detailListGrid= collDAO.contactRecordingSearchList(conteactRecVO);
		...
		//}
		ArrayList<Object> contactList=collDAO.getContactListApplicant();
