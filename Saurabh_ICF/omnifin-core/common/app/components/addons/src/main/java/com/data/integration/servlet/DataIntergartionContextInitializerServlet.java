package com.data.integration.servlet;
...
public class DataIntergartionContextInitializerServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public DataIntergartionContextInitializerServlet() {
		super();
	}
