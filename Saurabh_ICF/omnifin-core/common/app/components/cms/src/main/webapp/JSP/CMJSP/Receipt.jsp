...
<li><a href="receiptMaker.jsp" target="body" id="a"><span style="color: rgb(255, 255, 255);">Receipt Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/receiptAuthorProcessAction.do?method=receiptAuthorScreen"  target="body" id="b"><span style="color: rgb(255, 255, 255);">Receipt Author</span></a></li>
	</ul>
</div>
