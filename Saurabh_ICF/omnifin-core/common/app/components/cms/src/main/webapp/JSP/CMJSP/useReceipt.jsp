	...
	<div align="center" class="opacity" style="display:none" id="processingImage"></div>
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="1">
			<tr>
			   <td><bean:message key="lbl.receiptNo"/><span><font color="red">*</font></span></td>
				...
				<html:select property="status" styleClass="text" styleId="status">						
					...
					<html:option value="U">Used</html:option>
			...
			<tr> 
				...
				<button type="button" name="Search" id="save" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveForwaradUsed();clearUseReceipt();">
