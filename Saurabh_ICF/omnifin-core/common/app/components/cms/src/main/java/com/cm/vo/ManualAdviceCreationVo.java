...
public class ManualAdviceCreationVo implements Serializable {
	...
	private String origionalReversal;
	private String orgAdviceId;
	private String lbxorgAdviceId;
	
	public String getOrigionalReversal() {
		return origionalReversal;
	}
	public void setOrigionalReversal(String origionalReversal) {
		this.origionalReversal = origionalReversal;
	}
	public String getOrgAdviceId() {
		return orgAdviceId;
	}
	public void setOrgAdviceId(String orgAdviceId) {
		this.orgAdviceId = orgAdviceId;
	}
	public String getLbxorgAdviceId() {
		return lbxorgAdviceId;
	}
	public void setLbxorgAdviceId(String lbxorgAdviceId) {
		this.lbxorgAdviceId = lbxorgAdviceId;
	}
