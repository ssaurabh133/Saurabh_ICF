...
<! [endif] -->
	...
	<body oncontextmenu="return false" onload="enableAnchor();checkChanges('deferralAuthorForm');document.getElementById('deferralAuthorForm').decision.focus();init_fields();">
	
	<div id="centercolumn">
	
	<div id="revisedcontainer">
	
	<html:form action="/deferralAuthor" styleId="deferralAuthorForm" method="post">
	
 
  <fieldset>
  <legend><bean:message key="lbl.deferralAuthor"/></legend>
	...
	<tr>
		...
		<button type="button" accesskey="V" name="save" id="save" title="Alt+V" class="topformbutton2" onclick="return saveDeferralAuthor();"><bean:message key="button.save" /></button>
	      </td>
	</tr>
	</table>
...
<script>
	setFramevalues("deferralAuthorForm");
</script>
</body>
</html:html>
...
if('<%=request.getAttribute("message")%>'=='S')
{
	...
	parent.location="<%=request.getContextPath()%>/deferralSearchBehind.do?method=deferralAuthorSearch";
}
