...
<! [endif] -->
		 ...
		 <tr>	
		   <td width="13%"><bean:message key="lbl.loanNo"/><span><font color="red">*</font></span></td>
			 <td width="13%">
             	...
             	<html:button property="loanAccountButton" styleId="loanAccountButton" onclick="openLOVCommon(2032,'fileTrackingForm','loanNoSearch','','lbxLoanNoHIDSearch','','','','customerName')" value=" " styleClass="lovbutton"/>
 ...
 <table width="100%" border="0" cellspacing="1" cellpadding="0">
		<tr>
		<td colspan="3">
		<button type="button" name="Search" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return operationFileTrackingSearch();" ><bean:message key="button.search" /></button>
