...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	<body oncontextmenu="return false" onload="enableAnchor();checkChanges('partPrePaymentAuthorForm');document.getElementById('partPrePaymentAuthorForm').decision.focus();init_fields();">
	
	<div id="centercolumn">
	
	<div id="revisedcontainer">
	
	<html:form action="/partPrePaymentAuthor" styleId="partPrePaymentAuthorForm" method="post">
	
 
  <fieldset>
  <legend><bean:message key="lbl.partPrePaymentAuthor"/></legend>
	...
	<tr>
		...
		<button type="button" name="save" id="save"  class="topformbutton2" onclick="return savePartPrePaymentAuthor();"><bean:message key="button.save" /></button>
	      </td>
	</tr>
	</table>
...
<script>
	setFramevalues("partPrePaymentAuthorForm");
</script>
</body>
</html:html>
...
if('<%=request.getAttribute("message")%>'=='S')
{
	...
	parent.location="<%=request.getContextPath()%>/partPrePaymentSearchBehind.do?method=partPrePaymetAuthorSearch";
}
