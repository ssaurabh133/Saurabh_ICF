...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	<body onload="enableAnchor();init_fields();"><div><br /></div>
	...
	<html:form action="/holdinstrumentAuthor" method="post" >
	<fieldset>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    ...
    <td class="gridtd">
      ...
      <table id="table1" width="100%" border="0" cellspacing="1" cellpadding="4">
        <tr>
         ...
         <td width="167" class="white2" style="width:150px;"><b><strong>Installment Date </strong></b></td>
          <td width="220" class="white2" style="width:150px;"><strong>Instrument Type </strong></td>
          <td width="220" class="white2" style="width:150px;"><strong><b>Instrument No</b></strong></td>
          <td width="220" class="white2" style="width:150px;"><strong>EMI Amount </strong></td>
          <td width="220" class="white2" style="width:150px;"><strong>Hold Reason </strong></td>
            </tr>
        <tr>
 ...
 <fieldset>
  <legend><bean:message key="holdInstrumentAuthor"/></legend>
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td>
