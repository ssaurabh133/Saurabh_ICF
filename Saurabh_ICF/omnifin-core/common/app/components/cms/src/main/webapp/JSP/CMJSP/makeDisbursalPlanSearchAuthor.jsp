...
<! [endif] -->
	...
	<input type="hidden" name="contextPath" id="contextPath" value="<%=path %>" />
	   ...
	   <fieldset>	  
	<legend><bean:message key="lbl.makeDisbursalAuthorSearch"/></legend>         
	...
	<td>
	         ...
	         <html:text property="loanNo" styleId="loanNo" styleClass="text" readonly="true" tabindex="-1"/>
          	  <html:hidden  property="lbxLoanNoHID" styleId="lbxLoanNoHID" value="" />
          	   ...
          	   <html:button property="loanButton" styleId="loanButton" onclick="openLOVCommon(460,'CreditForm','loanNo','','lbxLoanNoHID', '','','','customerName');" value=" " styleClass="lovbutton"></html:button>
	...
	<bean:message key="lbl.product"/>  </td>
		...
		<tr>
	      ...
	      <td align="left" class="form2" colspan="1">
		            ...
		            <button type="button" name="search"  id="button" title="Alt+S" accesskey="S" class="topformbutton2" onclick="newSearchDisbursalAuthorLoan();"><bean:message key="button.search" /></button>
