	...
	<tr>
		...
		<tr>
		 ...
		 <html:select property="decision" styleId="decision">
		        ...
		        <html:option value="Y">Rejected</html:option>
		...
		<tr>
	      ...
	      <button type="button"  id="save" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return savedeleteInstrumentAuthor('<bean:message key="lbl.plsSelectComments"/>','<bean:message key="lbl.plsSelectDecision"/>');">
...
<logic:present name="savedSuccessfully">
	...
	parent.location="<%=request.getContextPath()%>/deleteInstrumentAuthorBehindAction.do";
