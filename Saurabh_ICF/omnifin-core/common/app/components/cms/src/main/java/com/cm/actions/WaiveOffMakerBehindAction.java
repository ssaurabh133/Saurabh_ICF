...
public class WaiveOffMakerBehindAction extends Action{
	private static final Logger logger = Logger.getLogger(WaiveOffMakerBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)throws Exception {
		
		logger.info("in WaiveOffMakerBehindAction ");
		...
		if(userobj!=null)
		{
			...
			logger.info("in  excute method  of WaiveOffMakerBehindActionaction the session is out----------------");
