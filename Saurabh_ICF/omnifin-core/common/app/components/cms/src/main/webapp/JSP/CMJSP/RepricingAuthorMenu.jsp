...
<!--<li onclick="callFunction('/rePricingAuthor.do?method=showRepricingDataAuthor','');"><a href="#" id="a" onclick="activeTab(id);"><span>Repricing Maker</span></a></li>-->
<!--<li onclick="callFunction('/rePricingAuthor.do?method=openRepricingAuthor','b');"><a href="#" id="b" onclick="activeTab(id);"><span>Repricing Author</span></a></li>-->
<!---->
...
<li><a href="<%=request.getContextPath()%>/rePricingAuthor.do?method=showRepricingDataAuthor" id="a"><span>Repricing Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/rePricingAuthor.do?method=openRepricingAuthor" id="b"><span>Repricing Author</span></a></li>
</ul>
</div>
