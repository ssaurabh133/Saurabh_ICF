...
public class SendTOStoreBehindAction extends  DispatchAction {
	private static final Logger logger = Logger.getLogger(ReceivedAtOPSBehindAction.class.getName());

	public ActionForward operationfileTrackingtostore(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception 
			{
		
		logger.info("In operationfileTrackingtostore");
		...
		ArrayList list = dao.searchfileTrackingtostore(fileTrackVO);
...
public ActionForward savefileTrackingtostore(ActionMapping mapping,ActionForm form, HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		boolean status = fileTrackDAO.insertfileTrackingtostore(vo,loanIds,receivedDates,remarks);
