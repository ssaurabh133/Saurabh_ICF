...
<! [endif] -->		
	...
	<body onunload="closeAllLovCallUnloadBody();" oncontextmenu="return false" onload="enableAnchor();document.getElementById('CreditForm').dealButton.focus();init_fields();"><div align="center"> 
	...
	<td width="35%">
	  ...
	  <%--  </a>--%>
		 ...
		 <html:button property="dealButton" styleId="dealButton" onclick="openLOVCommon(85,'CreditForm','dealNo','userId','dealNo', 'userId','','','hCommon');closeLovCallonLov1();clearLoan();" value=" " styleClass="lovbutton"></html:button>
	...
	<td>
	         ...
	         <html:text property="loanNo" styleId="loanNo" styleClass="text" readonly="true" tabindex="-1"/>
          	<html:hidden  property="lbxLoanNoHID" styleId="lbxLoanNoHID"  />
  			 ...
  			 <html:button property="loanButton" styleId="loanButton" onclick="closeLovCallonLov('dealNo');openLOVCommon(73,'CreditForm','loanNo','dealNo','lbxLoanNoHID', 'lbxDealNo','Select Deal LOV','','customerName');" value=" " styleClass="lovbutton"></html:button>
	...
	<bean:message key="lbl.product"/>  </td>
        ...
        <html:button property="productButton" styleId="productButton" onclick="openLOVCommon(86,'CreditForm','product','userId','scheme', 'lbxscheme|userId','','','hCommon');closeLovCallonLov1();" value=" " styleClass="lovbutton"></html:button>
		...
		<%--  <img onclick="openLOVCommon(86,'','product','','scheme', '','','','hCommon')" src="<%= request.getContextPath()%>/images/lov.gif" /> --%>
		 ...
		 <td  > 
	      <html:text property="scheme" styleId="scheme" styleClass="text" readonly="true" tabindex="-1"/>
    		 ...
    		 <html:button property="schemeButton" styleId="schemeButton" onclick="closeLovCallonLov('product');openLOVCommon(22,'CreditForm','scheme','product','lbxscheme', 'lbxProductID','Please Select Product','','hCommon');" value=" " styleClass="lovbutton"></html:button>
		...
		<%--  <img onclick="openLOVCommon(22,'CreditForm','scheme','product','lbxscheme', 'lbxProductID','Please Select Product','','hCommon')" src="<%= request.getContextPath()%>/images/lov.gif" /> --%>
			...
			<td>
            	...
            	<html:text property="userName" styleClass="text" styleId="userName" maxlength="100" readonly="true" value=""/>
     			...
     			<input type="hidden" name="userId" id="userId" value="${userobject.userId}" />
      			<html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="openLOVCommon(266,'CreditForm','userName','userId','', 'userId','','','reportingToUserId')" value=" " styleClass="lovbutton"  ></html:button>
			</td>
		</tr>
		...
		<tr>
	      ...
	      <td align="left" class="form2" colspan="4">
	       <button type="button" name="search"  title="Alt+S" accesskey="S" id="searchButton" class="topformbutton2" onclick="return newSearchLoan('P');"><bean:message key="button.search" /></button>
		   <button type="button" name="button2" class="topformbutton2" title="Alt+N" accesskey="N"  onclick="return newLoanInit();"><bean:message key="button.new" /></button>
