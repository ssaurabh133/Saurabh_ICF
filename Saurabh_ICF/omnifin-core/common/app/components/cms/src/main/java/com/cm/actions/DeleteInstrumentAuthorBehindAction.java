...
public class DeleteInstrumentAuthorBehindAction extends Action {
	private static final Logger logger = Logger.getLogger(DeleteInstrumentAuthorBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception{
				...
				logger.info(" In the DeleteInstrumentAuthorBehindAction----------");
