...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/commonScript/commonMethods.js"></script>
		<script type="text/javascript" src="<%=request.getContextPath() %>/js/cmScript/poolIDMakerAuthor.js"></script>
<!--[if IE]>
	<style type="text/css">
		.opacity{
			 position:fixed;
...
<! [endif] -->
	...
	<tr>
		...
		<tr>
		   ...
		   <td width="20%"><bean:message key="lbl.comments"></bean:message><font color="red">*</font></td>
			...
			<!--    <html:text property="lbxLoanNoHID" styleId="lbxLoanNoHID" value="${sessionScope.loanID}"/>-->
			   <html:hidden property="poolID" styleId="poolID" value="${sessionScope.poolID}"/>
		...
		<tr>
	        <td> 
	       <button type="button" id="save" class="topformbutton2" onclick="return onSaveOfPoolIdAuthor('<bean:message key="msg.CommReqField" />');" title="Alt+V" accesskey="V" ><bean:message key="button.save" /></button>
