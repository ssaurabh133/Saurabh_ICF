...
<body onload="enableAnchor();">
	<div align="center" class="opacity" style="display:none" id="processingImage"></div>
		...
		<fieldset> <legend><bean:message key="lbl.hoStatAcknowledgment"/></legend>
		<table width="100%" border="0" cellspacing="2" cellpadding="1">
			<tr>
				...
				<td>				  
					...
					<html:button property="branchButton" styleId="branchButton" tabindex="1" onclick="openLOVCommon(562,'StationaryMasterForm','bookIssue','','', '','','','lbxBookNo')" value=" " styleClass="lovbutton"  ></html:button>
			   </td>
			...
			<tr> 
				...
				<button type="button" name="Search" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return searchStationaryHoAckno();">
		...
		<fieldset><legend><bean:message key="lbl.hoacknowledgmentDetail"/></legend>
		<logic:present name="list">
	    	<logic:notEmpty name="list">
			<display:table  id="list"  name="list" style="width: 100%" class="dataTable" cellspacing="1"  pagesize="5" requestURI="/hoStationaryAcknowledgmentAtCM.do" >
