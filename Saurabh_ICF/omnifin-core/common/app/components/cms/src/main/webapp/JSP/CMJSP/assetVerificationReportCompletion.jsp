...
%> 
	...
	<link type="text/css" rel="stylesheet" href="<%=path%>/${css }/displaytable.css"/>
</logic:present>
			
<logic:notPresent name="css">
	<link type="text/css" rel="stylesheet" href="<%=path%>/css/theme1/displaytable.css"/>
</logic:notPresent>	   
...
<! [endif] -->
	...
	<legend><bean:message key="lbl.assetVerificationRepComplete"/></legend>   
	 ...
	 <tr>
	  <td>
		...
		<td  width="13%"><bean:message key="lbl.LoanNo"/></td>
			<td  width="13%">
			<html:text styleClass="text" property="loanAccNo" styleId="loanAccNo" maxlength="100" readonly="true" value="" tabindex="-1"/>  
			<html:button property="loanButton" styleId="loanButton" onclick="openLOVCommon(145,'sourcingForm','loanAccNo','','', '','','','customerName','hcommon')" value=" " styleClass="lovbutton"></html:button> 
         ...
         <tr>
         	<td><bean:message key="lbl.assetId"></bean:message> </td>
			<td> <html:text styleClass="text" property="assetID" styleId="assetID" tabindex="-1" value="" readonly="true"/>
			<html:button property="assetButton" styleId="assetButton" onclick="openLOVCommon(146,'sourcingForm','assetID','loanAccNo','lbxLoanNoHID', 'assetDesc','Please Select Loan No first','','assetDesc')" value=" " styleClass="lovbutton"></html:button>
      ...
      <td colspan="4">&nbsp;
      <button type="button" id="SearchButton" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return searchAssetVerRepComplete();"><bean:message key="button.search" /></button>       
     </td>
    </tr>
