...
<body onload="enableAnchor();">
	<div align="center" class="opacity" style="display:none" id="processingImage"></div>
		<html:form action="/stationaryIssuanceMasterAtCM" styleId="StationaryBranchchange" >
		...
		<fieldset> <legend><bean:message key="lbl.hoAllocation"/></legend>
		<table width="100%" border="0" cellspacing="2" cellpadding="1">
			<tr>
			   <td><bean:message key="lbl.BookNo"/><span><font color="red">*</font></span></td>
				...
				<td>
					...
					<html:button property="branchButton" styleId="branchButton" tabindex="1" onclick="openLOVCommon(2039,'StationaryMasterForm','bookIssue','','', '','','','lbxBookNo')" value=" " styleClass="lovbutton"  ></html:button>
			   </td>				
			...
			<tr> 
				...
				<button type="button" name="Search" id="search" class="topformbutton2" title="Alt+W" accesskey="W" onclick="return searchStationaryBranchChange('<bean:message key="lbl.selectAtleast" />');">
				<bean:message key="button.search" /></button>
				<%-- <input class="topformbutton2" type="button" onclick="return newHoAllocation();" title="Alt+N" accesskey="N" value="New">--%>
		...
		<fieldset><legend><bean:message key="lbl.hoAllocationDtl"/></legend>
		<logic:present name="list">
	    	<logic:notEmpty name="list">
			<display:table  id="list"  name="list" style="width: 100%" class="dataTable" cellspacing="1"  pagesize="5" requestURI="/stationaryBranchgChangeBehindAtCM.do" >
				...
				<display:column property="branchid" titleKey="lbl.hoIssubranch" sortable="true"/>
				<display:column property="issuedate"  titleKey="lbl.hoIssudate" sortable="true"  />
          ...
          <tr>
           <td class="gridtd">
			...
			<tr class="white2">
				...
				<td width="220" style="width: 250px;">
					<b><bean:message key="lbl.hoIssubranch" /> <br> </b>
				</td>
				
				<td width="220" style="width: 250px;">
					<b><bean:message key="lbl.hoIssudate" /> <br> </b>
				</td>
			...
			<%-- 	
			<tr class="white1">
				<td colspan="5"><button type="button" onclick="" class="topformbutton2" title="Alt+E" accesskey="E"><bean:message key="lbl.edit"/></button>&nbsp;&nbsp;&nbsp; 
