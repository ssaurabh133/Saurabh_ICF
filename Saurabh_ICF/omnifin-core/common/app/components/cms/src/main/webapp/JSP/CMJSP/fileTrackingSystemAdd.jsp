...
height:150px;
	...
	<legend><bean:message key="lbl.fileTrackingSystem"/></legend>   
	 ...
	 <tr>
	  <td>
		...
		<tr>
			...
			<td>
			<html:select property="fileTrackStatus"  styleId="fileTrackStatus" styleClass="text" value="${list[0].fileTrackStatus}" onchange="return checkFileStatus();">
	 ...
	 <tr>
	  <td>
		...
		<tr>
			<td><bean:message key="lbl.fileTrackStatus"/></td>
			<td>
			<html:select property="fileTrackStatus" disabled="true"  styleId="fileTrackStatus" styleClass="text" value="${list[0].fileTrackStatus}" onchange="return checkFileStatus();">
			<html:option value="P">Pending</html:option>
			<html:option value="R">Received</html:option>
			<html:option value="H">Hold</html:option>
			<html:option value="C">Clear</html:option>
	  ...
	  <td>
		...
		<tr>	   
		    ...
		    <td>
             	...
             	<html:button property="loanAccountButton" styleId="loanAccountButton" onclick="openLOVCommon(1375,'fileTrackingForm','loanNo','','lbxLoanNoHID','','','getDealNumber','customerName')" value=" " styleClass="lovbutton"/>
		...
		<tr>
			<td><bean:message key="lbl.fileTrackStatus"/></td>
			<td>
			<html:select property="fileTrackStatus"  styleId="fileTrackStatus" styleClass="text" onchange="return checkFileStatus();">
			<html:option value="P">Pending</html:option>
			<html:option value="R">Received</html:option>
			<html:option value="H">Hold</html:option>
			<html:option value="C">Clear</html:option>
...
<logic:present name="sms">
	...
	document.getElementById('fileTrackingForm').action="<%=request.getContextPath()%>/fileTrackingDispatchAction.do?method=assetsavegrid";
