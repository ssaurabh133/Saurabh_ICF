...
<body
	onload="enableAnchor();document.getElementById('rePricingSearchForm').loanLov.focus();init_fields();"
	oncontextmenu="return false" onclick="parent_disable();"
	onunload="closeAllLovCallUnloadBody();">

	<logic:present name="rePricingMakerSearch">
		<div id="revisedcontainer">

			<html:form action="/rePricingSearch" method="post"
				styleId="rePricingSearchForm">

				<fieldset>
					<legend>
						<bean:message key="lbl.rePricingMakerSearch" />
					</legend>
								...
								<table width="100%" border="0" cellspacing="1" cellpadding="1">
									...
									<tr>
										...
										<td width="35%">
											...
											<html:button property="loanLov"
												onclick="openLOVCommon(232,'rePricingSearchForm','loanNo','userId','loanNo', 'userId','','','customerName');closeLovCallonLov1();"
									...
									<tr>
									 ...
									 <td>
									    ...
									    <html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="openLOVCommon(266,'rePricingSearchForm','userName','userId','', 'userId','','','reportingToUserId')" value=" " styleClass="lovbutton"  ></html:button>
									 </td>
									...
									<tr>
										<td>
											<button type="button" class="topformbutton2" name="search"
												...
												onclick="searchRePricing('P');" ><bean:message key="button.search" /></button>
											<button type="button" class="topformbutton2" name="new"
												id="new" accesskey="N" title="Alt+N"
												onclick="openNewRePricing();" ><bean:message key="button.new" /></button>
										</td>
										<td>
											&nbsp;
										</td>
		...
		<fieldset>
			<legend>
				<bean:message key="lbl.rePricingMakerRecords" />
			</legend>

			<logic:present name="rePricingSearchList">
	...
	<logic:present name="rePricingAuthorSearch">
		...
		<div id="revisedcontainer">
			...
			<html:form action="/rePricingSearch" method="post"
				...
				<fieldset>
					<legend>
						<bean:message key="lbl.rePricingAuthorSearch" />
					</legend>
								...
								<table width="100%" border="0" cellspacing="1" cellpadding="1">
									<tr>
										...
										<td width="35%">
											...
											<html:button property="loanLov"
												onclick="openLOVCommon(233,'rePricingSearchForm','loanNo','userId','loanNo', 'userId','','','customerName');closeLovCallonLov1();"
												value=" " styleClass="lovButton" />
											<input type="hidden" name="contextPath"
												value="<%=request.getContextPath()%>" id="contextPath" />
											<html:hidden property="lbxLoanNoHID" styleId="lbxLoanNoHID"
									...
									<tr>
										 ...
										 <td>
										    ...
										    <html:hidden property="lbxUserId" styleId="lbxUserId" value=""/>
										    <input type="hidden" name="userId" id="userId" value="${userobject.userId}" />
										    <html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="openLOVCommon(282,'rePricingSearchForm','userName','userId','', 'userId','','','reportingToUserId')" value=" " styleClass="lovbutton"  ></html:button>
										 </td>
									...
									<tr>
										<td>
											<button type="button" class="topformbutton2" name="search"
												...
												onclick="searchRePricing('F');" ><bean:message key="button.search" /></button>
										</td>
										<td>
											&nbsp;
										</td>
		...
		<fieldset>
			<legend>
				<bean:message key="lbl.rePricingAuthorRecords" />
			</legend>
			<logic:present name="rePricingSearchList">
				<logic:notEmpty name="list">
					<display:table id="list" name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/rePricingSearch.do">
