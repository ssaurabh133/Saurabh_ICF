  ...
  <tr>
       ...
       <html:radio property="applicantCategory" styleId="applicantCategory1" value="C" disabled="true" tabindex='5'>Corporate</html:radio>
          ...
          <td colspan="4">
              ...
              <button type="button" name="createCust" class="topformbutton3" title="Alt+C" accesskey="C" id="createCust" onclick="createCustomerAtCM();callOnInCreateCustomer('applicantType','applicantCategory1','applicantCategory2');"><bean:message key="button.createcust" /></button>
...
<!--         <td class="gridheader"><b><bean:message key="lbl.customerStatus"/></b></td>-->
					...
					<tr class="white1">
							...
							<td   >
							<a href="#" id="anchor0" onclick="updateCustomerAtCM('${subroleList.customerId }', '${subroleList.applicantCategory }','${subroleList.applicantType }','${subroleList.existingCustomer }');">
							...
							<logic:equal name="subroleList" property="applicantType" value="GUARANTOR">
							
								<a href="#" id="anchor0" onclick="linkGuaranteeAmountAtCM('${subroleList.roleId }','${subroleList.guaranteeAmount }');">
							...
							<td ><logic:equal name="subroleList" property="applicantCategory"
																	value="INDIVIDUAL">
						<a href="#" id="anchor0" onclick="return linkPhotoUpload('${subroleList.customerId }','');">Photo Upload</a>
 ...
 <button type="button" name="delete" class="topformbutton2" id="delete" title="Alt+D" accesskey="D" value="Delet" onclick="deleteCustomerLoan('N');"><bean:message key="button.delete" /></button>
