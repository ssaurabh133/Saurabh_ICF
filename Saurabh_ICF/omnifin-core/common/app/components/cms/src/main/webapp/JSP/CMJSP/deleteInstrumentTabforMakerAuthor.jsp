...
<!--<li onclick="callFunction('/JSP/CMJSP/deleteInstrumentMakerMain.jsp','');"><a href="#" target="body" id="a" onclick="activeTab(id);"><span style="color: rgb(255, 255, 255);">Delete Instrument Maker</span></a></li>-->
<!--<li onclick="callFunction('/JSP/CMJSP/deleteInstrumentCapturingAuthor.jsp','b');"><a href="#" target="body" id="b" onclick="activeTab(id);"><span style="color: rgb(255, 255, 255);">Delete Instrument Author</span></a></li>-->
<!---->
...
<li><a href="deleteInstrumentMakerMain.jsp" target="body" id="a"><span style="color: rgb(255, 255, 255);">Delete Instrument Maker</span></a></li>
<li><a href="deleteInstrumentCapturingAuthor.jsp" target="body" id="b"><span style="color: rgb(255, 255, 255);">Delete Instrument Author</span></a></li>
</ul>
</div>
