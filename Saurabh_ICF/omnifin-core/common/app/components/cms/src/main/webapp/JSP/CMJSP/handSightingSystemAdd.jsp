...
<!DOCTYPE html PUBLIC "-//W3C//Dtd XHTML 1.0 transitional//EN" "http://www.w3.org/tr/xhtml1/Dtd/xhtml1-transitional.dtd">
	...
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/js/cmScript/handSighting.js"></script>
...
height:150px;
	...
	<legend><bean:message key="lbl.handSightingSystem"/></legend>   
	 ...
	 <tr>
	  <td>
		...
		<tr>
			<td><bean:message key="lbl.handSightingStatus"/></td>
			<td>
