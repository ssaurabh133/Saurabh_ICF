         ...
         {    
             var file=document.getElementById('docFile').value;
                if(splitVal[cnt].toLowerCase()!=file.toLowerCase())
                  ...
                  document.getElementById("nhbUpload").action=sourcepath+"/nhbUploadStart.do?method=uploadData";
...
<! [endif] -->
	...
	<html:form styleId="nhbUpload" action="/nhbUploadStart" method="post" enctype="multipart/form-data">    
	
	<fieldset>	  
	<legend><bean:message key="lbl.nhbUpload"/></legend>  
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="1" cellpadding="4">
		...
		<tr>		
		<td colspan="4">
		<button type="button" name="startProcessing" class="topformbutton3" id="startProcessing" title="Alt+P" accesskey="P" onclick="startProcessNHB();"><bean:message key="button.startProcng" /></button>&nbsp;&nbsp;&nbsp;
		<button type="button" name="errorLog" class="topformbutton2" id="errorLog" title="Alt+E" accesskey="E" onclick="errorLogDownloadForNHB();"><bean:message key="button.errorlog" /></button>&nbsp;&nbsp;&nbsp;
	    </td>
		</tr>
