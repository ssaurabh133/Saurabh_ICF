...
Purpose :-  screen for Bulk File Tracking OPS
-->
...
<!DOCTYPE html PUBLIC "-//W3C//Dtd XHTML 1.0 transitional//EN" "http://www.w3.org/tr/xhtml1/Dtd/xhtml1-transitional.dtd">
	...
	<legend><bean:message key="lbl.opsBranchFileTracking"/></legend>   
    ...
    <td>
  	<html:text styleClass="text" property="loanNoSearch" styleId="loanNoSearch" maxlength="20"  value="" readonly="true" tabindex="-1"/>
        	<html:button property="loanAccountButton" styleId="loanAccountButton" onclick="openLOVCommon(2031,'fileTrackingForm','loanNoSearch','','lbxLoanNoHID','','','','customerName')" value=" " styleClass="lovbutton"/>
	...
	<tr>
	<td colspan="3">
	<button type="button" name="Search" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return branchBulkFileTrackingSearch();" ><bean:message key="button.search" /></button>
	</td>
	</tr> 		  
	</table>
	</td>
	...
	<textarea name="remarks" id="remarks<%=counter.intValue()+1%>"  class="text"></textarea>
		...
		<button type="button"  title="Alt+A" accesskey="A" onclick="return bulkfileTrackSave();" class="topformbutton2"><bean:message key="button.save" /></button>
			</td>
			</tr>
...
<logic:present name="sms">
	...
	if('<%=request.getAttribute("sms")%>'=='S'){
		...
		location.href="<%=request.getContextPath()%>/fileTrackingBehindAction.do?method=branchBulkFileTracking";
