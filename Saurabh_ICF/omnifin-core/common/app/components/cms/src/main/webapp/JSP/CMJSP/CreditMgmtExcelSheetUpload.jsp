    ...
    if(exc==true ){
	 ...
	 if(docFile != '') {
	  	if((ext1.toUpperCase()=='XLS')&& abc1=="excel"){
		    document.getElementById("excelSheetUploadDynaForm").action = basePath+'/creditMgmtExcelSheetUpload.do?actionName=saveExcel';
		 	document.getElementById("processingImage").style.display = '';
		 	document.getElementById("excelSheetUploadDynaForm").submit();   
	    	return true;
		}else if((ext.toUpperCase()=="CSV" ||ext.toUpperCase()=="CSVX") && abc1=="csv" ){
			  document.getElementById("excelSheetUploadDynaForm").action = basePath+'/creditMgmtExcelSheetUpload.do?actionName=saveCsv';
			document.getElementById("processingImage").style.display = '';
			document.getElementById("excelSheetUploadDynaForm").submit();
			return true;
		 }else{
...
{
  	var sourcepath=document.getElementById("context").value;
  	document.getElementById("excelSheetUploadDynaForm").action = sourcepath+'/creditMgmtExcelSheetUpload.do?actionName=xlsFileDownload';
//	document.getElementById("processingImage").style.display = '';
	document.getElementById("excelSheetUploadDynaForm").submit();
	return true;
...
<div>
<div>
<html:form action="creditMgmtExcelSheetUpload" method="post" styleId="excelSheetUploadDynaForm" enctype="multipart/form-data">
...
<table width="100%"  border="0" cellspacing="7" cellpadding="0" >
    ...
    <tr> 
   <%--  <td>
	<button type="button" name="xlsfileDownload" class="topformbutton4" id="xlsfileDownload" onclick="exlsFileDownloadForLosUpload();" tabindex="4"><bean:message key="button.xlsDownload" /></button>
	</td> --%>
 ...
 <logic:present name="errorMsg">
       <script type="text/javascript">	
			alert("<%=request.getAttribute("errorMsg")%>");
			 var basePath=document.getElementById("context").value;	
		     document.getElementById("excelSheetUploadDynaForm").action = basePath+'/creditMgmtExcelSheetUpload.do?actionName=openExcel';
		     document.getElementById("excelSheetUploadDynaForm").submit(); 
       </script>
 </logic:present>
