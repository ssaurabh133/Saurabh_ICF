...
<! [endif] -->
	...
	<body oncontextmenu="return false" onload="enableAnchor();checkChanges('addDisbursalAuthorForm');document.getElementById('partPrePaymentAuthorForm').decision.focus();init_fields();">
	
	<div id="centercolumn">
	
	<div id="revisedcontainer">
	
	<html:form action="/addDisbAuthorAction" styleId="addDisbursalAuthorForm" method="post">
	
 
  <fieldset>
  <legend><bean:message key="lbl.addDisbursalAuthor"/></legend>
	...
	<tr>
		...
		<tr>
		 ...
		 <button type="button" name="save" id="save" title="Alt+V" accesskey="V" onclick="return saveAdditionalDisbAuthor();" class="topformbutton2" ><bean:message key="button.save" /></button>
	      </td>
	</tr>
	</table>
...
<script>
	setFramevalues("addDisbursalAuthorForm");
</script>
</body>
</html:html>
...
if('<%=request.getAttribute("message")%>'=='S')
{
	...
	parent.location="<%=request.getContextPath()%>/additionalDisbursalAuthor.do?method=searchAdditionalDisbursalAuthor";
}
