 ...
 */
public class AddDisbInstallmentPlanActionProcessAction extends DispatchAction {
	/*
	 * Generated Methods
	 */
	private static final Logger logger = Logger.getLogger(AddDisbInstallmentPlanActionProcessAction.class.getName());
	/** 
	 * Method execute
	 * @param mapping
	 * @param form
	...
	public ActionForward saveNewInstallmentPlan(ActionMapping mapping, ActionForm form,
		...
		if(userobj==null){
			logger.info("here in saveNewInstallmentPlan method of AddDisbInstallmentPlanActionProcessAction action the session is out----------------");
...
//			CreditManagementDAO dao = new CreditManagementDAOImpl();
		...
		return mapping.findForward("saveInstallment");
	}
