...
<! [endif] -->
	...
	<td width="35%">
		 ...
		 <html:button property="dealnoButton" styleId="dealnoButton" onclick="closeLovCallonLov1();openLOVCommon(102,'CreditForm','dealNo','userId','dealNo', 'userId','','','hCommon');" value=" " styleClass="lovbutton"></html:button>
	...
	<td>
	         ...
	         <html:text property="loanNo" styleId="loanNo" styleClass="text" readonly="true" tabindex="-1"/>
          	 <html:hidden  property="lbxLoanNoHID" styleId="lbxLoanNoHID" value="" />
          	   ...
          	   <html:button property="loanButton" styleId="loanButton" onclick="closeLovCallonLov1();openLOVCommon(77,'CreditForm','loanNo','','lbxLoanNoHID', '','','','customerName');" value=" " styleClass="lovbutton"></html:button>
	...
	<bean:message key="lbl.product"/>  </td>
		...
		<tr>
	      ...
	      <td align="left" class="form2" colspan="1">
		            ...
		            <button type="button" name="search"  id="button" title="Alt+S" accesskey="S" class="topformbutton2" onclick="return newSearchLoan('F');"><bean:message key="button.search" /></button>
