...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath() %>/js/cmScript/disbursalPlanMakerAuthor.js"></script>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <logic:present name="disbList">
	       ...
	       <logic:notEmpty name="disbList">
	         <logic:iterate name="disbList" id="subDisbList" indexId="counter">
				...
				<html:hidden property="disbStatus" styleId="disbStatus${counter+1 }" styleClass="text" value="${subDisbList.disbStatus}" />
				<logic:equal name="subDisbList" property="disbStatus" value="Y">
				
					<tr >
	           		
	     			<td class="white1"><input type="checkbox"  name="chk" id="chk${counter+1 }" value="" disabled="disabled"/></td>
	          		 ...
	          		 <td class="white1"><b><html:text property="dateOfDisbursal" styleId="dateOfDisbursalReadOnly${counter+1 }" readonly="true" styleClass="text" value="${subDisbList.dateOfDisb}" onchange="checkDate('dateOfDisbursal${counter+1 }');"/></b></td>
				 ...
				 <logic:notEqual name="subDisbList" property="disbStatus" value="Y">
				 ...
				 <tr >
	     			...
	     			<td class="white1"><input type="checkbox"  name="chk" id="chk${counter+1 }" value=""/></td>
	         		 ...
	         		 <td class="white1"><b><html:text property="descOfDisbursal" styleId="descOfDisbursal${counter+1 }" styleClass="text" value="${subDisbList.descOfDisb}" /></b></td>
 ...
 <button type="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="saveDisbPlanInCM();" ><bean:message key="button.save" /></button>&nbsp;&nbsp;&nbsp;
 <button type="button" class="topformbutton2" title="Alt+F" accesskey="F" onclick="forwardDisbPlanInCM();" ><bean:message key="button.forward" /></button>&nbsp;&nbsp;&nbsp;	
 <button type="button" tabindex="-1" class="topformbutton2" onclick="addROWAtDisbPlanCM('<bean:message key="msg.LoanAccountNo" />');makeChoice();" title="Alt+A" accesskey="A"><bean:message key="button.addrow" /></button>&nbsp;&nbsp;&nbsp;
 <button type="button"  id="deleteRow" tabindex="-1" class="topformbutton2" onclick="removeRowDisbPlan();" title="Alt+D" accesskey="D"><bean:message key="button.deleterow" /></button>				
...
<logic:present name="sms">
		...
		else if('<%=request.getAttribute("sms").toString()%>'=='F')
		{
			...
			location.href='<%=request.getContextPath()%>/disbursalPlanSearchMaker.do?method=disbursalPlanSearchMaker';
