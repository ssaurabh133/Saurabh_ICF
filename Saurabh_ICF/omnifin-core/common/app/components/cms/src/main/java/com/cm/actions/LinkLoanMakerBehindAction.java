...
public class LinkLoanMakerBehindAction  extends Action {
	private static final Logger logger=Logger.getLogger(LinkLoanMakerBehindAction.class.getName());
	
	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request
					,HttpServletResponse response)throws Exception{
		logger.info("in execute method of LinkLoanMakerBehindAction ");
		...
		ArrayList<LinkLoanVo> searchList= dao.getLoanDetails(linkLoanVo);		
