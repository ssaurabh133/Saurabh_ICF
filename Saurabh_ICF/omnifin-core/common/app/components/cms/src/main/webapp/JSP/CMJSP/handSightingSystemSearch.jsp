		 ...
		 <tr>	
		   <td width="13%"><bean:message key="lbl.loanNo"/><span><font color="red">*</font></span></td>
			 <td width="13%">
             	...
             	<html:button property="loanAccountButton" styleId="loanAccountButton" onclick="openLOVCommon(510,'fileTrackingForm','loanNoSearch','','lbxLoanNoHIDSearch','','','','customerName')" value=" " styleClass="lovbutton"/>
