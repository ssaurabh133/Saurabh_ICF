...
<div  align="center" class="opacity" style="display: none;"  id="processingImage">		
	...
	<html:form action="/knockOffCancellationDispatchAction" styleId="knockOffCancellationAuthor" >
		<fieldset>
			<legend><bean:message key="lbl.KnockOffCancellationAuthor"/></legend>  
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="1">
					<tr>
						...
						<td><html:text property="loanNumber" styleClass="text" value="" styleId="loanNumber" readonly="true"/>
							...
							<html:button property="loanFromButton" styleId="loanFromButton" tabindex="1" onclick="openLOVCommon(343,'knockOffCancellationAuthor','loanNumber','userId','', 'userId','','','customerName','knockOffID')" value=" " styleClass="lovbutton"  />
						</td>
					...
					<tr>
						<td><button type="button" name=" mybutton" accesskey="S" title="Alt+S" class="topformbutton2" onclick="return searchKOCAuthorData()" ><bean:message key="button.search" /></button></td>
					</tr>	
					</table>
		</fieldset>
		<fieldset>
			<legend><bean:message key="lbl.knockOffCancellationAuthorRecord" /></legend>
			<logic:present name="defaultKOCList">
			<logic:notEmpty name="defaultKOCList">
				<display:table  id="defaultKOCList"  name="defaultKOCList" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1"  partialList="true" size="${defaultKOCList[0].totalRecordSize}" requestURI="/knockOffCancellationAuthorBehindAction.do" >
			...
			<logic:notEmpty name="KOCList">
				<display:table  id="KOCList"  name="KOCList" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1"  partialList="true" size="${KOCList[0].totalRecordSize}" requestURI="/knockOffCancellationDispatchAction.do?method=searchKOCAuthorData" >
    				<display:setProperty name="paging.banner.placement"  value="bottom"/>
    				<display:setProperty name="locale.resolver" value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
    				<display:setProperty name="locale.provider" value="org.displaytag.localization.I18nStrutsAdapter"></display:setProperty>
				    <display:column property="knockOffId" titleKey="lbl.knockOffId"  sortable="true"  />
