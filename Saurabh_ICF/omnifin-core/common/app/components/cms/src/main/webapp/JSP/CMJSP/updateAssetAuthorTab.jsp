...
<li><a href="<%=request.getContextPath()%>/JSP/CMJSP/updateAuthorView.jsp" target="body" id="a"><span style="color: rgb(255, 255, 255);">Update Asset Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/updateAssetAuthorFrame.do?method=openAuthorAssetApprovalScreen" target="body" id="b"><span style="color: rgb(255, 255, 255);">Update Asset Author</span></a></li>
</ul>
</div>
