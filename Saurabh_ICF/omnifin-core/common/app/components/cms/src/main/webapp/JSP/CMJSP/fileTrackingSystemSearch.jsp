...
<! [endif] -->
	...
	<legend><bean:message key="lbl.fileTrackingSearch"/></legend>   
 ...
 <table width="100%" border="0" cellspacing="1" cellpadding="0">
		<tr>
		<td colspan="3">
		<button type="button" name="Search" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return fileTrackingSearch('SearchAndNew');" ><bean:message key="button.search" /></button>
