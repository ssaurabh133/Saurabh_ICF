...
<!--<li onclick="callFunction('/JSP/CMJSP/instrumentUpdateMaker.jsp','');"><a href="#" target="body" id="a" onclick="activeTab(id);"><span style="color: rgb(255, 255, 255);">Instrument Update Maker</span></a></li>-->
<!--<li onclick="callFunction('/JSP/CMJSP/instrumentUpdateAuthor.jsp','');"><a href="#" target="body" id="b" onclick="activeTab(id);"><span style="color: rgb(255, 255, 255);">Instrument Update Author</span></a></li>-->
<!---->
...
<li><a href="instrumentUpdateMaker.jsp" target="body" id="a"><span style="color: rgb(255, 255, 255);">Instrument Update Maker</span></a></li>
<li><a href="instrumentUpdateAuthor.jsp" target="body" id="b"><span style="color: rgb(255, 255, 255);">Instrument Update Author</span></a></li>
</ul>
</div>
