...
<!DOCTYPE html PUBLIC "-//W3C//Dtd XHTML 1.0 transitional//EN" "http://www.w3.org/tr/xhtml1/Dtd/xhtml1-transitional.dtd">
	...
	<head>
		...
		<legend><bean:message key="lbl.sendTostore"/></legend>   
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
	 	...
	 	<td width="13%"><bean:message key="lbl.loanNo"/><span><font color="red">*</font></span></td>
			 <td>
             	...
             	<html:button property="loanAccountButton" styleId="loanAccountButton" onclick="openLOVCommon(2048,'fileTrackingForm','loanNoSearch','','lbxLoanNoHIDSearch','','','','customerName')" value=" " styleClass="lovbutton"/>
	...
	<tr>
		...
		<tr>
		<td colspan="3">
		<button type="button" name="Search" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return sendTOStoreSearch();" ><bean:message key="button.search" /></button>
		</td>
		</tr> 		  
		</table>
		</td>
	...
	<fieldset>
		...
		<button type="button"  title="Alt+A" accesskey="A" onclick="return sendTOStoreSave();" class="topformbutton2"><bean:message key="button.save" /></button>
			</td>
			</tr>
		...
		location.href="<%=request.getContextPath()%>/SendTOStoreBehindAction.do?method=operationfileTrackingtostore";
	}
