...
<li><a href="<%=request.getContextPath()%>/authorBehind.do?method=openCancellationAuthor" id="a" onclick="activeTab(id);" ><span>Cancellation Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/authorBehind.do?method=openClosureAuthor" id="b" onclick="activeTab(id);"><span>Cancellation Author</span></a></li>
