...
public class PartPrePaymentViewReceivableAction extends DispatchAction{
	private static final Logger logger = Logger.getLogger(PartPrePaymentViewReceivableAction.class.getName());
	
	public ActionForward ViewReceivablePartPrePayment(ActionMapping mapping,ActionForm form,
			HttpServletRequest request,HttpServletResponse response)
	throws Exception {
			
		logger.info("In  PartPrePaymentViewReceivableAction ViewReceivablePartPrePayment()----------------------------");
		
		HttpSession session = request.getSession();
		boolean flag=false;
		UserObject userobj=(UserObject)session.getAttribute("userobject");
		if(userobj==null){
			logger.info("here in ViewReceivablePartPrePayment method of PartPrePaymentViewReceivableAction action the session is out----------------");
		...
		logger.info("In ViewReceivablePartPrePayment---loanId-"+loanId);  
		...
		return mapping.findForward("ViewReceivablePartPrePayment");
