...
<!--           <html:option value="">--Select--</html:option>-->
         ...
         <input type="hidden" name="flagExp" id="flagExp${i}" value="${subdocuments.expirFlag }" />
             ...
             <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','ASSET');"%>Upload/Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','ASSET');">Upload/Download</a></td>
               </logic:notEqual>
...
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocumentPOD('AS','Y');"><bean:message key="button.save" /></button> 
</logic:present>   
<logic:notPresent name="dataFound">
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocumentPOD('AS','N');"><bean:message key="button.save" /></button> 
</logic:notPresent>
 <!--change by sachin-->
  ...
  <tr>
    <td class="gridtd">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="4">
       <tr class="white2">
          <td   ><strong><bean:message key="lbl.assetDocs" /></strong></td>
          <td ><strong><bean:message key="lbl.documentName" /></strong></td>
          <td><b><bean:message key="lbl.originalOrPhotocopy" /></b></td>
          <td><b><bean:message key="lbl.mandatoryOrNonMandatory" /></b></td>
    <td ><b><bean:message key="lbl.DOC-TYPE" /></b></td>          <td ><b><bean:message key="lbl.status" /></b></td>
...
<!--           <html:option value="">--Select--</html:option>-->
            ...
            <html:option value="N">NA</html:option><!-- Virender -->
             ...
             <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','ASSET');"%>Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','ASSET');">Download</a></td>
               </logic:notEqual>
...
<!-- <html:button property="button" value="Save" styleClass="topformbutton2" onclick="return saveDocument('AS');"/>-->
