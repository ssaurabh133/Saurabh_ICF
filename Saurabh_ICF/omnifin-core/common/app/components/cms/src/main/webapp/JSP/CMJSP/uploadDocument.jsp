         ...
         {    
             var file=document.getElementById('docFile').value;
                if(splitVal[cnt].toLowerCase()!=file.toLowerCase())
                  ...
                  document.getElementById("DocUpload").action=sourcepath+"/uploadAction.do?method=uploadData";
...
<! [endif] -->
	...
	<html:form styleId="DocUpload" action="/underwritingDocUpload" method="post" enctype="multipart/form-data">    
	
	<fieldset>	  
	<legend><bean:message key="lbl.docUpload"/></legend>  
	...
	<input type="hidden" name="txnfile" id="txnfile" value="<%=processFile%>"/>
     <tr>
      <td><table width="100%" border="0" cellspacing="1" cellpadding="4">
		...
		<tr>		
		<td colspan="4">
		<button type="button" name="startProcessing" class="topformbutton3" id="startProcessing" title="Alt+P" accesskey="P" onclick="startProcess();"><bean:message key="button.startProcng" /></button>&nbsp;&nbsp;&nbsp;
		<button type="button" name="errorLog" class="topformbutton2" id="errorLog" title="Alt+E" accesskey="E" onclick="errorLogDownload();"><bean:message key="button.errorlog" /></button>&nbsp;&nbsp;&nbsp;
