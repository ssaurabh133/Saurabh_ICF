...
<! [endif] -->
	...
	<html:form action="/repaymentServiceAction" method="post" styleId="RepaymentServiceForm">
	...
	<td>
	         ...
	         <html:text property="loanNo" styleId="loanNo" styleClass="text" readonly="true" tabindex="-1"/>
          	 <html:hidden  property="lbxLoanNoHID" styleId="lbxLoanNoHID" value="" />
          	   ...
          	   <html:button property="loanButton" styleId="loanButton" onclick="closeLovCallonLov1();openLOVCommon(722,'RepaymentServiceForm','loanNo','','lbxLoanNoHID', '','','','customerName');" value=" " styleClass="lovbutton"></html:button>
	...
	<bean:message key="lbl.product"/>  </td>
		<td > 
         ...
         <html:hidden  property="lbxProductID" styleId="lbxProductID" />
          ...
          <html:button property="productButton" styleId="productButton" onclick="closeLovCallonLov1();openLOVCommon(724,'RepaymentServiceForm','product','userId','scheme', 'lbxscheme|userId','','','hCommon');" value=" " styleClass="lovbutton"></html:button>
		 ...
		 <td  > 
	      <html:text property="scheme" styleId="scheme" styleClass="text" readonly="true" tabindex="-1"/>
          		<html:hidden  property="lbxscheme" styleId="lbxscheme"  />
          		    ...
          		    <html:button property="schemeButton" styleId="dealButton" onclick="closeLovCallonLov('product');openLOVCommon(22,'RepaymentServiceForm','scheme','product','lbxscheme', 'lbxProductID','Please Select Product','','hCommon');" value=" " styleClass="lovbutton"></html:button>
...
<%--       		<html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="openLOVCommon(723,'RepaymentServiceForm','userName','','', '','','','reportingToUserId')" value=" " styleClass="lovbutton"  ></html:button> --%>
<!-- 			</td> -->
<!-- 			</tr> -->
			<tr>
		    	...
		    	<td>
		            <html:text property="selectiveBranch" styleClass="text" styleId="selectiveBranch" maxlength="100" readonly="true" value=""/>
		     		<html:hidden property="lbxBranchId" styleClass="text" styleId="lbxBranchId" value=""/>
		      		<html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="openLOVCommon(505,'RepaymentServiceForm','lbxBranchId','','', '','','','selectiveBranch')" value=" " styleClass="lovbutton"  ></html:button>
				</td>
			</tr>
	...
	<td>
	         ...
	         <html:text property="loanNo" styleId="loanNo" styleClass="text" readonly="true" tabindex="-1"/>
          	 <html:hidden  property="lbxLoanNoHID" styleId="lbxLoanNoHID" value="" />
          	   ...
          	   <html:button property="loanButton" styleId="loanButton" onclick="closeLovCallonLov1();openLOVCommon(725,'RepaymentServiceForm','loanNo','','lbxLoanNoHID', '','','','customerName');" value=" " styleClass="lovbutton"></html:button>
...
<!-- 			</tr> -->
		...
		<tr>
	      ...
	      <td align="left" class="form2" colspan="1">
		            ...
		            <button type="button" name="search"  id="button" title="Alt+S" accesskey="S" class="topformbutton2" onclick="return SearchLoanForRepaymentService();"><bean:message key="button.search" /></button>
...
<logic:notEmpty name="list">
  <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1"  partialList="true" size="${list[0].totalRecordSize}" requestURI="/repaymentServiceAction.do?method=searchLinkForRepaymentService" >
    ...
    <display:column property="customerRSPName" titleKey="lbl.businessPartnerName"  sortable="true"  />
