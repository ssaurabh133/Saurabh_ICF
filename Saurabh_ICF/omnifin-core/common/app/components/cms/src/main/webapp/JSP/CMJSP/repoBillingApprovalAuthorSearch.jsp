...
<fieldset>	  
		...
		<legend>
		<bean:message key="lbl.repoBillingApprovalAuthor"/>
		</legend>
	...
	<tr>
		...
		<td width="35%"  >
			...
			<html:button property="dealButton" style = "" styleId="dealButton" tabindex="1" onclick="closeLovCallonLov1();openLOVCommon(581,'RepoBillingApprovalSearchForm','searchLoanNo','','', '','','','searchCustomerName')" value=" " styleClass="lovbutton"></html:button>
	 </td>
 ...
 <tr>
		  <td align="left" class="form2" colspan="4">
		   <button type="button" name="search"  id="button" title="Alt+S" accesskey="S" class="topformbutton2" onclick="return searchRepoBillingApprovalAuthor('<bean:message key="lbl.selectLoanNo" />');"><bean:message key="button.search" /></button>
		  </tr>
		</table>
...
<fieldset>
		 <legend><bean:message key="lbl.repoBillingApprovalAuthor"/></legend> 
