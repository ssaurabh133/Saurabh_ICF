...
public class InstallmentPlanForCMVO implements Serializable{
	...
	public String getInsNextDueDate() {
		return insNextDueDate;
	}
	public void setInsNextDueDate(String insNextDueDate) {
		this.insNextDueDate = insNextDueDate;
	}
	
	// Ends here | Rahul papneja
	// added one filed for auto fill due date in installment plan| frequency|Vijendra Singh	
	...
	public String getCustomerRSPId() {
		return customerRSPId;
	}
	public void setCustomerRSPId(String customerRSPId) {
		this.customerRSPId = customerRSPId;
	}
