...
public class CmInsuranceVo implements Serializable{
	...
	public static final Comparator<CmInsuranceVo> insuranceProviderSorting = new Comparator<CmInsuranceVo>(){

        @Override
        public int compare(CmInsuranceVo o1, CmInsuranceVo o2) {
    ...
    public boolean equals(Object obj) {
        ...
        final CmInsuranceVo other = (CmInsuranceVo) obj;
