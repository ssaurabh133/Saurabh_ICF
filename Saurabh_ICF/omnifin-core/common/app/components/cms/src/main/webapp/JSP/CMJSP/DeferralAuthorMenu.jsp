...
<!--<li onclick="callFunction('/deferralAuthor.do?method=showDeferralDataAuthor','');"><a href="#" id="a" onclick="activeTab(id);"><span>Deferral Maker</span></a></li>-->
<!--<li onclick="callFunction('/deferralAuthor.do?method=openDeferralAuthor','b');"><a href="#" id="b" onclick="activeTab(id);"><span>Deferral Author</span></a></li>-->
<!---->
...
<li><a href="<%=request.getContextPath()%>/deferralAuthor.do?method=showDeferralDataAuthor" id="a"><span>Deferral Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/deferralAuthor.do?method=openDeferralAuthor" id="b"><span>Deferral Author</span></a></li>
</ul>
</div>
