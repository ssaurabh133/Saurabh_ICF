...
<html:form action="/caseMarkingMakerDispatch" styleId="caseMarkingSearchForm" method="post" > 	
...
<fieldset>	  
	...
	<tr>
		...
		<td width="35%"  >
			...
			<html:button property="dealButton" style = "" styleId="dealButton" tabindex="1" onclick="closeLovCallonLov1();openLOVCommon(476,'caseMarkingMakerForm','searchLoanNo','','', '','','','searchCustomerName')" value=" " styleClass="lovbutton"></html:button>
			<html:button property="dealButton" style = "display:none"  styleId="dealButton1" tabindex="1" onclick="closeLovCallonLov1();openLOVCommon(568,'caseMarkingMakerForm','searchLoanNo','','', '','','','searchCustomerName')" value=" " styleClass="lovbutton"></html:button>
	  </td>
	  ...
	  <tr>		
		  ...
		  <td>
		      	<html:select property="statusCase" styleId="statusCase" styleClass="text" onchange= "lovHideShow()" >
		 ...
		 <tr>
		  <td align="left" class="form2" colspan="4">
		   <button type="button" name="search"  id="button" title="Alt+S" accesskey="S" class="topformbutton2" onclick="return searchCaseMarkingMaker('<bean:message key="lbl.selectLoanNo" />');"><bean:message key="button.search" /></button>
		   <button type="button"  name="add" id="add" class="topformbutton2" title="Alt+A" accesskey="A" onclick="return newAddCaseMarking()" ><bean:message key="button.new" /></button></td>
...
<fieldset>
		 <legend><bean:message key="lbl.caseMarkingMaker"/></legend> 
