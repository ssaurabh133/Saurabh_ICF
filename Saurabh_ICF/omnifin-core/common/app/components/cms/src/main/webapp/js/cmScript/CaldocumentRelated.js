...
//	alert("recievedDate"+i);
	...
	//$("#recivDate"+i).datepicker({
		$("#recivBussinessDate"+i).datepicker({	
...
function makeChoice(str){
	...
	var businessDate=document.getElementById("bDate").value;
	//alert("flagE:------"+businessDate);
	//alert(document.getElementById(flagE).value);
	if(document.getElementById(status).value == 'R'){
		//document.getElementById(rec).innerHTML = "<input name='recievedDate' type='text' class='text6' id='recivDate"+str+"' value=''  maxlength='10' onchange=\"return checkDate('recivDate"+str+"');\" >";
		
		document.getElementById(rec).innerHTML = "<input name='recievedDate' type='text' class='text6' id='recievedDate"+str+"' value='"+businessDate+"' maxlength='10' onchange=\"return checkDate('recievedDate"+str+"');\"  >";
		...
		{
			document.getElementById(exp).innerHTML = "<input name='expiryDate' id='expirDate"+str+"' value='' type='text' class='text6' onchange=\"return checkDate('expirDate"+str+"');\" >";
		}
		else
		{
	   ...
	   //alert("In  d");
		...
		document.getElementById(def).innerHTML = "<input name='deferedDate'  type='text' readonly='true' class='text6' id='deferedDate"+str+"' value=''   maxlength='10' onchange=\"return checkDate('deferedDate"+str+"');\" >";
...
function makeChoiceAdditional(str){
	...
	if(document.getElementById(additionalDocStatus).value == 'R'){
		...
		document.getElementById(addRec).innerHTML = "<input name='additionalReceivedDate' type='text' class='text6' id='additionalReceivedDate"+psize+"' value='"+businessDate+"'  maxlength='10' onchange=\"return checkDate('additionalReceivedDate"+psize+"');\" >"; 
	   ...
	   //alert("In  d");
		...
		document.getElementById(addDef).innerHTML = "<input name='additionalDeferredDate'  type='text' class='text6' readonly='true' id='additionalDeferredDate"+psize+"' value=''   maxlength='10' onchange=\"return checkDate('additionalDeferredDate"+psize+"');\" >";
