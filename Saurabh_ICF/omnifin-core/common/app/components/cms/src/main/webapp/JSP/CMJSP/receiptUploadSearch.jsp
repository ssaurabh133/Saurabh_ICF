...
//alert("submitDocUpload");
	...
	{
                  document.getElementById("DocUpload").action=sourcepath+"/reciptUploadProcessAction.do?method=uploadData";
...
<! [endif] -->
	...
	<html:form styleId="DocUpload" action="/reciptUploadProcessAction" method="post" enctype="multipart/form-data">    
	...
	<input type="hidden" name="txnfile" id="txnfile" value="<%=processFile%>"/>
     <tr>
      <td><table width="100%" border="0" cellspacing="1" cellpadding="4">
		...
		<tr>		
		<td colspan="4">
		<button type="button" name="startProcessing" class="topformbutton3" title="Alt+P" accesskey="P" id="startProcessing"  onclick="startProcessReceipt();"><bean:message key="button.startProcng" /></button>&nbsp;&nbsp;&nbsp;
