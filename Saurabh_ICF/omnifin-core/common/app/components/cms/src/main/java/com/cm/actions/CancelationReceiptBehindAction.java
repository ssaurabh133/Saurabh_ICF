...
public class CancelationReceiptBehindAction extends Action
{
	Logger logger = Logger.getLogger(CancelationReceiptBehindAction.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception 
	{
		logger.info(" In CancelationReceiptBehindAction execute");
