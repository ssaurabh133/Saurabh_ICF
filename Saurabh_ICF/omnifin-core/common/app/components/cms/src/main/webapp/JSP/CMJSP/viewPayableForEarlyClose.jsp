...
<body onload="enableAnchor();">
	<div id="revisedcontainer">
			<fieldset>
				<legend>
					<bean:message key="lbl.paymentDetails" />
				</legend>
					...
					<tr>
						<td class="gridtd">
							<table width="100%" border="0" cellspacing="1" cellpadding="4"
								...
								<logic:present name="viewPayableList">
									<logic:iterate name="viewPayableList" id="subPayableList"
										indexId="count">
										<tr class="white1">
											<td>
												${subPayableList.paymentDate}
											</td>
											<td>
												${subPayableList.chargeDesc}
											</td>
											<td>
												${subPayableList.originalAmount}
													
											</td>
											<td>
												${subPayableList.waiveOffAmount}
													
											</td>
											<td>
												${subPayableList.adviceAmount}
													
											</td>
											
											<td>
												${subPayableList.adjustedAmount}
													
											</td>
											<td>
												${subPayableList.amountInProcess}
													
											</td>
											<td>
												${subPayableList.balanceAmount}
