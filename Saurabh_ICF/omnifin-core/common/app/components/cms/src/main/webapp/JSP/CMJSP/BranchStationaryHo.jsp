	...
	<div align="center" class="opacity" style="display:none" id="processingImage"></div>
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="1">
			...
			<tr> 
				...
				<button type="button" name="save" id="save" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return saveAcknowHo();">
   ...
   if('<%=request.getAttribute("saveData").toString()%>'=='saveData')
	{
		...
		document.getElementById("StationaryMasterForm").action="branchStationaryReturnHOAtCM.do";
