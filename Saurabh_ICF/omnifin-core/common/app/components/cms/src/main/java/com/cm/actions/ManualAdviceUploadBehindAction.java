...
public class ManualAdviceUploadBehindAction extends Action {
	private static  final Logger logger=Logger.getLogger(ManualAdviceUploadBehindAction.class.getName());
	
	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest 
								request,HttpServletResponse response)throws Exception{
		logger.info("in execute method of ManualDeviationUploadBehindAction::::::::::::::::::::::::::::::::::::");
		...
		if(userobj!=null)
		{
			...
			logger.info("here in execute method of LinkLoanMakerBehindAction action the session is out----------------");
		...
		logger.info("in ManualDeviationUploadBehindAction maker id is:"+userId);
