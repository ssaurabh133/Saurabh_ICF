...
public class MSSQLChequeStatusUpdateDAOImpl implements ChequeStatusUpdateDAO {
	
	
	private static final Logger logger = Logger.getLogger(MSSQLChequeStatusUpdateDAOImpl.class.getName());
 ...
 //End Here By Prashant, and the valDate used by Prashant 
                    ...
                    defaultBranch=CommonFunction.checkNull(chequeStatusVO.getLbxBranchId()).trim();
           	            ...
           	            StringBuffer bufInsSqlTempCount = new StringBuffer();
           	               ...
           	               {
           	            	   bufInsSql.append("select distinct a.instrument_no, ");
           	            	   bufInsSql.append(dbo);
           	            	   bufInsSql.append("DATE_FORMAT(a.INSTRUMENT_DATE,'"+dateFormat+"')  as INSTRUMENT_DATE,a.INSTRUMENT_AMOUNT,a.BPID,a.BPTYPE,b.bank_name,a.ISSUEING_BANK_ID, "+
           	            			   ...
           	            			   //" a.DEPOSIT_BANK_ACCOUNT,u.REASON_ID,r.REASON_DESC,z.loan_no,a.INSTRUMENT_MODE,if(a.REC_STATUS in('C','D','R'),DATE_FORMAT((SELECT PARAMETER_VALUE FROM PARAMETER_MST WHERE PARAMETER_KEY='BUSINESS_DATE'),'%d-%m-%Y'),DATE_FORMAT(a.RECEIVED_DATE,'%d-%m-%Y')) as valuedate ,if(a.REC_STATUS in('C','D','R'),DATE_FORMAT(A.DEPOSITED_DATE,'%d-%m-%Y'),DATE_FORMAT(a.RECEIVED_DATE,'%d-%m-%Y')) as HIDDENdate,z.REC_STATUS"+
           	            			" a.DEPOSIT_BANK_ACCOUNT,u.REASON_ID,r.REASON_DESC,z.loan_no,a.INSTRUMENT_MODE,CASE WHEN a.REC_STATUS in('C','D','R') THEN ");
           	            	   bufInsSql.append(dbo);
           	            	   bufInsSql.append("DATE_FORMAT((SELECT PARAMETER_VALUE FROM PARAMETER_MST WHERE PARAMETER_KEY='BUSINESS_DATE'),'%d-%m-%Y') ELSE ");
           	            	   bufInsSql.append(dbo);
           	            	   bufInsSql.append("DATE_FORMAT(a.RECEIVED_DATE,'%d-%m-%Y') END as valuedate ,CASE WHEN a.REC_STATUS in('C','D','R') THEN ");
           	            	   bufInsSql.append(dbo);
        	            	   bufInsSql.append("DATE_FORMAT(A.DEPOSITED_DATE,'%d-%m-%Y') ELSE ");
        	            	   bufInsSql.append(dbo);
           	            	   bufInsSql.append("DATE_FORMAT(a.RECEIVED_DATE,'%d-%m-%Y') END as HIDDENdate,z.REC_STATUS,a.RECIPT_NO,dbo.DATE_FORMAT(a.RECEIVED_DATE,'%d-%m-%Y') as RECIPT_DATE,BRANCH_DESC,u.REASON_REMARKS ,BM.BANK_NAME,BRM.BANK_BRANCH_NAME,a.DEPOSIT_BANK_ACCOUNT ");
           	            	   bufInsSql.append(" from cr_instrument_dtl a "+
         	            			   ...
         	            			   " LEFT JOIN COM_BANKBRANCH_M BRM ON BRM.BANK_BRANCH_ID=a.DEPOSIT_BRANCH_ID "+
           	            			   ...
           	            			   " left outer join com_branch_m cbm on cbm.BRANCH_ID=a.DEFAULT_BRANCH  left outer join com_reason_m r on  r.REASON_ID=u.REASON_ID "+
           	            			   " inner join cr_loan_dtl z on a.TXNID = z.loan_id "+
           	            			   " where  z.rec_status<>'L' and isnull(a.TXN_TYPE,'')='LIM' and  A.instrument_type='P' and ((a.rec_status='X' and a.rec_status not in ('P','F')) or (a.rec_status<>'X' and a.rec_status not in ('P','F','X'))) "+
                   ...
                   /* bufInsSql.append( "select a.instrument_no,DATE_FORMAT(a.INSTRUMENT_DATE,'"+dateFormat+"'),a.INSTRUMENT_AMOUNT,a.BPID,a.BPTYPE,b.bank_name,a.ISSUEING_BANK_ID," +
                    ...
                    bufInsSqlTempCount.append("select count(1) from( select distinct a.instrument_no, ");
                    bufInsSqlTempCount.append(dbo);
	            	bufInsSqlTempCount.append("DATE_FORMAT(a.INSTRUMENT_DATE,'"+dateFormat+"')  as INSTRUMENT_DATE,a.INSTRUMENT_AMOUNT,a.BPID,a.BPTYPE,b.bank_name,a.ISSUEING_BANK_ID, "+
           	            			   " c.bank_branch_name,a.ISSUEING_BRANCH_ID,a.ISSUEING_BANK_ACCOUNT,a.REC_STATUS,(select description from  generic_master   where generic_key='BPTYPE' and value=a.BPTYPE)Description,e.bp_name,A.INSTRUMENT_ID,a.tds_amount,"+
           	            			   " a.pdc_instrument_id, a.instrument_type,a.DEPOSIT_BANK_ID,a.DEPOSIT_BRANCH_ID,a.DEPOSIT_MICR_CODE,a.DEPOSIT_IFSC_CODE, "+
                    		 ...
                    		 " from cr_instrument_dtl a "+
 	            			   ...
 	            			   " and a.INSTRUMENT_ID not in(select INSTRUMENT_ID from cr_instrument_update_dtl where REC_STATUS in ('P','F') )");
  		           	         ...
  		           	         {   
		           	            	bufInsSql.append("select distinct a.instrument_no, ");
		           	            	bufInsSql.append(dbo);
		        	                bufInsSql.append("DATE_FORMAT(a.INSTRUMENT_DATE,'"+dateFormat+"'),a.INSTRUMENT_AMOUNT,a.BPID,a.BPTYPE,b.bank_name,a.ISSUEING_BANK_ID, "+
		           	            			   " c.bank_branch_name,a.ISSUEING_BRANCH_ID,a.ISSUEING_BANK_ACCOUNT,a.REC_STATUS,(select description from  generic_master   where generic_key='BPTYPE' and value=a.BPTYPE)Description,e.bp_name,A.INSTRUMENT_ID,a.tds_amount,"+
		           	            			   " a.pdc_instrument_id, a.instrument_type,a.DEPOSIT_BANK_ID,a.DEPOSIT_BRANCH_ID,a.DEPOSIT_MICR_CODE,a.DEPOSIT_IFSC_CODE, "+
		           	            			   " a.DEPOSIT_BANK_ACCOUNT,u.REASON_ID,r.REASON_DESC,z.loan_no,a.INSTRUMENT_MODE, CASE WHEN a.REC_STATUS in('C','D','R') THEN ");
		        	                bufInsSql.append(dbo);
		        	            	...
		        	            	bufInsSql.append(" from cr_instrument_dtl a "+
		           	            			   ...
		           	            			   " left outer join com_branch_m cbm on cbm.BRANCH_ID=a.DEFAULT_BRANCH  left outer join com_reason_m r on  r.REASON_ID=u.REASON_ID "+
		           	            			   " inner join cr_loan_dtl z on a.TXNID = z.loan_id "+
		           	            			   " where  z.rec_status<>'L' and isnull(a.TXN_TYPE,'')='LIM' and  A.instrument_type='R' and ((a.rec_status='X' and a.rec_status not in ('P','F')) or (a.rec_status<>'X' and a.rec_status not in ('P','F','X')))  "+
		           	            			   " and a.INSTRUMENT_ID not in(select INSTRUMENT_ID from cr_instrument_update_dtl where REC_STATUS in ('P','F') ) ");  
  		           	    ...
  		           	    if((txnType.toString()).equalsIgnoreCase("DC"))
	        	                ...
	        	                bufInsSql.append("DATE_FORMAT(a.INSTRUMENT_DATE,'"+dateFormat+"'),a.INSTRUMENT_AMOUNT,a.BPID,a.BPTYPE,b.bank_name,a.ISSUEING_BANK_ID, "+
	           	            			   " c.bank_branch_name,a.ISSUEING_BRANCH_ID,a.ISSUEING_BANK_ACCOUNT,a.REC_STATUS,(select description from  generic_master   where generic_key='BPTYPE' and value=a.BPTYPE)Description,e.bp_name,A.INSTRUMENT_ID,a.tds_amount,"+
	           	            			   " a.pdc_instrument_id, a.instrument_type,a.DEPOSIT_BANK_ID,a.DEPOSIT_BRANCH_ID,a.DEPOSIT_MICR_CODE,a.DEPOSIT_IFSC_CODE, "+
	           	            			   " a.DEPOSIT_BANK_ACCOUNT,u.REASON_ID,r.REASON_DESC,z.deal_no,a.INSTRUMENT_MODE, CASE WHEN a.REC_STATUS in('C','D','R') THEN ");
	        	                bufInsSql.append(dbo);
	        	                bufInsSql.append("DATE_FORMAT((SELECT PARAMETER_VALUE FROM PARAMETER_MST WHERE PARAMETER_KEY='BUSINESS_DATE'),'%d-%m-%Y') ELSE ");
	           	            	bufInsSql.append(dbo);
	        	                bufInsSql.append("DATE_FORMAT(a.RECEIVED_DATE,'%d-%m-%Y') END as valuedate , CASE WHEN a.REC_STATUS in('C','D','R') THEN ");
	        	            	...
	        	            	bufInsSql.append(" from cr_instrument_dtl a "+
	           	            			   ...
	           	            			   " where  z.rec_status<>'L' and isnull(a.TXN_TYPE,'')='DC' and  A.instrument_type='R' and ((a.rec_status='X' and a.rec_status not in ('P','F')) or (a.rec_status<>'X' and a.rec_status not in ('P','F','X')))  "+
	           	            			   " and a.INSTRUMENT_ID not in(select INSTRUMENT_ID from cr_instrument_update_dtl where REC_STATUS in ('P','F') ) ");  
...
//       	               }
           	           ...
           	           if((!((instrumentDate.toString()).equalsIgnoreCase("")))) {
       	                   bufInsSql.append("  AND a.INSTRUMENT_DATE=");
       	                   bufInsSql.append(dbo);
    	            	   bufInsSql.append("STR_TO_DATE('"+StringEscapeUtils.escapeSql(instrumentDate.toString())+"','"+dateFormat+"')");
    	            	   bufInsSqlTempCount.append("  AND a.INSTRUMENT_DATE=");
    	            	   bufInsSqlTempCount.append(dbo);
    	            	   bufInsSqlTempCount.append("STR_TO_DATE('"+StringEscapeUtils.escapeSql(instrumentDate.toString())+"','"+dateFormat+"')");
       	               }           	           
           	           if((!((receivedDate.toString()).equalsIgnoreCase("")))) {
       	                   bufInsSql.append("  AND a.RECEIVED_DATE=");
       	                   bufInsSql.append(dbo);
    	            	   bufInsSql.append("STR_TO_DATE('"+StringEscapeUtils.escapeSql(receivedDate.toString())+"','"+dateFormat+"')");
    	            	   bufInsSqlTempCount.append("  AND a.RECEIVED_DATE=");
    	            	   bufInsSqlTempCount.append(dbo);
    	            	   bufInsSqlTempCount.append("STR_TO_DATE('"+StringEscapeUtils.escapeSql(receivedDate.toString())+"','"+dateFormat+"')");
       	               }
           	        ...
           	        bufInsSqlTempCount.append(" ) as b");  
           	           //bufInsSql.append("  order by a.instrument_no");
                    ...
                    int endRecordIndex=0;
          			...
          			bufInsSql.append(" ORDER BY a.instrument_no OFFSET ");
			...
			try
			{
	            ...
	            receiptNo.append(StringEscapeUtils.escapeSql(CommonFunction.checkNull(chequeStatusVO.getReciptNo()).trim()));
	           	...
	           	if((instrumentType.toString()).equalsIgnoreCase("P"))
	           	{
	           		bufInsSql.append("select distinct a.instrument_no, ");
	           		bufInsSql.append(dbo);
	            	bufInsSql.append("DATE_FORMAT(a.INSTRUMENT_DATE,'%d-%m-%Y')INSTRUMENTDATE,a.INSTRUMENT_AMOUNT,a.BPID,a.BPTYPE,b.bank_name,a.ISSUEING_BANK_ID, "+
	           	    			     " c.bank_branch_name,a.ISSUEING_BRANCH_ID,a.ISSUEING_BANK_ACCOUNT,a.REC_STATUS,(select description from  generic_master   where generic_key='BPTYPE' and value=a.BPTYPE)Description,e.bp_name,A.INSTRUMENT_ID,a.tds_amount,"+
	           	            	     " a.pdc_instrument_id, a.instrument_type,a.DEPOSIT_BANK_ID,a.DEPOSIT_BRANCH_ID,a.DEPOSIT_MICR_CODE,a.DEPOSIT_IFSC_CODE, "+
	           	            		 " a.DEPOSIT_BANK_ACCOUNT,u.REASON_ID,r.REASON_DESC,z.loan_no, ");
	            	bufInsSql.append(dbo);
   	            	bufInsSql.append("DATE_FORMAT(VALUE_DATE,'%d-%m-%Y')VALUEDATE,a.RECIPT_NO,concat((select USER_NAME from sec_user_m where user_id=u.AUTHOR_ID),'-', u.AUTHOR_ID) as AUTHOR_ID,BM.BANK_NAME,BRM.BANK_BRANCH_NAME,a.DEPOSIT_BANK_ACCOUNT ");
   	            	bufInsSql.append("from cr_instrument_dtl a "+
	           	            		 " left outer join com_bank_m b on a.ISSUEING_BANK_ID = b.BANK_ID "+
	           	            		 " left outer join com_bankbranch_m c on a.ISSUEING_BRANCH_ID = c.bank_BRANCH_ID "+
	           	            		 " LEFT JOIN COM_BANK_M BM ON BM.BANK_ID=a.DEPOSIT_BANK_ID " +
         	            			   " LEFT JOIN COM_BANKBRANCH_M BRM ON BRM.BANK_BRANCH_ID=a.DEPOSIT_BRANCH_ID "+
	           	            			...
	           	            			" inner join cr_loan_dtl z on a.TXNID = z.loan_id "+
	           	            			" where    z.rec_status<>'L' and isnull(a.TXN_TYPE,'')='LIM' and A.instrument_type ='P' and a.rec_status not in ('P','F') "+
	           	            			" and a.INSTRUMENT_ID not in(select INSTRUMENT_ID from cr_instrument_update_dtl where REC_STATUS in ('P','F') )"); 
	           	            			  
	           	     bufInsSqlTempCount.append("select count(1) from (select a.instrument_no,");
	           	  bufInsSqlTempCount.append(dbo);
	            	   bufInsSqlTempCount.append("DATE_FORMAT(a.INSTRUMENT_DATE,'%d-%m-%Y')INSTRUMENTDATE,a.INSTRUMENT_AMOUNT,a.BPID,a.BPTYPE,b.bank_name,a.ISSUEING_BANK_ID, "+
	           	    			     " c.bank_branch_name,a.ISSUEING_BRANCH_ID,a.ISSUEING_BANK_ACCOUNT,a.REC_STATUS,(select description from  generic_master   where generic_key='BPTYPE' and value=a.BPTYPE)Description,e.bp_name,A.INSTRUMENT_ID,a.tds_amount,"+
	           	            	     " a.pdc_instrument_id, a.instrument_type,a.DEPOSIT_BANK_ID,a.DEPOSIT_BRANCH_ID,a.DEPOSIT_MICR_CODE,a.DEPOSIT_IFSC_CODE, "+
	           	            		 " a.DEPOSIT_BANK_ACCOUNT,u.REASON_ID,r.REASON_DESC,z.loan_no, ");
	            	   bufInsSqlTempCount.append(dbo);
   	            	   bufInsSqlTempCount.append(" DATE_FORMAT(VALUE_DATE,'%d-%m-%Y')VALUEDATE,a.RECIPT_NO,concat((select USER_NAME from sec_user_m where user_id=u.AUTHOR_ID),'-', u.AUTHOR_ID) as AUTHOR_ID from cr_instrument_dtl a "+
	           	            		 "  left outer join com_bank_m b on a.ISSUEING_BANK_ID = b.BANK_ID "+
	           	            		 " left outer join com_bankbranch_m c on a.ISSUEING_BRANCH_ID = c.bank_BRANCH_ID "+
	           	            		 " LEFT JOIN COM_BANK_M BM ON BM.BANK_ID=a.DEPOSIT_BANK_ID " +
         	            			   " LEFT JOIN COM_BANKBRANCH_M BRM ON BRM.BANK_BRANCH_ID=a.DEPOSIT_BRANCH_ID "+
	           	...
	           	else
	           	{
	            	...
	            	bufInsSql.append("DATE_FORMAT(a.INSTRUMENT_DATE,'%d-%m-%Y')as INSTRUMENT_DATE,a.INSTRUMENT_AMOUNT,a.BPID,a.BPTYPE,b.bank_name,a.ISSUEING_BANK_ID, "+
	           	            		...
	           	            		" a.DEPOSIT_BANK_ACCOUNT,u.REASON_ID,r.REASON_DESC,z.loan_no, ");
	            	bufInsSql.append(dbo);
   	            	bufInsSql.append("DATE_FORMAT(VALUE_DATE,'%d-%m-%Y')as VALUE_DATE,a.RECIPT_NO,concat((select USER_NAME from sec_user_m where user_id=u.AUTHOR_ID),'-', u.AUTHOR_ID) as AUTHOR_ID,BM.BANK_NAME,BRM.BANK_BRANCH_NAME,a.DEPOSIT_BANK_ACCOUNT");
   	            	...
   	            	bufInsSql.append(" from cr_instrument_dtl a "+
     	            			   ...
     	            			   " LEFT JOIN COM_BANKBRANCH_M BRM ON BRM.BANK_BRANCH_ID=a.DEPOSIT_BRANCH_ID "+
	           	            		...
	           	            		"  left outer join com_reason_m r on  r.REASON_ID=u.REASON_ID "+
	           	            		" inner join cr_loan_dtl z on a.TXNID = z.loan_id "+
	           	            		" where z.rec_status<>'L' and isnull(a.TXN_TYPE,'')='LIM' and   A.instrument_type ='R' and a.rec_status not in ('P','F') "+
	           	            		" and a.INSTRUMENT_ID not in(select INSTRUMENT_ID from cr_instrument_update_dtl where REC_STATUS in ('P','F') ) ");  
