...
<!--           <html:option value="">--Select--</html:option>-->
         ...
         <input type="hidden" name="flagExp" id="flagExp${i}" value="${subdocuments.expirFlag }" />
             ...
             <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','PRAPPL');"%>Upload/Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','PRAPPL');">Upload/Download</td>
               </logic:notEqual>
          </tr>
       </logic:iterate>
...
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocumentPOD('A','Y');"><bean:message key="button.save" /></button> 
</logic:present> 
<logic:notPresent name="dataFound">
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocumentPOD('A','N');"><bean:message key="button.save" /></button> 
</logic:notPresent>
...
<!--           <html:option value="">--Select--</html:option>-->
            ...
            <html:option value="N">NA</html:option><!-- Virender -->
             ...
             <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','PRAPPL');"%>Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','PRAPPL');">Download</td>
               </logic:notEqual>  
