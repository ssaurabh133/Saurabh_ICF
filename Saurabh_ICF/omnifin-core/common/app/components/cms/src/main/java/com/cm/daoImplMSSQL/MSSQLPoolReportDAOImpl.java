...
import com.cm.dao.PoolReportDAO;

public class MSSQLPoolReportDAOImpl implements PoolReportDAO{
	
	private static final Logger logger = Logger.getLogger(MSSQLPoolReportDAOImpl.class.getName());
