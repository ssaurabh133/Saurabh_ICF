...
public class NHBPartPrePayUploadDispatchAction extends DispatchAction {
	private static final Logger logger=Logger.getLogger(NHBPartPrePayUploadDispatchAction.class.getName());
	ResourceBundle resource = ResourceBundle.getBundle("com.yourcompany.struts.ApplicationResources");
	
	public ActionForward uploadData(ActionMapping mapping,ActionForm form,
			HttpServletRequest request,HttpServletResponse response) throws Exception {
		logger.info(" in uploadData method of NHBPartPrePayUploadDispatchAction:::::::::::::::::::::::");
		
		HttpSession session = request.getSession();	
		UserObject userobj=(UserObject)session.getAttribute("userobject");
		if(userobj==null){
			logger.info("in  uploadData method of  NHBPartPrePayUploadDispatchAction action the session is out----------------");
		...
		boolean uploadStatus=false;	
			...
			uploadStatus=service.whereToUploadNHB(request,manualAdviceUploadVo.getDocFile());	
			...
			if(uploadStatus)
			{
				int count=service.countLineForNHB(manualAdviceUploadVo.getDocFile().toString());
	...
	public ActionForward startProcess(ActionMapping mapping,ActionForm form,
			HttpServletRequest request,HttpServletResponse response) throws Exception {
		logger.info(" in startProcess method of NHBPartPrePayUploadDispatchAction:::::::::::::::::::::::");
		...
		logger.info("startProcess() : file:==>>"+file);
			...
			boolean status=service.readExcelforNHBPartPrePayUpload(request, response,file);
	...
	public ActionForward errorLogDownload(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		    logger.info("In errorLogDownload().of .NHBUploadDispatchAction. ");
		    HttpSession session = request.getSession();
			UserObject userobj=(UserObject)session.getAttribute("userobject");
			String user_id="";
			...
			if(userobj!=null)
			{
				...
				logger.info("in  errorLogDownload method of NHBUploadDispatchAction action the session is out----------------");
				return mapping.findForward("sessionOut");
			}
			Object sessionId = session.getAttribute("sessionID");
			//for check User session start
