...
<li><a href= "repoBillingApprovalAuthorAdd.jsp"target="body" id="a"><span style="color: rgb(255, 255, 255);">Repo Billing Approval Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/repoBillingApprovalAuthorDispatch.do?method=repoBillingApprovalAuthorScreen" target="body" id="b"><span style="color: rgb(255, 255, 255);">Repo Billing Approval Author</span></a></li>
	</ul>
</div>
