...
<! [endif] -->		
	...
	<legend><bean:message key="lbl.instrumentCapturingMakerSearch"/></legend>   
	</logic:present>	    
	
	<logic:present name="instrumentCapturingAuthorSearch"> 
	<legend><bean:message key="lbl.instrumentCapturingAuthorSearch"/></legend>   
	</logic:present>   
    ...
    --%>
    <html:button property="loanNoButton" styleId="loanNoButton" onclick="openLOVCommon(273,'sourcingForm','loanAccNo','userId','loanAccNo', 'userId','','','customerName');closeLovCallonLov1();" value=" " styleClass="lovbutton"></html:button>
           </td>
	    </logic:present>
   ...
   <html:hidden property="lbxLoanNoHID" styleId="lbxLoanNoHID" />
	...
	<%--  <html:button property="loanNoButton" styleId="loanNoButton" onclick="openLOVCommon(118,'sourcingForm','loanAccNo','userId','loanAccNo', 'userId','','','customerName');closeLovCallonLov1();" value=" " styleClass="lovbutton"></html:button>   
        --%>
           <html:button property="loanNoButton" styleId="loanNoButton" onclick="openLOVCommon(274,'sourcingForm','loanAccNo','userId','loanAccNo', 'userId','','','customerName');closeLovCallonLov1();" value=" " styleClass="lovbutton"></html:button>   
   ...
   <td><bean:message key="lbl.instrumentMode"/></td>
    ...
    --%>
       ...
       <logic:present name="author">
         ...
         <tr>
			<td align="left">  
			    <button type="button" id="save" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return searchInstrumentAuthor();"><bean:message key="button.search" /></button> 
			</td>
		</tr>
		 </logic:present>
		 ...
		 <logic:present name="maker">
           ...
           <td align="left">
            <button type="button" name="button"  id="save" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return searchInstrument();"><bean:message key="button.search" /></button> 
	        <button type="button" name="button" id="new" class="topformbutton2" title="Alt+N" accesskey="N" onclick="return newInstrument();"><bean:message key="button.new" /></button>
	      </td>
		</tr>
		 </logic:present> 
...
<fieldset>	
		 ...
		 <logic:present name="instrumentCapturingMakerSearch"> 
	<legend><bean:message key="lbl.instrumentCapturingMakerRecords"/></legend>   
	</logic:present>
   
   <logic:present name="instrumentCapturingAuthorSearch"> 
	<legend><bean:message key="lbl.instrumentCapturingAuthorRecords"/></legend>   
	</logic:present>
