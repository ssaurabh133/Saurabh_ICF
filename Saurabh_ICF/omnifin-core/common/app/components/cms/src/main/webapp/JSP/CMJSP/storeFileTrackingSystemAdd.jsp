	 ...
	 <tr>
	  <td>
		...
		<tr>
			...
			<td><bean:message key="lbl.indexRefNo"></bean:message><span><font color="red">*</font></span></td>
		    <td>
		     	<html:text styleClass="text" property="indexRefNo" styleId="indexRefNo" maxlength="12"  value="${list[0].indexRefNo}"  tabindex="-1"/>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">	
		<tr>
		<td width="132px"><bean:message key="lbl.fileTrackRemark"/></td>
	     	<td>
	 ...
	 <tr>
	  <td>
		...
		<tr>
			...
			<td><bean:message key="lbl.indexRefNo"></bean:message><span><font color="red">*</font></span></td>
		    <td>
		     	<html:text styleClass="text" property="indexRefNo" styleId="indexRefNo" maxlength="20"  value="${list[0].indexRefNo}"  tabindex="-1" readonly="readonly"/>
...
<logic:present name="sms">
	...
	location.href="<%=request.getContextPath()%>/fileTrackingBehindAction.do?method=storeFileTracking";
	}
