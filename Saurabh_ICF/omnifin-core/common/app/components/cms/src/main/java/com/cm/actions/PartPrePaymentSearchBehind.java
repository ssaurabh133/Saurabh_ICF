 ...
 */
public class PartPrePaymentSearchBehind extends DispatchAction {
	private static final Logger logger = Logger.getLogger(PartPrePaymentSearchBehind.class.getName());
	...
	public ActionForward partPrePaymetMakerSearch(ActionMapping mapping, ActionForm form,
		...
		if(userobj!=null)
		{
			...
			logger.info("here in partPrePaymetMakerSearch method of PartPrePaymentSearchBehind action the session is out----------------");
		...
		return mapping.findForward("partPrePaymetMakerSearch");
	}
	...
	public ActionForward partPrePaymetAuthorSearch(ActionMapping mapping, ActionForm form,
		...
		if(userobj!=null)
		{
			...
			logger.info("here in partPrePaymetAuthorSearch method of PartPrePaymentMakerDispatchAction action the session is out----------------");
			return mapping.findForward("sessionOut");
		}
		PartPrePaymentSearchVO vo = new PartPrePaymentSearchVO();
		...
		return mapping.findForward("partPrePaymetAuthorSearch");
	}
}