...
<! [endif] -->
		 ...
		 <tr>	
		   <td width="13%"><bean:message key="lbl.loanNo"/><span><font color="red">*</font></span></td>
			 <td width="13%">
             	...
             	<html:button property="loanAccountButton" styleId="loanAccountButton" onclick="openLOVCommon(1376,'fileTrackingForm','loanNoSearch','','lbxLoanNoHIDSearch','','','','customerName')" value=" " styleClass="lovbutton"/>
			...
			<td>
			<html:select property="fileTrackStatus"  styleId="fileTrackStatus" styleClass="text" value="" >
 ...
 <table width="100%" border="0" cellspacing="1" cellpadding="0">
		<tr>
		<td colspan="3">
		<button type="button" name="Search" id="search" class="topformbutton2" title="Alt+S" accesskey="S" onclick="return branchFileTrackingSearch();" ><bean:message key="button.search" /></button>
		<button type="button" name="New" id="new"  class="topformbutton2" title="Alt+N" accesskey="N" onclick="return openNewFileTracking();" ><bean:message key="button.new" /></button>
	   </td>
  ...
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    ...
    <tr class="white2">
       ...
       <td><strong><bean:message key="lbl.loanNo"/></strong> </td>
 		...
 		<td><strong><bean:message key="lbl.fileTrackingUser"/></strong></td>
...
<logic:notEmpty name="list"> 
  <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1"  partialList="true" size="${list[0].totalRecordSize}" requestURI="/fileTrackingBehindAction.do" >
    ...
    <display:column property="fileTrackingUser" titleKey="lbl.fileTrackingUser"  sortable="true"  />
	<display:column property="fileTrackStatus" titleKey="lbl.fileStatus"  sortable="true"  />
