														...
														<tr class="white1">
															...
															<td>
																<input type="text" class="text" name="fromInstall"
																	id="fromInstallment<%=count.intValue() + 1%>"
																	value="${subInstallmentList.fromInstallment}"
																	maxlength="100" onkeypress="return isNumberKey(event);" />
															</td>
															<td>
																<input type="text" class="text" name="toInstall"
																	id="toInstallment<%=count.intValue() + 1%>"
...
<!--										</logic:notPresent>-->
						...
						<button type="button" name="saveInstallmentPlanBtn" id="saveInstallmentPlanBtn" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveNewInstallmentPlanAddtionalDisbursal();"><bean:message key="button.save" /></button>
						...
						<logic:notPresent name="viewMode">
							...
							<button type="button" name="addBtn" id="addBtn" class="topformbutton2" title="Alt+A" accesskey="A" onclick="addROWInAdditionDisb('<bean:message key="msg.LoanAccountNo" />');"><bean:message key="button.addrow" /></button>
							
							<button type="button" name="deleteBtn" id="deleteBtn" class="topformbutton2" title="Alt+D" accesskey="D" onclick="removeRowInAdditionDisb();"><bean:message key="button.deleterow" /></button>
						...
						<table width="50%" border="0" cellspacing="4" cellpadding="0">
							<tr>
								...
								<td>
									...
									<select name="recoveryType" id="recoveryType"
										onchange="changeRecoveryType();" disabled="disabled">
