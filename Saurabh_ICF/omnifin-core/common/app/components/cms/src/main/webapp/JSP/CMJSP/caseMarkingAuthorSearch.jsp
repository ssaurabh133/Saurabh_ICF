...
<html:form action="/caseMarkingAuthorDispatch" styleId="caseMarkingSearchForm" method="post" > 	
...
<fieldset>	  
	...
	<tr>
		...
		<td width="35%">
			...
			<html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="closeLovCallonLov1();openLOVCommon(555,'caseMarkingMakerForm','searchLoanNo','','', '','','','searchCustomerName')" value=" " styleClass="lovbutton"></html:button>
	  </td>
 ...
 <tr>
		  <td align="left" class="form2" colspan="4">
		   <button type="button" name="search"  id="button" title="Alt+S" accesskey="S" class="topformbutton2" onclick="return searchCaseMarkingAuthor('<bean:message key="lbl.selectLoanNo" />');"><bean:message key="button.search" /></button>
...
<fieldset>
		 <legend><bean:message key="lbl.caseMarkingAuthor"/></legend> 

 <logic:present name="detailList">

   <logic:notEmpty name="detailList">

  <display:table  id="detailList"  name="detailList" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${detailList[0].totalRecordSize}" requestURI="/caseMarkingAuthorBehind.do" >
