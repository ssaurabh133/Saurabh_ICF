...
public class MSSQLUploadDocumentDAOImpl implements UploadDocumentDAO {
	
	private static final Logger logger = Logger.getLogger(MSSQLUploadDocumentDAOImpl.class.getName());
	...
	public StringBuffer getUploadData(String makerId)
	{
		...
		if(makerId!=null)
		{
		query= "Select file_name from upload_SUMMARY where maker_id='"+makerId +"' and MAKER_DATE=CONVERT (date, GETDATE())";
