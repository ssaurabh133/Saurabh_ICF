...
<body
	onload="enableAnchor();document.getElementById('deferralSearchForm').loanLov.focus();init_fields();"
	oncontextmenu="return false" onclick="parent_disable();"
	onunload="closeAllLovCallUnloadBody();">

	<logic:present name="deferralMakerSearch">

		<div id="revisedcontainer">

			<html:form action="/deferralSearch" method="post"
				styleId="deferralSearchForm">

				<fieldset>
					<legend>
						<bean:message key="lbl.deferralMakerSearch" />
					</legend>
								...
								<table width="100%" border="0" cellspacing="1" cellpadding="1">
									...
									<tr>
										...
										<td width="35%">
											...
											<html:button property="loanLov"
												onclick="openLOVCommon(221,'deferralSearchForm','loanNo','userId','loanNo', 'userId','','','customerName');closeLovCallonLov1();"
									...
									<tr>
									 ...
									 <td>
									    ...
									    <html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="openLOVCommon(266,'deferralSearchForm','userName','userId','', 'userId','','','reportingToUserId')" value=" " styleClass="lovbutton"  ></html:button>
									 </td>
									</tr>

									<tr>
										<td>
											<!--<html:button styleClass="topformbutton2" property="search"
												styleId="search" value="Search" accesskey="F" title="Alt+F"
												onclick="this.disabed=true;searchDeferral('P');" />-->
												<button type="button" class="topformbutton2" name="search"  id="search"  onclick="searchDeferral('P');"
 title="Alt+S" accesskey="S" ><bean:message key="button.search" /></button>
											<!--<html:button styleClass="topformbutton2" property="new"
												styleId="new" value="New" accesskey="N" title="Alt+N"
												onclick="this.disabled=true;openNewdeferral();" />-->
												
<button type="button" class="topformbutton2" name="new"  id="new"  onclick="openNewdeferral();" title="Alt+N" accesskey="N" ><bean:message key="button.new" /></button>
		...
		<fieldset>
			<legend>
				<bean:message key="lbl.deferralMakerRecords" />
			</legend>
			<logic:present name="deferralSearchList">
				<logic:notEmpty name="list">
					<display:table id="list" name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${list[0].totalRecordSize}" requestURI="/deferralSearch.do">
	...
	<logic:present name="deferralAuthorSearch">
		...
		<div id="revisedcontainer">
			...
			<html:form action="/deferralSearch" method="post"
				...
				<fieldset>
					<legend>
						<bean:message key="lbl.deferralAuthorSearch" />
					</legend>
								...
								<table width="100%" border="0" cellspacing="1" cellpadding="1">
									<tr>
										...
										<td width="35%">
											...
											<html:button property="loanLov"
												onclick="openLOVCommon(222,'deferralSearchForm','loanNo','userId','loanNo', 'userId','','','customerName');closeLovCallonLov1();"
												value=" " styleClass="lovButton" />
											<input type="hidden" name="contextPath"
												value="<%=request.getContextPath()%>" id="contextPath" />
											<html:hidden property="lbxLoanNoHID" styleId="lbxLoanNoHID"
									...
									<tr>
									 ...
									 <td>
									    ...
									    <html:hidden property="lbxUserId" styleId="lbxUserId" value=""/>
									    <input type="hidden" name="userId" id="userId" value="${userobject.userId}" />
									    <html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="openLOVCommon(282,'deferralSearchForm','userName','userId','', 'userId','','','reportingToUserId')" value=" " styleClass="lovbutton"  ></html:button>
									 </td>
									</tr>
									...
									<tr>
										<td>
											<!--<html:button styleClass="topformbutton2" property="search"
												styleId="search" value="Search" accesskey="F" title="Alt+F"
												onclick="this.disabed=true;searchDeferral('F');" />-->
												<button type="button" class="topformbutton2" name="search"  id="search"  onclick="searchDeferral('F');"
 title="Alt+S" accesskey="S" ><bean:message key="button.search" /></button>
										</td>
										<td>
											&nbsp;
		...
		<fieldset>
			<legend>
				<bean:message key="lbl.deferralAuthorRecords" />
			</legend>
