...
<! [endif] -->
	...
	<body onload="enableAnchor();document.getElementById('waiveOffMakerForm').loanButton.focus();init_fields();" onunload="closeAllLovCallUnloadBody();">
	<div id="centercolumn">
	<div id="revisedcontainer">
	<html:form action="/waiveOffMakerAction" styleId="waiveOffMakerForm">
	
	<fieldset>	  
	  <legend><bean:message key="lbl.WaiveOffmakerSearch"/> </legend>         
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
		  ...
		  <tr>
		    ...
		    <input type="hidden" name="userId" id="userId" value="${userobject.userId}" />	
              ...
              <!-- <img onclick="openLOVCommon(153,'waiveOffMakerForm','loanAccountNo','','', '','','','customerName','hCommon','hCommon')" src="<%= request.getContextPath() %>/images/lov.gif"/> -->
              <html:button property="loanButton" styleId="loanButton" onclick="closeLovCallonLov1();openLOVCommon(153,'waiveOffMakerForm','loanAccountNo','userId','loanAccountNo', 'userId','','','customerName','hCommon','hCommon')" value=" " styleClass="lovbutton"></html:button>
		    ...
		    <td nowrap="nowrap" >
								...
								<html:hidden styleClass="text" property="businessPartnerType" styleId="businessPartnerType" style="" value=""/>              					
              					...
              					<html:button property="loanButton" styleId="loanButton" onclick="openLOVCommon(45,'waiveOffMakerForm','businessPartnerType','loanAccountNo', 'lbxBusinessPartnearHID','lbxLoanNoHID','Select Loan Account LOV First','','businessPartnerName','businessPartnerTypeDesc');closeLovCallonLov('loanAccountNo');" value=" " styleClass="lovbutton"></html:button>
              					<!-- <img onclick="openLOVCommon(45,'waiveOffMakerForm','businessPartnerType','loanAccountNo', 'lbxBusinessPartnearHID','lbxLoanNoHID','Select Loan Account LOV First','','businessPartnerName','businessPartnerTypeDesc')" src="<%= request.getContextPath() %>/images/lov.gif"/> -->
		  ...
		  <tr>
			...
			<tr>
			 ...
			 <td>
			    ...
			    <input type="hidden" name="userId" id="userId" value="${userobject.userId}" />
			    <html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="openLOVCommon(266,'waiveOffMakerForm','userName','userId','', 'userId','','','reportingToUserId')" value=" " styleClass="lovbutton"  ></html:button>
			 </td>

		    </tr>
		    
		  <tr>
            <td align="left" > <button type="button" name="search" onclick="return searchWaiveOff()" class="topformbutton2" id="search" title="Alt+S" accesskey="S" ><bean:message key="button.search" /></button>
		    <button type="button" name="button2" class="topformbutton2" onclick="return openNewWaifOff('N');" title="Alt+N" accesskey="N"><bean:message key="button.new" /></button>
		    </td>
		    <td align="left" >&nbsp;</td>
		    <td align="left" >&nbsp;</td>
		    <td  align="right" />
     ...
     <fieldset>	
		<legend><bean:message key="lbl.WaiveOffmakerRecord"/> </legend>    
 		...
 		<logic:present name="searchWaiveOff">
		<logic:notEmpty name="list"> 
		
    <display:table  id="list"  name="list" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1"  partialList="true" size="${list[0].totalRecordSize}" requestURI="/waiveOffMakerBehindAction.do" >
...
<tr>
    ...
    <logic:present name="searchWaiveOffNoData">
	<script type="text/javascript">	
		
		if('<%=request.getAttribute("searchWaiveOffNoData")%>'=='No Data')
	    {
		  // alert('<bean:message key="lbl.NoDatafound" />');
	    }	
		if('<%=request.getAttribute("searchWaiveOffNoData")%>'=='Locked')
	    {
