...
<tr>
 ...
 <tr class="white2">
 			...
 			<td><strong><bean:message key="lbl.FieldName"/></strong></td>
...
<logic:iterate name="errorList" id="sublist" >
  ...
  <tr  class="white1">
			...
			<td>${sublist.fileName}</td>
			<td>${sublist.errorFieldName}</td>
...
<logic:present name="noError">
<table width="100%" border="0" cellpadding="0" cellspacing="1" >
<tr class="white2">
<td><strong>MESSAGE</strong></td>
</tr>
<tr  class="white1">
<td><b> There is no Error in file  Or the file is under process. PLEASE WAIT !...........</td>
</tr>
</table>
</logic:present>
