...
<! [endif] -->	
  ...
  <legend><bean:message key="lbl.author"/></legend>
	...
	<tr>
		...
		<tr>
	      <td align="left" colspan="3">
	        ...
	        <button type="button"  id="save" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveUpdateInstrumentAuthor();"><bean:message key="button.save" /></button>
	...
	parent.location="<%=request.getContextPath()%>/instrumentUpdateProcessActionforNew.do?method=searchInstrumentAuthor";
