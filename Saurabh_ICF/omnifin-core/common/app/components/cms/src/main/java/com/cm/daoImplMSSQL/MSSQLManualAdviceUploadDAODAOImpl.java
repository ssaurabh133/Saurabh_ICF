...
public class MSSQLManualAdviceUploadDAODAOImpl  implements ManualAdviceUploadDAO {
	private static final Logger logger=Logger.getLogger(MSSQLManualAdviceUploadDAODAOImpl.class.getName());
