...
public class HoldInstrumentBehindActionAuthor extends Action {
	private static final Logger logger = Logger.getLogger(HoldInstrumentBehindActionAuthor.class.getName());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if(userobj==null){
			logger.info("here in execute method of HoldInstrumentBehindActionAuthor action the session is out----------------");
