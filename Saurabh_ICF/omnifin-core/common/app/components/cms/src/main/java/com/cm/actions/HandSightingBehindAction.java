...
public class HandSightingBehindAction extends Action {
	private static final Logger logger = Logger.getLogger(HandSightingBehindAction.class.getName());
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		HandSightingVO fileTrackVO = new HandSightingVO();
		boolean flag = false;
		...
		String getMode=request.getParameter("method");
        logger.info("getMode...................."+getMode);
		ArrayList list = dao.searchfileTracking(fileTrackVO);
		request.setAttribute("list", list);
        
		if(CommonFunction.checkNull(getMode).equalsIgnoreCase("viewMode")){
