...
<li><a href="paymentMaker.jsp" target="body" id="a"><span style="color: rgb(255, 255, 255);">Payment Maker</span></a></li>
<li><a href="<%=request.getContextPath()%>/paymentAuthorProcessAction.do?method=authorScreen" target="body" id="b"><span style="color: rgb(255, 255, 255);">Payment Author</span></a></li>
