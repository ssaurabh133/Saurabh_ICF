    ...
    <td class="gridtd">
      ...
      <input type="hidden" name="docFlag" id="docFlag${i }" value="${subdocuments.docChildFlag}" />
        ...
        <logic:notEqual value="R" name="subdocuments" property="docStatus">
          ...
          <input type="hidden" name="mandOrNonMand" id="mandOrNonMand${i }" value="${subdocuments.mandatory}" /></td>
  <!-- Virender Code start -->
		 <td >
...
<!--           <html:option value="">--Select--</html:option>-->
         ...
         <input type="hidden" name="flagExp" id="flagExp${i}" value="${subdocuments.expirFlag }" />
             ...
             <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','COAPPL');"%>Upload/Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','COAPPL');">Upload/Download</td>
               </logic:notEqual>
          </tr>
       </logic:iterate>
       <script type="text/javascript" src="<%=request.getContextPath() %>/js/cmScript/CaldocumentRelated.js"></script>
...
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocumentPOD('CA','Y');"><bean:message key="button.save" /></button>
</logic:present>   
<logic:notPresent name="dataFound">
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocumentPOD('CA','N');"><bean:message key="button.save" /></button>
</logic:notPresent>
...
<script type="text/javascript">
  ...
  <tr>
    <td class="gridtd">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
         <tr class="white2">
          <td   ><strong><bean:message key="lbl.coApplicantDocs" /></strong></td>
          <td ><strong><bean:message key="lbl.documentName" /></strong></td>
          <td><b><bean:message key="lbl.originalOrPhotocopy" /></b></td>
          <td><b><bean:message key="lbl.mandatoryOrNonMandatory" /></b></td>
      <td ><b><bean:message key="lbl.DOC-TYPE" /></b></td>          <td ><b><bean:message key="lbl.status" /></b></td>
...
<!--           <html:option value="">--Select--</html:option>-->
            ...
            <html:option value="N">NA</html:option><!-- Virender -->
             ...
             <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','COAPPL');"%>Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','COAPPL');">Download</td>
               </logic:notEqual>
          </tr>
       </logic:iterate>
...
<!--<html:button property="button" value="Save" styleClass="topformbutton2" onclick="return saveDocument('CA');"/>-->
</td>
