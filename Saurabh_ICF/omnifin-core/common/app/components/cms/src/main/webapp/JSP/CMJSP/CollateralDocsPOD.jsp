 ...
 <!-- Virender Code start -->
		 <td >
          <html:select property="vDocType" styleClass=""  styleId="vDocType${i}" value="${subdocuments.vDocumentType}" onchange="docTypeChoice(${i});refreshChildId(${i }); ">
            ...
            <html:option value="AW">As And When</html:option>
            </logic:equal>
...
<!--           <html:option value="">--Select--</html:option>-->
         ...
         <input type="hidden" name="flagExp" id="flagExp${i}" value="${subdocuments.expirFlag }" />
             ...
             <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','COLLATERAL');"%>Upload/Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','COLLATERAL');">Upload/Download</a></td>
               </logic:notEqual>
          </tr>
       </logic:iterate>
       <script type="text/javascript" src="<%=request.getContextPath() %>/js/cmScript/CaldocumentRelated.js"></script>
...
<td >
            ...
            <html:option value="AW">As And When</html:option><!-- Virender -->
         	...
         	<logic:equal name="subdocuments" property="orgOrCopy" value="Y" >
         ...
         <logic:notEqual name="subdocuments" property="orgOrCopy" value="Y">
             	<html:select property="additionalDocStatus" styleClass="" styleId="additionalDocStatus${i}" value="${subdocuments.addnDocStatus}"  onchange="OTCPDDMarkingAdd(${i });makeChoiceAdditional(${i+1});" style="width:10%;">
            <html:option value="R">Received</html:option>
            <html:option value="L">Release</html:option>  <!-- Virender -->
            <html:option value="N">NA</html:option><!-- Virender -->
		...
		<logic:notEqual name="subdocuments" property="addnDocStatus" value="R" >
        	<html:select property="additionalDocStatus" styleClass="" styleId="additionalDocStatus${i}" value="${subdocuments.addnDocStatus}"  onchange="OTCPDDMarkingAdd(${i });makeChoiceAdditional(${i+1});" style="width:10%;">
<!--           <html:option value="">--Select--</html:option>-->
             <html:option value="P">Pending</html:option>
            <html:option value="R">Received</html:option>
           ...
           <html:option value="N">NA</html:option><!-- Virender -->
	               ...
	               <logic:equal name="subdocuments" property="addnDocStatus" value="D">
		            ...
		            <logic:equal name="subdocuments" property="addnDocStatus" value="L">
		              <input type="text" name="additionalReceivedDate" class="text6" readonly="readonly"  value="" />
		            </logic:equal>
	          	 </td>
            	 <td id="addDef${i }">
...
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocumentPOD('C','Y');"><bean:message key="button.save" /></button>
</logic:present>   
<logic:notPresent name="dataFound">
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocumentPOD('C','N');"><bean:message key="button.save" /></button> 
</logic:notPresent>
