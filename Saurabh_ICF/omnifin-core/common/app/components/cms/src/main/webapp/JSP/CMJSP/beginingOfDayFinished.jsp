...
<body onload="enableAnchor();JavaScript:eodBodFinished(1);">
  ...
  <legend><bean:message key="lbl.beginingOfDayheader" /></legend>
    ...
    LoggerMsg.info("In beginingOfDayFinished.....jsp....");
...
{
%>
<button type="button" name="startProcess" disabled="disabled"  title="Alt+P" accesskey="P" id="startProcess" class="topformbutton3" onclick="beginingOfDayStartprocess();"> 
