...
public class UpdateAssetAuthorBehindAction extends Action {
	private static final Logger logger=Logger.getLogger(UpdateAssetAuthorBehindAction.class.getName());
	
	public ActionForward execute(ActionMapping mapping,ActionForm form,
								HttpServletRequest request,HttpServletResponse response)throws Exception{
		
		
		logger.info("in execute method of UpdateAssetAuthorBehindAction:::::::::::::::::");
		...
		if(userobj!=null)
		{
			...
			logger.info("here in execute method of UpdateAssetAuthorBehindAction action the session is out----------------");
		...
		updateAssetVO.setMakerId(userId);
		...
		ArrayList<UpdateAssetVO> searchList= dao.getLoanDetailsAuthor(updateAssetVO);		
