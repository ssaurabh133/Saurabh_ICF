	...
	<div align="center" class="opacity" style="display:none" id="processingImage"></div>
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="1">
			<tr>
			   <td><bean:message key="lbl.BookNo"/><span><font color="red">*</font></span></td>
				...
				<td>
					...
					<html:button property="branchButton" styleId="branchButton" tabindex="1" onclick="openLOVCommon(2024,'StationaryMasterForm','bookIssue','','', '','','','lbxBookNo')" value=" " styleClass="lovbutton"  ></html:button>
			   </td>				
			...
			<tr> 
				...
				<button type="button" name="Search" id="search" class="topformbutton2" title="Alt+W" accesskey="W" onclick="return searchActionHoAllocation();">
		...
		<logic:present name="list">
			...
			<display:table  id="list"  name="list" style="width: 100%" class="dataTable" cellspacing="1"  pagesize="5" requestURI="/hoAllocationSearchAtCM.do" >
