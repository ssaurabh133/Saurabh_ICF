...
<body onload="enableAnchor();init_fields();">
	...
	<input type="hidden" name="contextPath" id="contextPath" value="<%=path %>" />
	   ...
	   <fieldset>	  
	<legend><bean:message key="lbl.sblGblWaiverAuthor"/></legend>         
...
<tr>
	        ...
	        <input type="hidden" name="customerName" id="customerName"/> 
 	        <html:text property="loanNo" styleId="loanNo" styleClass="text" readonly="true" tabindex="-1"/>
  			...
  			<html:button property="loanButton" styleId="loanButton" onclick="closeLovCallonLov('loanNo');openLOVCommon(192021,'CreditForm','loanNo','userId','lbxLoanNoHID', 'lbxDealNo','','','customerName');" value=" " styleClass="lovbutton"></html:button>
	    ...
	    <td width="35%">
		 ...
		 <html:button property="dealButton" styleId="dealButton" onclick="openLOVCommon(192022,'CreditForm','dealNo','lbxLoanNoHID','lbxDealNo', 'loanNo','Select Loan No LOV','','lbxDealNo');closeLovCallonLov();" value=" " styleClass="lovbutton"></html:button>
		...
		<tr>
	      ...
	      <button type="button" name="search"  title="Alt+S" accesskey="S" id="searchButton" class="topformbutton2" onclick="return fnSearchAuthorSblGbl();"><bean:message key="button.search" /></button>
	      </td>
