...
public class AssetMakerBehindAction extends Action {
	private static final Logger logger = Logger.getLogger(AssetMakerBehindAction.class.getName());
	...
	throws Exception {
		...
		logger.info("In assetMakerBehindAction  ");
		boolean flag=false;
