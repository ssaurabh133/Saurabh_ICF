...
/** 
 * MyEclipse Struts
 * Creation date: 09-25-2011
 * 
 * XDoclet definition:
 * @struts.action validate="true"
 */
public class ExistAssetsActionInCM extends Action {
	/*
	 * Generated Methods
	 */
	private static final Logger logger = Logger.getLogger(ExistAssetsActionInCM.class.getName());	
	/** 
	 * Method execute
	 * @param mapping
	 * @param form
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
       ...
       logger.info(" In execute ");
		...
		if(userobj!=null){
			...
			logger.info("here in execute method of ExistAssetsActionInCM action the session is out----------------");
		...
		logger.info("In ExistAssetsActionInCM execute: " + loanId);
		...
		boolean status = dao.addassetCollateralInCM(id,loanId,userId,bDate);
		if(status)
		{
