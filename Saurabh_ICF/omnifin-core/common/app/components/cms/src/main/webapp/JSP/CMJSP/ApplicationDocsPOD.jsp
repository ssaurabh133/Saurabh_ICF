...
<!--           <html:option value="">--Select--</html:option>-->
         ...
         <input type="hidden" name="flagExp" id="flagExp${i}" value="${subdocuments.expirFlag }" />
             ...
             <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','APPL');"%>Upload/Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','APPL');">Upload/Download</td>
               </logic:notEqual>
          </tr>
       </logic:iterate>
        <script type="text/javascript" src="<%=request.getContextPath() %>/js/cmScript/CaldocumentRelated.js"></script>
...
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocumentPOD('AD','Y');"><bean:message key="button.save" /></button>
<logic:present name="documentCollection">
<logic:present name="Forword">
<button type="button" name="forwordButton" class="topformbutton2" title="Alt+V" accesskey="F" onclick="return forwardDocumentDetails('DocumentForm');"><bean:message key="button.forward" /></button>
</logic:present>
<logic:notPresent name="Forword">
<button type="button" name="forwardButton" class="topformbutton2" title="Alt+V" accesskey="F" onclick="return notAllowToForwardDocumentDetails();"><bean:message key="button.forward" /></button>
</logic:notPresent>
</logic:present>  
</logic:present>   
<logic:notPresent name="dataFound">
<button type="button" name="button" class="topformbutton2" title="Alt+V" accesskey="V" onclick="return saveDocumentPOD('AD','N');"><bean:message key="button.save" /></button>
<logic:present name="documentCollection">
<logic:present name="Forword">
<button type="button" name="forwordButton" class="topformbutton2" title="Alt+V" accesskey="F" onclick="return forwardDocumentDetails('DocumentForm');"><bean:message key="button.forward" /></button>
</logic:present>
...
<script type="text/javascript">
	...
	else if('<%=request.getAttribute("sms").toString()%>'=='F')
	{
		...
		parent.location="<%=request.getContextPath()%>/postDisbursalDocSearchBehind.do?method=postDisbursalDocMakerSearch";
	}
...
<!--           <html:option value="">--Select--</html:option>-->
            ...
            <html:option value="N">NA</html:option><!-- Virender -->
             ...
             <logic:equal name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','Y','APPL');"%>Download</a></td>
               </logic:equal>
               <logic:notEqual name="subdocuments" property="docChildFlag" value="Y">
               <td align="center" id="upl${i}"><a href="javascript:;" onclick="uploadDocuments('${i}','${subdocuments.realDocId}','${subdocuments.entityId}','N','APPL');">Download</td>
               </logic:notEqual> 
          </tr>
       </logic:iterate>
