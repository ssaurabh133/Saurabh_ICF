...
public class MSSQLLoggedInUserReportDAOImpl implements LoggedInUserReportDAO{
	private static final Logger logger = Logger.getLogger(MSSQLLoggedInUserReportDAOImpl.class.getName());
