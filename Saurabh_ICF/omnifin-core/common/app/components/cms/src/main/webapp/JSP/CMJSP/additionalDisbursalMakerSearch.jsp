...
<body
	...
	<div id="revisedcontainer">
			...
			<html:form action="/additionalDisbursalMaker" method="post"
				styleId="additionalDisbSearchForm">

				<fieldset>
					<legend>
						<bean:message key="lbl.additionalDisbursalMakerSearch" />
					</legend>
								...
								<table width="100%" border="0" cellspacing="1" cellpadding="1">
									...
									<tr>
										...
										<td width="35%">
											...
											<html:button property="loanLov"
												onclick="openLOVCommon(295,'additionalDisbSearchForm','loanNo','userId','loanNo', 'userId','','','customerName');closeLovCallonLov1();"
									...
									<tr>
										 ...
										 <td>
										    ...
										    <html:button property="dealButton" styleId="dealButton" tabindex="1" onclick="openLOVCommon(266,'additionalDisbSearchForm','userName','userId','', 'userId','','','reportingToUserId')" value=" " styleClass="lovbutton"  ></html:button>
										 </td>
									</tr>
									...
									<tr>
										<td>
										   ...
										   <button type="button" name="search" id="searchButton" class="topformbutton2" title="Alt+S" accesskey="S" onclick="searchAdditionalMaker();"><bean:message key="button.search" /></button>
		                                    <button type="button" name="new" id="button" class="topformbutton2" title="Alt+N" accesskey="N" onclick="openNewDisbMaker();" ><bean:message key="button.new" /></button></td>
		...
		<fieldset>
			<legend>
				<bean:message key="lbl.additionalDisbursalMakerRecords" />
			</legend>

			<logic:present name="disbMakerSearchList">
				<logic:notEmpty name="disbMakerSearchList">
					<display:table id="disbMakerSearchList" name="disbMakerSearchList" style="width: 100%" class="dataTable" pagesize="${requestScope.no}" cellspacing="1" partialList="true" size="${disbMakerSearchList[0].totalRecordSize}" requestURI="/additionalDisbursalMaker.do">
				...
				<logic:empty name="disbMakerSearchList">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td class="gridtd">
								<table width="100%" border="0" cellspacing="1" cellpadding="1">
