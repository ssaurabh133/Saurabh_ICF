...
<!--<li onclick="callFunction('/JSP/CMJSP/instrumentCapturingMaker.jsp','');"><a href="#" target="body" id="a" onclick="activeTab(id);"><span style="color: rgb(255, 255, 255);">Instrument capturing Maker</span></a></li>-->
<!--<li onclick="callFunction('/JSP/CMJSP/instrumentCapturingAuthor.jsp','');"><a href="#" target="body" id="b" onclick="activeTab(id);"><span style="color: rgb(255, 255, 255);">Instrument capturing Author</span></a></li>-->
<!---->
...
<li><a href="instrumentCapturingMaker.jsp" target="body" id="a"><span style="color: rgb(255, 255, 255);">Instrument capturing Maker</span></a></li>
<li><a href="instrumentCapturingAuthor.jsp" target="body" id="b"><span style="color: rgb(255, 255, 255);">Instrument capturing Author</span></a></li>
