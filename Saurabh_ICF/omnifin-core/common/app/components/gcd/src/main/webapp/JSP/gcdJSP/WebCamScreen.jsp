...
//	window.location.href=image;
    ...
    var path =sourcepath+"/customerDocUpload.do?method=customerWebPicUpload&customerId="+customerId;

   	     var form = document.getElementById("webPhotoForm");//document.createElement("sourcingForm");
...
<html:form action="/customerDocUpload" styleId="webPhotoForm" method="post" >
