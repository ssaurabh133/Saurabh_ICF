...
public class UpdateCustomerAuthorBehindAction extends Action 
{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response)throws Exception 
	{
		...
		logger.info("current page link .......... "+request.getParameter("d-6377850-p"));		
		int currentPageLink = 0;
		if(request.getParameter("d-6377850-p")==null || request.getParameter("d-6377850-p").equalsIgnoreCase("0"))
			currentPageLink=1;
		else
			currentPageLink =Integer.parseInt(request.getParameter("d-6377850-p"));
		logger.info("current page link ................ "+request.getParameter("d-6377850-p"));
		...
		ArrayList<ShowCustomerDetailVo> list=dao.getDefaultUpdateCustomerAuthorList(currentPageLink,userId);
		request.setAttribute("updateCustomerAuthorGrid",list);	
