<!--
 	...
 	Date of Creation :- 
 	Purpose          :- To provide user interface for Individual Success
 	Documentation    :- 
 -->
<%@ page language="java"%>
<%@ page session="true"%>
...
<html:html lang="true">
  ...
  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1">
    <tr>
      <td width="30%">&nbsp;</td>
      <td><h2><font color="red">${requestScope.status}</font></h2></td>
     
    </tr>
    <tr>
     <td width="30%">&nbsp;</td>
     <td><h2><font color="red">Individual Code: ${sessionScope.idividualId}</font></h2></td>
     <%
