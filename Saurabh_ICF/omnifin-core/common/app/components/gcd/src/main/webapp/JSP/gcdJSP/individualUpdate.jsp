<!--
 	...
 	Date of Creation :- 
 	Purpose          :- To provide user interface for Individual Update
 	Documentation    :- 
 -->
<%@ page language="java"%>
<%@ page session="true"%>
...
<html:html lang="true">
  <head>
	...
	<script type="text/javascript">
     alert("Address Details are successfully updated!!!");
  ...
  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1">
    <tr>
      <td width="30%">&nbsp;</td>
      <td><h2><font color="red">${requestScope.closeSuccess}</font></h2></td>
